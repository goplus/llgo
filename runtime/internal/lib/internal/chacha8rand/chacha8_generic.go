...
// Use of this source code is governed by the License of the Go Project.
...
func block_generic(seed *[4]uint64, blocks *[32]uint64, counter uint32) {
	b := (*[16][4]uint32)(unsafe.Pointer(blocks))
