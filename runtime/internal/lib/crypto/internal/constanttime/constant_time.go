...
// The stdlib version uses a compiler intrinsic for boolToUint8.
// llgo doesn't lower that intrinsic yet, so keep the same API surface with
// a direct implementation for now.
