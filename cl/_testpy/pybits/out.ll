...
@0 = private unnamed_addr constant [15 x i8] c"int.bit_length\00", align 1
...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  call void (ptr, ...) @llgoLoadPyModSyms(ptr %1, ptr @0, ptr @"__llgo_py.builtins$int.bit_length", ptr null)
  br label %_llgo_2
