...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  call void @"github.com/goplus/llgo/cl/_testpy/pow.init$python"()
  br label %_llgo_2
...
define void @"github.com/goplus/llgo/cl/_testpy/pow.init$python"() {
_llgo_0:
  %0 = load ptr, ptr @__llgo_py.math, align 8
  %1 = load ptr, ptr @"__llgo_py.math$pow", align 8
  %2 = icmp eq ptr %1, null
  br i1 %2, label %_llgo_1, label %_llgo_2

_llgo_1:                                          ; preds = %_llgo_0
  %3 = call ptr @PyObject_GetAttrString(ptr %0, ptr @1)
  store ptr %3, ptr @"__llgo_py.math$pow", align 8
  br label %_llgo_2
