...
@"_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 -1814719306, i8 13, i8 8, i8 8, i8 57, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$lOhriNu2BrWBR2Mh8k-KggMYlAw0Wx-2ftE2_gNyubg$fields", i64 1, i64 1 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$lOhriNu2BrWBR2Mh8k-KggMYlAw0Wx-2ftE2_gNyubg$fields" = weak_odr constant [1 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 5 }, ptr @_llgo_int, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"_llgo_github.com/goplus/llgo/async.Context" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 0, i32 29200871, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Context" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 13 }, ptr @"*_llgo_github.com/goplus/llgo/async.Context" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$Re9uCNpaPdvqJtnZYej5NZ8aMgZjb-_ftN8ogfRqy78$fields", i64 2, i64 2 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@12 = private unnamed_addr constant [5 x i8] c"Waker", align 1
@"_llgo_github.com/goplus/llgo/async.Waker" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -2133419533, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @13, i64 11 }, ptr @"*_llgo_github.com/goplus/llgo/async.Waker" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_iface$5udCHZ6xl-fBE2F9apjWV2qrxMb4_QYfwdoy0QD1D8c$imethods", i64 1, i64 1 } }, align 8
...
@14 = private unnamed_addr constant [44 x i8] c"github.com/goplus/llgo/cl/_testpull/multiret", align 1
...
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$Re9uCNpaPdvqJtnZYej5NZ8aMgZjb-_ftN8ogfRqy78$fields" = weak_odr constant [2 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @12, i64 5 }, ptr @"_llgo_github.com/goplus/llgo/async.Waker", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @17, i64 8 }, ptr @_llgo_bool, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"_llgo_github.com/goplus/llgo/async.Poll[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 32, i32 801809575, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Poll[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @19, i64 15 }, ptr @"*_llgo_github.com/goplus/llgo/async.Poll[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields", i64 3, i64 3 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @20, i64 5 }, ptr @"_llgo_func$qr5k1qEWsN-DT0K_2GdiJjFmaF5XRqCiKsG-CTPmlC8", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error", ptr @"github.com/goplus/llgo/async.Poll[int].Error" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @23, i64 8 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError", ptr @"github.com/goplus/llgo/async.Poll[int].HasError" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @25, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady", ptr @"github.com/goplus/llgo/async.Poll[int].IsReady" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @26, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value", ptr @"github.com/goplus/llgo/async.Poll[int].Value" }] }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields" = weak_odr constant [3 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @_llgo_bool, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 5 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @28, i64 3 }, ptr @_llgo_any, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1611081629, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 26 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @9, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*EarlyReturn$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*EarlyReturn$State).Poll" }] }, align 8
@32 = private unnamed_addr constant [26 x i8] c"multiret.EarlyReturn$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 40, i64 24, i32 -768035575, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 26 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$TlJSwtSEbRmuHtSbRGvkIAKGDH-LolL0Fk8qV-4tu4Y$fields", i64 5, i64 5 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 0, i32 1769159236, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields", i64 4, i64 4 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields" = weak_odr constant [4 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @39, i64 2 }, ptr @"_llgo_closure$GJlcV766GMBE3IJ_9tkJ4Ppu8coeRlXki_OTyWvNI74", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @47, i64 7 }, ptr @_llgo_bool, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @_llgo_bool, i64 17, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 5 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@48 = private unnamed_addr constant [11 x i8] c"resultValue", align 1
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$TlJSwtSEbRmuHtSbRGvkIAKGDH-LolL0Fk8qV-4tu4Y$fields" = weak_odr constant [5 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @35, i64 6 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, ptr @_llgo_int, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @37, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @48, i64 11 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@49 = private unnamed_addr constant [15 x i8] c"MultipleReturns", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1608189218, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @50, i64 30 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @9, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*MultipleReturns$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*MultipleReturns$State).Poll" }] }, align 8
@50 = private unnamed_addr constant [30 x i8] c"multiret.MultipleReturns$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 40, i64 24, i32 81262879, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @50, i64 30 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$TlJSwtSEbRmuHtSbRGvkIAKGDH-LolL0Fk8qV-4tu4Y$fields", i64 5, i64 5 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@51 = private unnamed_addr constant [17 x i8] c"NestedReturnPaths", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1226237647, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @52, i64 32 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @9, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*NestedReturnPaths$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/multiret.(*NestedReturnPaths$State).Poll" }] }, align 8
@52 = private unnamed_addr constant [32 x i8] c"multiret.NestedReturnPaths$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 64, i64 48, i32 -1393420628, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @52, i64 32 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/multiret.struct$D0CqqQDTRtk7JRpCDY6II-63DzwyeybwKcup1Vfgblg$fields", i64 8, i64 8 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 44 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@53 = private unnamed_addr constant [6 x i8] c"param1", align 1
@54 = private unnamed_addr constant [4 x i8] c"var1", align 1
@55 = private unnamed_addr constant [4 x i8] c"sub1", align 1
@"github.com/goplus/llgo/cl/_testpull/multiret.struct$D0CqqQDTRtk7JRpCDY6II-63DzwyeybwKcup1Vfgblg$fields" = weak_odr constant [8 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @35, i64 6 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @53, i64 6 }, ptr @_llgo_int, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @54, i64 4 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @37, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @55, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @48, i64 11 }, ptr @_llgo_int, i64 56, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
EarlyReturn_state_00:                             ; preds = %EarlyReturn_entry
  %5 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 1
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  ...
  %9 = icmp slt i64 %6, 0
  br i1 %9, label %EarlyReturn_state_00_true, label %EarlyReturn_state_00_false

EarlyReturn_state_01:                             ; preds = %EarlyReturn_state_00_true, %EarlyReturn_entry
  %10 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 1
  %11 = load i64, ptr %10, align 4
  %12 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  ...
  %19 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 0
  ...
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 4
...
EarlyReturn_state_02:                             ; preds = %EarlyReturn_state_00_false, %EarlyReturn_entry
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 1
  %25 = load i64, ptr %24, align 4
  %26 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  ...
  %28 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = icmp eq ptr %29, null
  br i1 %30, label %EarlyReturn_state_02_init, label %EarlyReturn_state_02_poll

EarlyReturn_state_03:                             ; preds = %EarlyReturn_state_02_ready, %EarlyReturn_entry
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 1
  %32 = load i64, ptr %31, align 4
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  ...
  %35 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  ...
  %41 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 4
  store i64 %36, ptr %41, align 4
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 0
...
EarlyReturn_state_done:                           ; preds = %EarlyReturn_entry
  ...
  %47 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 4
...
EarlyReturn_state_00_false:                       ; preds = %EarlyReturn_state_00
  %52 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %52, align 1
  br label %EarlyReturn_state_02

EarlyReturn_state_02_init:                        ; preds = %EarlyReturn_state_02
  %53 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 1
  %54 = load i64, ptr %53, align 4
  %55 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  %56 = load i64, ptr %55, align 4
  %57 = call ptr @"github.com/goplus/llgo/cl/_testpull/multiret.Step"(i64 %54)
...
EarlyReturn_state_02_poll:                        ; preds = %EarlyReturn_state_02_init, %EarlyReturn_state_02
  ...
  %59 = call %"github.com/goplus/llgo/async.Poll[int]" @"github.com/goplus/llgo/async.(*AsyncFuture[int]).Poll"(ptr %58, ptr %1)
  %60 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %59, 0
  br i1 %60, label %EarlyReturn_state_02_ready, label %EarlyReturn_state_02_pending

EarlyReturn_state_02_ready:                       ; preds = %EarlyReturn_state_02_poll
  %61 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %59, 1
  %62 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 2
  store i64 %61, ptr %62, align 4
  store ptr null, ptr %28, align 8
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State", ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  %2 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.EarlyReturn$State")
...
MultipleReturns_state_00:                         ; preds = %MultipleReturns_entry
  %5 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %8 = load i64, ptr %7, align 4
  ...
  %9 = icmp slt i64 %6, 0
  br i1 %9, label %MultipleReturns_state_00_true, label %MultipleReturns_state_00_false

MultipleReturns_state_01:                         ; preds = %MultipleReturns_state_00_true, %MultipleReturns_entry
  %10 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %11 = load i64, ptr %10, align 4
  %12 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %13 = load i64, ptr %12, align 4
  ...
  store i64 -1, ptr %18, align 4
  %19 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
  ...
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
  %21 = load i64, ptr %20, align 4
  %22 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" { i1 true, i64 undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, i64 %21, 1
  %23 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" %22, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
  ret %"github.com/goplus/llgo/async.Poll[int]" %23
...
MultipleReturns_state_02:                         ; preds = %MultipleReturns_state_00_false, %MultipleReturns_entry
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %25 = load i64, ptr %24, align 4
  %26 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %27 = load i64, ptr %26, align 4
  ...
  %28 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = icmp eq ptr %29, null
  br i1 %30, label %MultipleReturns_state_02_init, label %MultipleReturns_state_02_poll

MultipleReturns_state_03:                         ; preds = %MultipleReturns_state_02_ready, %MultipleReturns_entry
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %32 = load i64, ptr %31, align 4
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %34 = load i64, ptr %33, align 4
  ...
  %35 = icmp sgt i64 %34, 100
  br i1 %35, label %MultipleReturns_state_02_true, label %MultipleReturns_state_02_false

MultipleReturns_state_04:                         ; preds = %MultipleReturns_state_02_true, %MultipleReturns_entry
  %36 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %37 = load i64, ptr %36, align 4
  %38 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  ...
  %40 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 100)
  ...
  %44 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
  store i64 100, ptr %44, align 4
  %45 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
...
MultipleReturns_state_05:                         ; preds = %MultipleReturns_state_02_false, %MultipleReturns_entry
  %50 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %51 = load i64, ptr %50, align 4
  %52 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %53 = load i64, ptr %52, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @49, i64 15 }, i64 5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %54 = icmp slt i64 %53, 10
  br i1 %54, label %MultipleReturns_state_04_true, label %MultipleReturns_state_04_false

MultipleReturns_state_06:                         ; preds = %MultipleReturns_state_04_true, %MultipleReturns_entry
  %55 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %56 = load i64, ptr %55, align 4
  %57 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  ...
  %59 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 0)
  ...
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
  store i64 0, ptr %63, align 4
  %64 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
  ...
  %65 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
...
MultipleReturns_state_07:                         ; preds = %MultipleReturns_state_04_false, %MultipleReturns_entry
  %69 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %70 = load i64, ptr %69, align 4
  %71 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %72 = load i64, ptr %71, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @49, i64 15 }, i64 7, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %73 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %74 = load i64, ptr %73, align 4
  %75 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %72)
  %76 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  %77 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %76, 0
  %78 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %77, ptr %75, 1
  %79 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
  store i64 %74, ptr %79, align 4
  %80 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
  store i8 8, ptr %80, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @49, i64 15 }, i64 7, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, i1 false, i1 true)
  %81 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 4
...
MultipleReturns_state_done:                       ; preds = %MultipleReturns_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @49, i64 15 }, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @31, i64 4 }, i1 false, i1 true)
...
MultipleReturns_state_00_false:                   ; preds = %MultipleReturns_state_00
  %90 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %90, align 1
  br label %MultipleReturns_state_02

MultipleReturns_state_02_init:                    ; preds = %MultipleReturns_state_02
  %91 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 1
  %92 = load i64, ptr %91, align 4
  %93 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  %94 = load i64, ptr %93, align 4
  %95 = call ptr @"github.com/goplus/llgo/cl/_testpull/multiret.Step"(i64 %92)
...
MultipleReturns_state_02_poll:                    ; preds = %MultipleReturns_state_02_init, %MultipleReturns_state_02
  ...
  %98 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %97, 0
  br i1 %98, label %MultipleReturns_state_02_ready, label %MultipleReturns_state_02_pending

MultipleReturns_state_02_ready:                   ; preds = %MultipleReturns_state_02_poll
  %99 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %97, 1
  %100 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 2
  store i64 %99, ptr %100, align 4
  store ptr null, ptr %28, align 8
  %101 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State", ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  %2 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.MultipleReturns$State")
  %3 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %2, 0
  %4 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %3, ptr %1, 1
  ret %"github.com/goplus/llgo/runtime/internal/runtime.iface" %4
}
...
NestedReturnPaths_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
NestedReturnPaths_state_00:                       ; preds = %NestedReturnPaths_entry
  %5 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %6 = load i64, ptr %5, align 4
  %7 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %8 = load i64, ptr %7, align 4
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %10 = load i64, ptr %9, align 4
  %11 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %12 = load i64, ptr %11, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %13 = icmp sgt i64 %6, 0
  br i1 %13, label %NestedReturnPaths_state_00_true, label %NestedReturnPaths_state_00_false

NestedReturnPaths_state_01:                       ; preds = %NestedReturnPaths_state_00_true, %NestedReturnPaths_entry
  %14 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %15 = load i64, ptr %14, align 4
  %16 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %17 = load i64, ptr %16, align 4
  %18 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %19 = load i64, ptr %18, align 4
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %21 = load i64, ptr %20, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 5
  %23 = load ptr, ptr %22, align 8
  %24 = icmp eq ptr %23, null
  br i1 %24, label %NestedReturnPaths_state_01_init, label %NestedReturnPaths_state_01_poll

NestedReturnPaths_state_02:                       ; preds = %NestedReturnPaths_state_01_ready, %NestedReturnPaths_entry
  %25 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %26 = load i64, ptr %25, align 4
  %27 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %28 = load i64, ptr %27, align 4
  %29 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %30 = load i64, ptr %29, align 4
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %32 = load i64, ptr %31, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %33 = icmp sgt i64 %30, %28
  br i1 %33, label %NestedReturnPaths_state_01_true, label %NestedReturnPaths_state_01_false

NestedReturnPaths_state_03:                       ; preds = %NestedReturnPaths_state_00_false, %NestedReturnPaths_entry
  %34 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %35 = load i64, ptr %34, align 4
  %36 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %37 = load i64, ptr %36, align 4
  %38 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %39 = load i64, ptr %38, align 4
  %40 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %41 = load i64, ptr %40, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  ...
  %47 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 0
  store i8 7, ptr %47, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, i1 false, i1 true)
  %48 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 7
...
NestedReturnPaths_state_04:                       ; preds = %NestedReturnPaths_state_01_true, %NestedReturnPaths_entry
  %52 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %53 = load i64, ptr %52, align 4
  %54 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %55 = load i64, ptr %54, align 4
  %56 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %57 = load i64, ptr %56, align 4
  %58 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %59 = load i64, ptr %58, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %60 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  ...
  %66 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 7
  store i64 %61, ptr %66, align 4
  %67 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 0
  store i8 7, ptr %67, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, i1 false, i1 true)
...
NestedReturnPaths_state_05:                       ; preds = %NestedReturnPaths_state_01_false, %NestedReturnPaths_entry
  %72 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %73 = load i64, ptr %72, align 4
  %74 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %75 = load i64, ptr %74, align 4
  %76 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %77 = load i64, ptr %76, align 4
  %78 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %79 = load i64, ptr %78, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %80 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 6
  %81 = load ptr, ptr %80, align 8
  %82 = icmp eq ptr %81, null
  br i1 %82, label %NestedReturnPaths_state_05_init, label %NestedReturnPaths_state_05_poll

NestedReturnPaths_state_06:                       ; preds = %NestedReturnPaths_state_05_ready, %NestedReturnPaths_entry
  %83 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %84 = load i64, ptr %83, align 4
  %85 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %86 = load i64, ptr %85, align 4
  %87 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %88 = load i64, ptr %87, align 4
  %89 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %90 = load i64, ptr %89, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 6, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %91 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %92 = load i64, ptr %91, align 4
  %93 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %90)
  %94 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  ...
  %97 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 7
  store i64 %92, ptr %97, align 4
  %98 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 0
  store i8 7, ptr %98, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 6, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, i1 false, i1 true)
  %99 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 7
...
NestedReturnPaths_state_done:                     ; preds = %NestedReturnPaths_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 7, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @31, i64 4 }, i1 false, i1 true)
  %103 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 7
...
NestedReturnPaths_state_00_false:                 ; preds = %NestedReturnPaths_state_00
  %108 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 0
...
NestedReturnPaths_state_01_init:                  ; preds = %NestedReturnPaths_state_01
  %109 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 1
  %110 = load i64, ptr %109, align 4
  %111 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 2
  %112 = load i64, ptr %111, align 4
  %113 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  %114 = load i64, ptr %113, align 4
  %115 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 4
  %116 = load i64, ptr %115, align 4
  %117 = call ptr @"github.com/goplus/llgo/cl/_testpull/multiret.Step"(i64 %110)
...
NestedReturnPaths_state_01_poll:                  ; preds = %NestedReturnPaths_state_01_init, %NestedReturnPaths_state_01
  ...
  %119 = call %"github.com/goplus/llgo/async.Poll[int]" @"github.com/goplus/llgo/async.(*AsyncFuture[int]).Poll"(ptr %118, ptr %1)
  %120 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %119, 0
  br i1 %120, label %NestedReturnPaths_state_01_ready, label %NestedReturnPaths_state_01_pending

NestedReturnPaths_state_01_ready:                 ; preds = %NestedReturnPaths_state_01_poll
  %121 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %119, 1
  %122 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State", ptr %0, i32 0, i32 3
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, i1 true, i1 false)
  br label %NestedReturnPaths_state_02

NestedReturnPaths_state_01_pending:               ; preds = %NestedReturnPaths_state_01_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
...
NestedReturnPaths_state_05_pending:               ; preds = %NestedReturnPaths_state_05_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 17 }, i64 5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
}
...
_llgo_0:
  ...
  %3 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.NestedReturnPaths$State")
...
ReturnInLoop_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @56, i64 12 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
ReturnInLoop_state_00:                            ; preds = %ReturnInLoop_entry
  %5 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/multiret.ReturnInLoop$State", ptr %0, i32 0, i32 1
  %6 = load i64, ptr %5, align 4
...
ReturnInLoop_state_02_pending:                    ; preds = %ReturnInLoop_state_02_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @56, i64 12 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
...
_llgo_0:
  ...
  %2 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/multiret.ReturnInLoop$State")
  %3 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %2, 0
  %4 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %3, ptr %1, 1
  ret %"github.com/goplus/llgo/runtime/internal/runtime.iface" %4
}
