...
%"github.com/goplus/llgo/cl/_testpull/types.Divmod$State" = type { i8, i64, i64, i64, i64, ptr, ptr, %"github.com/goplus/llgo/async.Tuple2[int,int]" }
...
%"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State" = type { i8, ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String", i64, ptr, %"github.com/goplus/llgo/async.Result[int]" }
...
%"github.com/goplus/llgo/cl/_testpull/types.MapParam$State" = type { i8, ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String", i64, ptr, i64 }
%"github.com/goplus/llgo/async.ReadyFuture[int]" = type { i64 }
%"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" = type { i8, ptr, i64, ptr, i64 }
%"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" = type { i8, i64, i64, i64, ptr, %"github.com/goplus/llgo/async.Result[int]" }
%"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State" = type { i8, %"github.com/goplus/llgo/runtime/internal/runtime.Slice", i64, i64, i64, ptr, i64 }
...
%"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" = type { i8, %"github.com/goplus/llgo/cl/_testpull/types.Point", %"github.com/goplus/llgo/cl/_testpull/types.Point", i64, i64, ptr, ptr, i64 }
...
@"_llgo_closure$GJlcV766GMBE3IJ_9tkJ4Ppu8coeRlXki_OTyWvNI74$fields" = weak_odr constant [2 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @48, i64 2 }, ptr @"_llgo_func$lQx49kWFbT0FZ8OSeOPqCs05G8gC5IEC_g_JMrdojCY", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @52, i64 5 }, ptr @_llgo_Pointer, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@54 = private unnamed_addr constant [7 x i8] c"started", align 1
@"github.com/goplus/llgo/cl/_testpull/types.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields" = weak_odr constant [4 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @46, i64 2 }, ptr @"_llgo_closure$GJlcV766GMBE3IJ_9tkJ4Ppu8coeRlXki_OTyWvNI74", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @54, i64 7 }, ptr @_llgo_bool, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, ptr @_llgo_bool, i64 17, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @7, i64 5 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.FuncType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 2131144854, i8 0, i8 8, i8 8, i8 51, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @55, i64 10 }, ptr @"*_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA" }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA$out", i64 1, i64 1 } }, align 8
@55 = private unnamed_addr constant [10 x i8] c"func() int", align 1
@"*_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1805835775, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @55, i64 10 }, ptr null }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA" }, align 8
@"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA$out" = weak_odr constant [1 x ptr] [ptr @_llgo_int], align 8
@"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.FuncType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1655717054, i8 0, i8 8, i8 8, i8 51, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @56, i64 36 }, ptr @"*_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss" }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss$in", i64 1, i64 1 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss$out", i64 1, i64 1 } }, align 8
@56 = private unnamed_addr constant [36 x i8] c"func(*async.Context) async.Poll[int]", align 1
@"*_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -62824656, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @56, i64 36 }, ptr null }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss" }, align 8
...
@"_llgo_github.com/goplus/llgo/async.Poll[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 32, i32 801809575, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Poll[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @57, i64 15 }, ptr @"*_llgo_github.com/goplus/llgo/async.Poll[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields", i64 3, i64 3 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @"_llgo_func$qr5k1qEWsN-DT0K_2GdiJjFmaF5XRqCiKsG-CTPmlC8", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error", ptr @"github.com/goplus/llgo/async.Poll[int].Error" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 8 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError", ptr @"github.com/goplus/llgo/async.Poll[int].HasError" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady", ptr @"github.com/goplus/llgo/async.Poll[int].IsReady" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value", ptr @"github.com/goplus/llgo/async.Poll[int].Value" }] }, align 8
@57 = private unnamed_addr constant [15 x i8] c"async.Poll[int]", align 1
@"*_llgo_github.com/goplus/llgo/async.Poll[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -920093333, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @57, i64 15 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/async.Poll[int]" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @"_llgo_func$qr5k1qEWsN-DT0K_2GdiJjFmaF5XRqCiKsG-CTPmlC8", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 8 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value" }] }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 208, i64 208, i32 -2085301039, i8 0, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @65, i64 82 }, ptr @"*github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc$fields", i64 4, i64 4 } }, align 8
@65 = private unnamed_addr constant [82 x i8] c"struct { topbits [8]uint8; keys [8]string; elems [8]int; overflow unsafe.Pointer }", align 1
@"*github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 3417020, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @65, i64 82 }, ptr null }, ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc" }, align 8
@66 = private unnamed_addr constant [7 x i8] c"topbits", align 1
@"[8]_llgo_uint8" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.ArrayType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 307038632, i8 8, i8 1, i8 1, i8 17, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.arrayequal", ptr @"[8]_llgo_uint8" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @67, i64 8 }, ptr @"*[8]_llgo_uint8" }, ptr @_llgo_uint8, ptr @"[]_llgo_uint8", i64 8 }, align 8
@67 = private unnamed_addr constant [8 x i8] c"[8]uint8", align 1
@"*[8]_llgo_uint8" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -566230779, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @67, i64 8 }, ptr null }, ptr @"[8]_llgo_uint8" }, align 8
@_llgo_uint8 = weak_odr constant %"github.com/goplus/llgo/runtime/abi.Type" { i64 1, i64 0, i32 269156761, i8 12, i8 1, i8 1, i8 40, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal8", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @68, i64 5 }, ptr @"*_llgo_uint8" }, align 8
@68 = private unnamed_addr constant [5 x i8] c"uint8", align 1
@"*_llgo_uint8" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1277858201, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @68, i64 5 }, ptr null }, ptr @_llgo_uint8 }, align 8
@"[]_llgo_uint8" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.SliceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 8, i32 370346748, i8 0, i8 8, i8 8, i8 23, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @69, i64 7 }, ptr @"*[]_llgo_uint8" }, ptr @_llgo_uint8 }, align 8
@69 = private unnamed_addr constant [7 x i8] c"[]uint8", align 1
@"*[]_llgo_uint8" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -2143776929, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @69, i64 7 }, ptr null }, ptr @"[]_llgo_uint8" }, align 8
@70 = private unnamed_addr constant [4 x i8] c"keys", align 1
@"[8]_llgo_string" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.ArrayType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 128, i64 120, i32 460245566, i8 0, i8 8, i8 8, i8 17, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.arrayequal", ptr @"[8]_llgo_string" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @71, i64 9 }, ptr @"*[8]_llgo_string" }, ptr @_llgo_string, ptr @"[]_llgo_string", i64 8 }, align 8
@71 = private unnamed_addr constant [9 x i8] c"[8]string", align 1
@"*[8]_llgo_string" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 368026044, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @71, i64 9 }, ptr null }, ptr @"[8]_llgo_string" }, align 8
@"[]_llgo_string" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.SliceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 8, i32 608974920, i8 0, i8 8, i8 8, i8 23, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @72, i64 8 }, ptr @"*[]_llgo_string" }, ptr @_llgo_string }, align 8
@72 = private unnamed_addr constant [8 x i8] c"[]string", align 1
@"*[]_llgo_string" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -157880218, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @72, i64 8 }, ptr null }, ptr @"[]_llgo_string" }, align 8
@73 = private unnamed_addr constant [5 x i8] c"elems", align 1
@"[8]_llgo_int" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.ArrayType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 64, i64 0, i32 -1310855284, i8 8, i8 8, i8 8, i8 17, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.arrayequal", ptr @"[8]_llgo_int" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @74, i64 6 }, ptr @"*[8]_llgo_int" }, ptr @_llgo_int, ptr @"[]_llgo_int", i64 8 }, align 8
@74 = private unnamed_addr constant [6 x i8] c"[8]int", align 1
@"*[8]_llgo_int" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1841254256, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @74, i64 6 }, ptr null }, ptr @"[8]_llgo_int" }, align 8
@"[]_llgo_int" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.SliceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 8, i32 -1129561019, i8 0, i8 8, i8 8, i8 23, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @75, i64 5 }, ptr @"*[]_llgo_int" }, ptr @_llgo_int }, align 8
@75 = private unnamed_addr constant [5 x i8] c"[]int", align 1
@"*[]_llgo_int" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1428175521, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @75, i64 5 }, ptr null }, ptr @"[]_llgo_int" }, align 8
@76 = private unnamed_addr constant [8 x i8] c"overflow", align 1
@"github.com/goplus/llgo/cl/_testpull/types.struct$Zjz3Xuhag4fhTrc62mjJpFnVpx-gapi2RlFUTxk7rTc$fields" = weak_odr constant [4 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @66, i64 7 }, ptr @"[8]_llgo_uint8", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @70, i64 4 }, ptr @"[8]_llgo_string", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @73, i64 5 }, ptr @"[8]_llgo_int", i64 136, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @76, i64 8 }, ptr @_llgo_Pointer, i64 200, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [2 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1485110546, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @77, i64 59 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 2, i16 2, i32 24 }, [2 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 5 }, ptr @"_llgo_func$18IbIdsW5s12z12VYvKfPxtB_5lqm5yDNtFMb3Hjozw", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[github.com/goplus/llgo/async.Result[int]]).Await", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[github.com/goplus/llgo/async.Result[int]]).Await" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$xJd8_BZL-CZgWSAVNkVU-LaqaPCvrR9gYJzwD1J-GP8", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[github.com/goplus/llgo/async.Result[int]]).Poll", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[github.com/goplus/llgo/async.Result[int]]).Poll" }] }, align 8
@77 = private unnamed_addr constant [59 x i8] c"async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]", align 1
@"_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 24, i32 504401203, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @77, i64 59 }, ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$a2kIjmWEj4soAG8ikWLa-WCoYk4eoItgOcUmPZ-eQNY$fields", i64 1, i64 1 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"_llgo_github.com/goplus/llgo/async.Result[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 24, i64 24, i32 411841992, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Result[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @78, i64 17 }, ptr @"*_llgo_github.com/goplus/llgo/async.Result[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_struct$oLcYhpB3wDWLnk5tkoUFCV4RjUr6h9SZHyPCuMxeWiQ$fields", i64 2, i64 2 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @79, i64 5 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsErr", ptr @"github.com/goplus/llgo/async.Result[int].IsErr" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @80, i64 4 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsOk", ptr @"github.com/goplus/llgo/async.Result[int].IsOk" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @81, i64 6 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Result[int]).Unwrap", ptr @"github.com/goplus/llgo/async.Result[int].Unwrap" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @82, i64 8 }, ptr @"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU", ptr @"github.com/goplus/llgo/async.(*Result[int]).UnwrapOr", ptr @"github.com/goplus/llgo/async.Result[int].UnwrapOr" }] }, align 8
@78 = private unnamed_addr constant [17 x i8] c"async.Result[int]", align 1
@"*_llgo_github.com/goplus/llgo/async.Result[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1214561949, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @78, i64 17 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/async.Result[int]" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @79, i64 5 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsErr", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsErr" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @80, i64 4 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsOk", ptr @"github.com/goplus/llgo/async.(*Result[int]).IsOk" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @81, i64 6 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Result[int]).Unwrap", ptr @"github.com/goplus/llgo/async.(*Result[int]).Unwrap" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @82, i64 8 }, ptr @"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU", ptr @"github.com/goplus/llgo/async.(*Result[int]).UnwrapOr", ptr @"github.com/goplus/llgo/async.(*Result[int]).UnwrapOr" }] }, align 8
@79 = private unnamed_addr constant [5 x i8] c"IsErr", align 1
@80 = private unnamed_addr constant [4 x i8] c"IsOk", align 1
@81 = private unnamed_addr constant [6 x i8] c"Unwrap", align 1
@82 = private unnamed_addr constant [8 x i8] c"UnwrapOr", align 1
@"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.FuncType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1134531106, i8 0, i8 8, i8 8, i8 51, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @83, i64 13 }, ptr @"*_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU" }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU$in", i64 1, i64 1 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU$out", i64 1, i64 1 } }, align 8
@83 = private unnamed_addr constant [13 x i8] c"func(int) int", align 1
@"*_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1763581361, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @83, i64 13 }, ptr null }, ptr @"_llgo_func$ekGNsrYBSzltfAjxbl6T8H6Yq8j16wzqS3nDj2xxGMU" }, align 8
...
@84 = private unnamed_addr constant [3 x i8] c"Err", align 1
@_llgo_error = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -1462738452, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @85, i64 5 }, ptr @"*_llgo_error" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_iface$Fh8eUJ-Gw4e6TYuajcFIOSCuqSPKAt5nS4ow7xeGXEU$imethods", i64 1, i64 1 } }, align 8
@85 = private unnamed_addr constant [5 x i8] c"error", align 1
@"*_llgo_error" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1621558991, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @85, i64 5 }, ptr null }, ptr @_llgo_error }, align 8
@"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.FuncType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1419376263, i8 0, i8 8, i8 8, i8 51, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @86, i64 13 }, ptr @"*_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to" }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to$out", i64 1, i64 1 } }, align 8
@86 = private unnamed_addr constant [13 x i8] c"func() string", align 1
@"*_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1900367307, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @86, i64 13 }, ptr null }, ptr @"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to" }, align 8
...
@"_llgo_struct$oLcYhpB3wDWLnk5tkoUFCV4RjUr6h9SZHyPCuMxeWiQ$fields" = weak_odr constant [2 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @_llgo_int, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @84, i64 3 }, ptr @_llgo_error, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -1994897336, i8 0, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @90, i64 87 }, ptr @"*_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU$imethods", i64 1, i64 1 } }, align 8
@90 = private unnamed_addr constant [87 x i8] c"interface { Poll(*async.Context) async.Poll[github.com/goplus/llgo/async.Result[int]] }", align 1
@"*_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 901209326, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @90, i64 87 }, ptr null }, ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU" }, align 8
...
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1638217846, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @91, i64 27 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$xJd8_BZL-CZgWSAVNkVU-LaqaPCvrR9gYJzwD1J-GP8", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*LookupAndDouble$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*LookupAndDouble$State).Poll" }] }, align 8
@91 = private unnamed_addr constant [27 x i8] c"types.LookupAndDouble$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 72, i64 72, i32 -1147440325, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @91, i64 27 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$0w0GQFaBAaHGhd_ZI_q58JazGLaZEJP1x_sg09tfKAE$fields", i64 6, i64 6 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$0w0GQFaBAaHGhd_ZI_q58JazGLaZEJP1x_sg09tfKAE$fields" = weak_odr constant [6 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @"map[_llgo_string]_llgo_int", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @41, i64 6 }, ptr @_llgo_string, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @"_llgo_github.com/goplus/llgo/async.Result[int]", i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@92 = private unnamed_addr constant [8 x i8] c"MapParam", align 1
@"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [2 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -103283099, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @93, i64 22 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 2, i16 2, i32 24 }, [2 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[int]).Await", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[int]).Await" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[int]).Poll", ptr @"github.com/goplus/llgo/async.(*ReadyFuture[int]).Poll" }] }, align 8
@93 = private unnamed_addr constant [22 x i8] c"async.ReadyFuture[int]", align 1
@"_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 -1814719306, i8 13, i8 8, i8 8, i8 57, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @93, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$lOhriNu2BrWBR2Mh8k-KggMYlAw0Wx-2ftE2_gNyubg$fields", i64 1, i64 1 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 968294533, i8 0, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @94, i64 50 }, ptr @"*_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0$imethods", i64 1, i64 1 } }, align 8
@94 = private unnamed_addr constant [50 x i8] c"interface { Poll(*async.Context) async.Poll[int] }", align 1
@"*_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1655281012, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @94, i64 50 }, ptr null }, ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0" }, align 8
...
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.MapParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -856744270, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @95, i64 20 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.MapParam$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*MapParam$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*MapParam$State).Poll" }] }, align 8
@95 = private unnamed_addr constant [20 x i8] c"types.MapParam$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.MapParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 56, i64 40, i32 54765331, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @95, i64 20 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.MapParam$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$27KK-DYtrPQEg_VYh2y30-qwvCV6snrlcb3yvvp1P0M$fields", i64 6, i64 6 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$27KK-DYtrPQEg_VYh2y30-qwvCV6snrlcb3yvvp1P0M$fields" = weak_odr constant [6 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @"map[_llgo_string]_llgo_int", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @41, i64 6 }, ptr @_llgo_string, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @_llgo_int, i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@96 = private unnamed_addr constant [12 x i8] c"PointerParam", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1890127781, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @97, i64 24 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*PointerParam$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*PointerParam$State).Poll" }] }, align 8
@97 = private unnamed_addr constant [24 x i8] c"types.PointerParam$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 40, i64 24, i32 -1176857743, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @97, i64 24 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.PointerParam$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$Jj7B4Jg2MpjUiILjHMRf_wm7A9pttv422BVqi_nhHuQ$fields", i64 5, i64 5 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$Jj7B4Jg2MpjUiILjHMRf_wm7A9pttv422BVqi_nhHuQ$fields" = weak_odr constant [5 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @"*_llgo_int", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@98 = private unnamed_addr constant [10 x i8] c"SafeDivide", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 133054281, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @99, i64 22 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$xJd8_BZL-CZgWSAVNkVU-LaqaPCvrR9gYJzwD1J-GP8", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*SafeDivide$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*SafeDivide$State).Poll" }] }, align 8
@99 = private unnamed_addr constant [22 x i8] c"types.SafeDivide$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 64, i64 64, i32 688455267, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @99, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$NxjOTGM7Tru8Kn1hN5rJDxXAuauV9ZHBdmJLAPepBjw$fields", i64 6, i64 6 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$NxjOTGM7Tru8Kn1hN5rJDxXAuauV9ZHBdmJLAPepBjw$fields" = weak_odr constant [6 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @41, i64 6 }, ptr @_llgo_int, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @"_llgo_github.com/goplus/llgo/async.Result[int]", i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@100 = private unnamed_addr constant [10 x i8] c"SliceParam", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.SliceParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 343692552, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @101, i64 22 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.SliceParam$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*SliceParam$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*SliceParam$State).Poll" }] }, align 8
@101 = private unnamed_addr constant [22 x i8] c"types.SliceParam$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.SliceParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 72, i64 56, i32 1393606221, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @101, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.SliceParam$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$ex-u1XBXwTUbj05O2MF62inFRH1BlWBXRSaT92K5wz8$fields", i64 7, i64 7 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@102 = private unnamed_addr constant [4 x i8] c"var2", align 1
@"github.com/goplus/llgo/cl/_testpull/types.struct$ex-u1XBXwTUbj05O2MF62inFRH1BlWBXRSaT92K5wz8$fields" = weak_odr constant [7 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @"[]_llgo_int", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @43, i64 4 }, ptr @_llgo_int, i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @102, i64 4 }, ptr @_llgo_int, i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 56, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @_llgo_int, i64 64, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@103 = private unnamed_addr constant [11 x i8] c"StringParam", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.StringParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -58551321, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @104, i64 23 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.StringParam$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*StringParam$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*StringParam$State).Poll" }] }, align 8
@104 = private unnamed_addr constant [23 x i8] c"types.StringParam$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.StringParam$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 48, i64 32, i32 273925782, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.StringParam$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @104, i64 23 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.StringParam$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$JUUi4X543N8d7ao6q1EBByPS5pRnVLT449SfWxoPGL8$fields", i64 5, i64 5 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$JUUi4X543N8d7ao6q1EBByPS5pRnVLT449SfWxoPGL8$fields" = weak_odr constant [5 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @_llgo_string, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @_llgo_int, i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@105 = private unnamed_addr constant [17 x i8] c"StructFieldAccess", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -68901220, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @106, i64 29 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*StructFieldAccess$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/types.(*StructFieldAccess$State).Poll" }] }, align 8
@106 = private unnamed_addr constant [29 x i8] c"types.StructFieldAccess$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 80, i64 64, i32 -1506970905, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @106, i64 29 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/types.struct$AvHHH1Z1uruPk8OE5QaWavDuZwo3kvvaVxFoP_PluNU$fields", i64 8, i64 8 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"_llgo_github.com/goplus/llgo/cl/_testpull/types.Point" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 0, i32 -1984961403, i8 13, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.Point" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @107, i64 11 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/types.Point" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_struct$EoN-2WQQZyu0WCtjjPX5UG3yM-s2ruKwcqP-tpve-Q8$fields", i64 2, i64 2 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@107 = private unnamed_addr constant [11 x i8] c"types.Point", align 1
@"*_llgo_github.com/goplus/llgo/cl/_testpull/types.Point" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -38123231, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @107, i64 11 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.Point" }, align 8
@108 = private unnamed_addr constant [1 x i8] c"X", align 1
@109 = private unnamed_addr constant [1 x i8] c"Y", align 1
@"_llgo_struct$EoN-2WQQZyu0WCtjjPX5UG3yM-s2ruKwcqP-tpve-Q8$fields" = weak_odr constant [2 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @108, i64 1 }, ptr @_llgo_int, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @109, i64 1 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"github.com/goplus/llgo/cl/_testpull/types.struct$AvHHH1Z1uruPk8OE5QaWavDuZwo3kvvaVxFoP_PluNU$fields" = weak_odr constant [8 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @38, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @40, i64 6 }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.Point", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 4 }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/types.Point", i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @43, i64 4 }, ptr @_llgo_int, i64 40, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @102, i64 4 }, ptr @_llgo_int, i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 56, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @58, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 64, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 11 }, ptr @_llgo_int, i64 72, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"github.com/goplus/llgo/cl/_testpull/types.init$guard" = global i1 false, align 1
@110 = private unnamed_addr constant [45 x i8] c"Await() should be transformed by the compiler", align 1
...
Divmod_state_00:                                  ; preds = %Divmod_entry
  ...
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  %10 = load i64, ptr %9, align 4
  %11 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
  ...
  %13 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 5
...
Divmod_state_01:                                  ; preds = %Divmod_state_00_ready, %Divmod_entry
  ...
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  %21 = load i64, ptr %20, align 4
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 6
...
Divmod_state_02:                                  ; preds = %Divmod_state_01_ready, %Divmod_entry
  ...
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  %32 = load i64, ptr %31, align 4
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
  ...
  %40 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 7
  ...
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 7
...
Divmod_state_done:                                ; preds = %Divmod_entry
  ...
  %46 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 7
...
Divmod_state_00_init:                             ; preds = %Divmod_state_00
  ...
  %54 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  %55 = load i64, ptr %54, align 4
  %56 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
...
Divmod_state_00_ready:                            ; preds = %Divmod_state_00_poll
  ...
  %64 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  store i64 %63, ptr %64, align 4
  store ptr null, ptr %13, align 8
  %65 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 0
...
Divmod_state_01_init:                             ; preds = %Divmod_state_01
  %66 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 1
  %67 = load i64, ptr %66, align 4
  %68 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 2
  %69 = load i64, ptr %68, align 4
  %70 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 3
  %71 = load i64, ptr %70, align 4
  %72 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
  %73 = load i64, ptr %72, align 4
  %74 = srem i64 %67, %69
  %75 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %74)
...
Divmod_state_01_poll:                             ; preds = %Divmod_state_01_init, %Divmod_state_01
  ...
  br i1 %78, label %Divmod_state_01_ready, label %Divmod_state_01_pending

Divmod_state_01_ready:                            ; preds = %Divmod_state_01_poll
  %79 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %77, 1
  %80 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 4
  store i64 %79, ptr %80, align 4
  store ptr null, ptr %24, align 8
  %81 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Divmod$State", ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @110, i64 45 }, ptr %1, align 8
...
GetMinMax_entry:
  ...
  %6 = sext i8 %5 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 %6, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
GetMinMax_state_00:                               ; preds = %GetMinMax_entry
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
...
GetMinMax_state_01:                               ; preds = %GetMinMax_state_00_ready, %GetMinMax_entry
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
...
GetMinMax_state_02:                               ; preds = %GetMinMax_state_01_ready, %GetMinMax_entry
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
...
GetMinMax_state_03:                               ; preds = %GetMinMax_state_00_true, %GetMinMax_entry
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
...
GetMinMax_state_04:                               ; preds = %GetMinMax_state_00_false, %GetMinMax_entry
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
...
GetMinMax_state_done:                             ; preds = %GetMinMax_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
...
GetMinMax_state_00_ready:                         ; preds = %GetMinMax_state_00_poll
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %GetMinMax_state_01

GetMinMax_state_00_pending:                       ; preds = %GetMinMax_state_00_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Tuple2[int, int]]" zeroinitializer
...
GetMinMax_state_01_ready:                         ; preds = %GetMinMax_state_01_poll
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %GetMinMax_state_02

GetMinMax_state_01_pending:                       ; preds = %GetMinMax_state_01_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @60, i64 9 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Tuple2[int, int]]" zeroinitializer
...
LookupAndDouble_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
LookupAndDouble_state_00:                         ; preds = %LookupAndDouble_entry
  ...
  %10 = load i64, ptr %9, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  ...
  br i1 %19, label %LookupAndDouble_state_00_true, label %LookupAndDouble_state_00_false

LookupAndDouble_state_01:                         ; preds = %LookupAndDouble_state_00_false, %LookupAndDouble_entry
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 1
  %21 = load ptr, ptr %20, align 8
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 2
  %23 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %22, align 8
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 3
  %25 = load i64, ptr %24, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %26 = call %"github.com/goplus/llgo/async.Result[int]" @"github.com/goplus/llgo/async.Err[int]"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" zeroinitializer)
  %27 = call ptr @"github.com/goplus/llgo/async.Return[github.com/goplus/llgo/async.Result[int]]"(%"github.com/goplus/llgo/async.Result[int]" %26)
  %28 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]")
  ...
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 5
  store %"github.com/goplus/llgo/async.Result[int]" %26, ptr %31, align 8
  %32 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %32, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 5
  %34 = load %"github.com/goplus/llgo/async.Result[int]", ptr %33, align 8
  %35 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" { i1 true, %"github.com/goplus/llgo/async.Result[int]" undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, %"github.com/goplus/llgo/async.Result[int]" %34, 1
  %36 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" %35, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" %36
...
LookupAndDouble_state_02:                         ; preds = %LookupAndDouble_state_00_true, %LookupAndDouble_entry
  ...
  %41 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 3
  %42 = load i64, ptr %41, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %43 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 4
  %44 = load ptr, ptr %43, align 8
  %45 = icmp eq ptr %44, null
  br i1 %45, label %LookupAndDouble_state_02_init, label %LookupAndDouble_state_02_poll

LookupAndDouble_state_03:                         ; preds = %LookupAndDouble_state_02_ready, %LookupAndDouble_entry
  %46 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 1
  %47 = load ptr, ptr %46, align 8
  %48 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 2
  %49 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %48, align 8
  %50 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 3
  %51 = load i64, ptr %50, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %52 = call %"github.com/goplus/llgo/async.Result[int]" @"github.com/goplus/llgo/async.Ok[int]"(i64 %51)
  %53 = call ptr @"github.com/goplus/llgo/async.Return[github.com/goplus/llgo/async.Result[int]]"(%"github.com/goplus/llgo/async.Result[int]" %52)
  %54 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]")
  %55 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %54, 0
  %56 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %55, ptr %53, 1
  %57 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 5
  store %"github.com/goplus/llgo/async.Result[int]" %52, ptr %57, align 8
  %58 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %58, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %59 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 5
...
LookupAndDouble_state_done:                       ; preds = %LookupAndDouble_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 5
...
LookupAndDouble_state_00_true:                    ; preds = %LookupAndDouble_state_00
  %67 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %67, align 1
  br label %LookupAndDouble_state_02

LookupAndDouble_state_00_false:                   ; preds = %LookupAndDouble_state_00
  %68 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 0
  store i8 1, ptr %68, align 1
  br label %LookupAndDouble_state_01

LookupAndDouble_state_02_init:                    ; preds = %LookupAndDouble_state_02
  %69 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 1
  %70 = load ptr, ptr %69, align 8
  %71 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 2
  %72 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %71, align 8
  %73 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 3
  %74 = load i64, ptr %73, align 4
  %75 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" %72, ptr %75, align 8
  %76 = call { ptr, i1 } @"github.com/goplus/llgo/runtime/internal/runtime.MapAccess2"(ptr @"map[_llgo_string]_llgo_int", ptr %70, ptr %75)
  %77 = extractvalue { ptr, i1 } %76, 0
  %78 = load i64, ptr %77, align 4
  %79 = extractvalue { ptr, i1 } %76, 1
  %80 = insertvalue { i64, i1 } undef, i64 %78, 0
  %81 = insertvalue { i64, i1 } %80, i1 %79, 1
  %82 = extractvalue { i64, i1 } %81, 0
  %83 = mul i64 %82, 2
  %84 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %83)
...
LookupAndDouble_state_02_poll:                    ; preds = %LookupAndDouble_state_02_init, %LookupAndDouble_state_02
  ...
  br i1 %87, label %LookupAndDouble_state_02_ready, label %LookupAndDouble_state_02_pending
...
LookupAndDouble_state_02_ready:                   ; preds = %LookupAndDouble_state_02_poll
  ...
  %89 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 3
  store i64 %88, ptr %89, align 4
  store ptr null, ptr %43, align 8
  %90 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.LookupAndDouble$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %90, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %LookupAndDouble_state_03

LookupAndDouble_state_02_pending:                 ; preds = %LookupAndDouble_state_02_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @62, i64 15 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" zeroinitializer
}
...
MapParam_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
MapParam_state_00:                                ; preds = %MapParam_entry
  ...
  %8 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %7, align 8
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  %10 = load i64, ptr %9, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %11 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" %8, ptr %11, align 8
  %12 = call { ptr, i1 } @"github.com/goplus/llgo/runtime/internal/runtime.MapAccess2"(ptr @"map[_llgo_string]_llgo_int", ptr %6, ptr %11)
  %13 = extractvalue { ptr, i1 } %12, 0
...
MapParam_state_01:                                ; preds = %MapParam_state_00_false, %MapParam_entry
  ...
  %25 = load i64, ptr %24, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %26 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 -1)
  ...
  %30 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 5
  store i64 -1, ptr %30, align 4
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %31, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %32 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 5
  %33 = load i64, ptr %32, align 4
  %34 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" { i1 true, i64 undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, i64 %33, 1
  %35 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" %34, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
...
MapParam_state_02:                                ; preds = %MapParam_state_00_true, %MapParam_entry
  ...
  %40 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  %41 = load i64, ptr %40, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 4
  %43 = load ptr, ptr %42, align 8
  %44 = icmp eq ptr %43, null
  br i1 %44, label %MapParam_state_02_init, label %MapParam_state_02_poll

MapParam_state_03:                                ; preds = %MapParam_state_02_ready, %MapParam_entry
  %45 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 1
  %46 = load ptr, ptr %45, align 8
  %47 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 2
  %48 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %47, align 8
  %49 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  %50 = load i64, ptr %49, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %51 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  %52 = load i64, ptr %51, align 4
  %53 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %50)
  %54 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  %55 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %54, 0
  %56 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %55, ptr %53, 1
  %57 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 5
  store i64 %52, ptr %57, align 4
  %58 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %58, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %59 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 5
  %60 = load i64, ptr %59, align 4
...
MapParam_state_done:                              ; preds = %MapParam_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 5
  %64 = load i64, ptr %63, align 4
...
MapParam_state_00_true:                           ; preds = %MapParam_state_00
  %67 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %67, align 1
...
MapParam_state_02_init:                           ; preds = %MapParam_state_02
  %69 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 1
  %70 = load ptr, ptr %69, align 8
  %71 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 2
  %72 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %71, align 8
  %73 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  %74 = load i64, ptr %73, align 4
  %75 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" %72, ptr %75, align 8
  %76 = call { ptr, i1 } @"github.com/goplus/llgo/runtime/internal/runtime.MapAccess2"(ptr @"map[_llgo_string]_llgo_int", ptr %70, ptr %75)
  ...
  %81 = insertvalue { i64, i1 } %80, i1 %79, 1
  %82 = extractvalue { i64, i1 } %81, 0
  %83 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %82)
...
MapParam_state_02_poll:                           ; preds = %MapParam_state_02_init, %MapParam_state_02
  ...
  br i1 %86, label %MapParam_state_02_ready, label %MapParam_state_02_pending

MapParam_state_02_ready:                          ; preds = %MapParam_state_02_poll
  %87 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %85, 1
  %88 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 3
  store i64 %87, ptr %88, align 4
  store ptr null, ptr %42, align 8
  %89 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.MapParam$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %89, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %MapParam_state_03

MapParam_state_02_pending:                        ; preds = %MapParam_state_02_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @92, i64 8 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
}
...
PointerParam_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
PointerParam_state_00:                            ; preds = %PointerParam_entry
  ...
  %8 = load i64, ptr %7, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %9 = icmp eq ptr %6, null
  br i1 %9, label %PointerParam_state_00_true, label %PointerParam_state_00_false

PointerParam_state_01:                            ; preds = %PointerParam_state_00_true, %PointerParam_entry
  %10 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 1
  %11 = load ptr, ptr %10, align 8
  %12 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  %13 = load i64, ptr %12, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %14 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 -1)
  ...
  %18 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 4
  store i64 -1, ptr %18, align 4
  %19 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %19, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 4
  %21 = load i64, ptr %20, align 4
  %22 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" { i1 true, i64 undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, i64 %21, 1
  %23 = insertvalue %"github.com/goplus/llgo/async.Poll[int]" %22, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
  ret %"github.com/goplus/llgo/async.Poll[int]" %23

PointerParam_state_02:                            ; preds = %PointerParam_state_00_false, %PointerParam_entry
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 1
  %25 = load ptr, ptr %24, align 8
  %26 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  %27 = load i64, ptr %26, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %28 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = icmp eq ptr %29, null
  br i1 %30, label %PointerParam_state_02_init, label %PointerParam_state_02_poll

PointerParam_state_03:                            ; preds = %PointerParam_state_02_ready, %PointerParam_entry
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 1
  %32 = load ptr, ptr %31, align 8
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  %34 = load i64, ptr %33, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %35 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  %36 = load i64, ptr %35, align 4
  ...
  %41 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 4
  store i64 %36, ptr %41, align 4
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %42, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %43 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 4
...
PointerParam_state_done:                          ; preds = %PointerParam_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %47 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 4
...
PointerParam_state_00_false:                      ; preds = %PointerParam_state_00
  %52 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %52, align 1
  br label %PointerParam_state_02

PointerParam_state_02_init:                       ; preds = %PointerParam_state_02
  %53 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 1
  %54 = load ptr, ptr %53, align 8
  %55 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  %56 = load i64, ptr %55, align 4
  %57 = load i64, ptr %54, align 4
  %58 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %57)
...
PointerParam_state_02_poll:                       ; preds = %PointerParam_state_02_init, %PointerParam_state_02
  ...
  br i1 %61, label %PointerParam_state_02_ready, label %PointerParam_state_02_pending

PointerParam_state_02_ready:                      ; preds = %PointerParam_state_02_poll
  %62 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %60, 1
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 2
  store i64 %62, ptr %63, align 4
  store ptr null, ptr %28, align 8
  %64 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.PointerParam$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %64, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %PointerParam_state_03

PointerParam_state_02_pending:                    ; preds = %PointerParam_state_02_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @96, i64 12 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
}
...
SafeDivide_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
SafeDivide_state_00:                              ; preds = %SafeDivide_entry
  ...
  %10 = load i64, ptr %9, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %11 = icmp eq i64 %8, 0
  br i1 %11, label %SafeDivide_state_00_true, label %SafeDivide_state_00_false

SafeDivide_state_01:                              ; preds = %SafeDivide_state_00_true, %SafeDivide_entry
  %12 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 1
  %13 = load i64, ptr %12, align 4
  %14 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 2
  %15 = load i64, ptr %14, align 4
  %16 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 3
  %17 = load i64, ptr %16, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %18 = call %"github.com/goplus/llgo/async.Result[int]" @"github.com/goplus/llgo/async.Err[int]"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" zeroinitializer)
  %19 = call ptr @"github.com/goplus/llgo/async.Return[github.com/goplus/llgo/async.Result[int]]"(%"github.com/goplus/llgo/async.Result[int]" %18)
  %20 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]")
  ...
  %23 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 5
  store %"github.com/goplus/llgo/async.Result[int]" %18, ptr %23, align 8
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %24, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %25 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 5
  %26 = load %"github.com/goplus/llgo/async.Result[int]", ptr %25, align 8
  %27 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" { i1 true, %"github.com/goplus/llgo/async.Result[int]" undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, %"github.com/goplus/llgo/async.Result[int]" %26, 1
  %28 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" %27, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" %28

SafeDivide_state_02:                              ; preds = %SafeDivide_state_00_false, %SafeDivide_entry
  %29 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 1
  %30 = load i64, ptr %29, align 4
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 2
  %32 = load i64, ptr %31, align 4
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 3
  %34 = load i64, ptr %33, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %35 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 4
  %36 = load ptr, ptr %35, align 8
  %37 = icmp eq ptr %36, null
  br i1 %37, label %SafeDivide_state_02_init, label %SafeDivide_state_02_poll

SafeDivide_state_03:                              ; preds = %SafeDivide_state_02_ready, %SafeDivide_entry
  %38 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 1
  %39 = load i64, ptr %38, align 4
  %40 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 2
  %41 = load i64, ptr %40, align 4
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 3
  %43 = load i64, ptr %42, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %44 = call %"github.com/goplus/llgo/async.Result[int]" @"github.com/goplus/llgo/async.Ok[int]"(i64 %43)
  %45 = call ptr @"github.com/goplus/llgo/async.Return[github.com/goplus/llgo/async.Result[int]]"(%"github.com/goplus/llgo/async.Result[int]" %44)
  %46 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$XGb4EXxXWKV-dYcJTsDF_8cRVN34b3GvQfT6bkSD8WU", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[github.com/goplus/llgo/async.Result[int]]")
  %47 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %46, 0
  %48 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %47, ptr %45, 1
  %49 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 5
  store %"github.com/goplus/llgo/async.Result[int]" %44, ptr %49, align 8
  %50 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %50, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %51 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 5
  %52 = load %"github.com/goplus/llgo/async.Result[int]", ptr %51, align 8
  %53 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" { i1 true, %"github.com/goplus/llgo/async.Result[int]" undef, %"github.com/goplus/llgo/runtime/internal/runtime.eface" undef }, %"github.com/goplus/llgo/async.Result[int]" %52, 1
  %54 = insertvalue %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" %53, %"github.com/goplus/llgo/runtime/internal/runtime.eface" zeroinitializer, 2
...
SafeDivide_state_done:                            ; preds = %SafeDivide_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %55 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 5
...
SafeDivide_state_00_true:                         ; preds = %SafeDivide_state_00
  %59 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 0
  store i8 1, ptr %59, align 1
  br label %SafeDivide_state_01

SafeDivide_state_00_false:                        ; preds = %SafeDivide_state_00
  %60 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %60, align 1
  br label %SafeDivide_state_02

SafeDivide_state_02_init:                         ; preds = %SafeDivide_state_02
  %61 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 1
  %62 = load i64, ptr %61, align 4
  %63 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 2
  %64 = load i64, ptr %63, align 4
  %65 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 3
  %66 = load i64, ptr %65, align 4
  %67 = sdiv i64 %62, %64
  %68 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %67)
...
SafeDivide_state_02_poll:                         ; preds = %SafeDivide_state_02_init, %SafeDivide_state_02
  ...
  br i1 %71, label %SafeDivide_state_02_ready, label %SafeDivide_state_02_pending

SafeDivide_state_02_ready:                        ; preds = %SafeDivide_state_02_poll
  %72 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %70, 1
  %73 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 3
  store i64 %72, ptr %73, align 4
  store ptr null, ptr %35, align 8
  %74 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SafeDivide$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %74, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %SafeDivide_state_03

SafeDivide_state_02_pending:                      ; preds = %SafeDivide_state_02_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @98, i64 10 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[github.com/goplus/llgo/async.Result[int]]" zeroinitializer
}
...
SliceParam_state_00:                              ; preds = %SliceParam_entry
  ...
  %8 = load i64, ptr %7, align 4
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  %10 = load i64, ptr %9, align 4
  %11 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  %12 = load i64, ptr %11, align 4
  ...
  %13 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %6, 1
  %14 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  store i64 0, ptr %14, align 4
  %15 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 2
  store i64 -1, ptr %15, align 4
  %16 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 0
...
SliceParam_state_01:                              ; preds = %SliceParam_state_03, %SliceParam_state_00, %SliceParam_entry
  ...
  %23 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  %24 = load i64, ptr %23, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @100, i64 10 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %25 = add i64 %20, 1
  %26 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %18, 1
  %27 = icmp slt i64 %25, %26
  br i1 %27, label %SliceParam_state_01_true, label %SliceParam_state_01_false
...
SliceParam_state_02:                              ; preds = %SliceParam_state_01_true, %SliceParam_entry
  ...
  %36 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 5
  %37 = load ptr, ptr %36, align 8
  %38 = icmp eq ptr %37, null
  br i1 %38, label %SliceParam_state_02_init, label %SliceParam_state_02_poll

SliceParam_state_03:                              ; preds = %SliceParam_state_02_ready, %SliceParam_entry
  %39 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 1
  %40 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %39, align 8
  %41 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 2
  %42 = load i64, ptr %41, align 4
  %43 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  %44 = load i64, ptr %43, align 4
  %45 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  %46 = load i64, ptr %45, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @100, i64 10 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 false)
  %47 = add i64 %44, %46
  %48 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
...
SliceParam_state_04:                              ; preds = %SliceParam_state_01_false, %SliceParam_entry
  %52 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 1
  %53 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %52, align 8
  %54 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 2
  %55 = load i64, ptr %54, align 4
  %56 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  %57 = load i64, ptr %56, align 4
  %58 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  %59 = load i64, ptr %58, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @100, i64 10 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %60 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  %61 = load i64, ptr %60, align 4
  %62 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %57)
  ...
  %66 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 6
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @100, i64 10 }, i64 4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %68 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 6
  %69 = load i64, ptr %68, align 4
...
SliceParam_state_done:                            ; preds = %SliceParam_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @100, i64 10 }, i64 5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %72 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 6
  %73 = load i64, ptr %72, align 4
...
SliceParam_state_01_true:                         ; preds = %SliceParam_state_01
  %76 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %76, align 1
  br label %SliceParam_state_02

SliceParam_state_01_false:                        ; preds = %SliceParam_state_01
  %77 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 0
  store i8 4, ptr %77, align 1
  br label %SliceParam_state_04

SliceParam_state_02_init:                         ; preds = %SliceParam_state_02
  %78 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 1
  %79 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %78, align 8
  %80 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 2
  %81 = load i64, ptr %80, align 4
  %82 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 3
  %83 = load i64, ptr %82, align 4
  %84 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  %85 = load i64, ptr %84, align 4
  %86 = add i64 %81, 1
  %87 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %79, 0
  %88 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %79, 1
  %89 = icmp slt i64 %86, 0
  %90 = icmp sge i64 %86, %88
  %91 = or i1 %90, %89
  call void @"github.com/goplus/llgo/runtime/internal/runtime.AssertIndexRange"(i1 %91)
  %92 = getelementptr inbounds i64, ptr %87, i64 %86
  %93 = load i64, ptr %92, align 4
  %94 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %93)
...
SliceParam_state_02_poll:                         ; preds = %SliceParam_state_02_init, %SliceParam_state_02
  ...
  br i1 %97, label %SliceParam_state_02_ready, label %SliceParam_state_02_pending

SliceParam_state_02_ready:                        ; preds = %SliceParam_state_02_poll
  %98 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %96, 1
  %99 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 4
  store i64 %98, ptr %99, align 4
  store ptr null, ptr %36, align 8
  %100 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.SliceParam$State", ptr %0, i32 0, i32 0
...
StringParam_entry:
  ...
  %3 = load i8, ptr %2, align 1
  %4 = sext i8 %3 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 %4, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
StringParam_state_00:                             ; preds = %StringParam_entry
  ...
  %8 = load i64, ptr %7, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
...
StringParam_state_01:                             ; preds = %StringParam_state_00_ready, %StringParam_entry
  ...
  %15 = load i64, ptr %14, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
...
StringParam_state_done:                           ; preds = %StringParam_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
...
StringParam_state_00_ready:                       ; preds = %StringParam_state_00_poll
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %StringParam_state_01

StringParam_state_00_pending:                     ; preds = %StringParam_state_00_poll
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @103, i64 11 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
}
...
StructFieldAccess_entry:
  ...
  %5 = sext i8 %4 to i64
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 %5, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 8 }, i1 false, i1 false)
...
StructFieldAccess_state_00:                       ; preds = %StructFieldAccess_entry
  ...
  %10 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  %11 = load i64, ptr %10, align 4
  %12 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  %13 = load i64, ptr %12, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %14 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 5
...
StructFieldAccess_state_01:                       ; preds = %StructFieldAccess_state_00_ready, %StructFieldAccess_entry
  ...
  %21 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  %22 = load i64, ptr %21, align 4
  %23 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  %24 = load i64, ptr %23, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 true, i1 false)
  %25 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 6
...
StructFieldAccess_state_02:                       ; preds = %StructFieldAccess_state_01_ready, %StructFieldAccess_entry
  ...
  %32 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  %33 = load i64, ptr %32, align 4
  %34 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  %35 = load i64, ptr %34, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, i1 false, i1 true)
  %36 = add i64 %33, %35
  %37 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %36)
  %38 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  %39 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %38, 0
  %40 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %39, ptr %37, 1
  %41 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 7
  store i64 %36, ptr %41, align 4
  ...
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 2, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 false, i1 true)
  %45 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 7
  %46 = load i64, ptr %45, align 4
...
StructFieldAccess_state_done:                     ; preds = %StructFieldAccess_entry
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 3, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @36, i64 4 }, i1 false, i1 true)
  %49 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 7
  %50 = load i64, ptr %49, align 4
...
StructFieldAccess_state_00_init:                  ; preds = %StructFieldAccess_state_00
  ...
  %57 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  %58 = load i64, ptr %57, align 4
  %59 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  %60 = load i64, ptr %59, align 4
...
StructFieldAccess_state_00_ready:                 ; preds = %StructFieldAccess_state_00_poll
  ...
  %68 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  store i64 %67, ptr %68, align 4
  store ptr null, ptr %14, align 8
  %69 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 2
  %70 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %2, align 4
  store %"github.com/goplus/llgo/cl/_testpull/types.Point" %70, ptr %69, align 4
  %71 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 0
  store i8 1, ptr %71, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %StructFieldAccess_state_01

StructFieldAccess_state_00_pending:               ; preds = %StructFieldAccess_state_00_poll
  %72 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 2
  %73 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %2, align 4
  store %"github.com/goplus/llgo/cl/_testpull/types.Point" %73, ptr %72, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer

StructFieldAccess_state_01_init:                  ; preds = %StructFieldAccess_state_01
  %74 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 1
  %75 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %74, align 4
  %76 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 2
  %77 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %76, align 4
  store %"github.com/goplus/llgo/cl/_testpull/types.Point" %77, ptr %2, align 4
  %78 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 3
  %79 = load i64, ptr %78, align 4
  %80 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  %81 = load i64, ptr %80, align 4
  %82 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %2, i32 0, i32 1
  %83 = load i64, ptr %82, align 4
  %84 = call ptr @"github.com/goplus/llgo/cl/_testpull/types.StepInt"(i64 %83)
...
StructFieldAccess_state_01_poll:                  ; preds = %StructFieldAccess_state_01_init, %StructFieldAccess_state_01
  ...
  %86 = call %"github.com/goplus/llgo/async.Poll[int]" @"github.com/goplus/llgo/async.(*AsyncFuture[int]).Poll"(ptr %85, ptr %1)
  %87 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %86, 0
  br i1 %87, label %StructFieldAccess_state_01_ready, label %StructFieldAccess_state_01_pending

StructFieldAccess_state_01_ready:                 ; preds = %StructFieldAccess_state_01_poll
  %88 = extractvalue %"github.com/goplus/llgo/async.Poll[int]" %86, 1
  %89 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 4
  store i64 %88, ptr %89, align 4
  store ptr null, ptr %25, align 8
  %90 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 2
  %91 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %2, align 4
  store %"github.com/goplus/llgo/cl/_testpull/types.Point" %91, ptr %90, align 4
  %92 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 0
  store i8 2, ptr %92, align 1
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 5 }, i1 true, i1 false)
  br label %StructFieldAccess_state_02

StructFieldAccess_state_01_pending:               ; preds = %StructFieldAccess_state_01_poll
  %93 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/types.StructFieldAccess$State", ptr %0, i32 0, i32 2
  %94 = load %"github.com/goplus/llgo/cl/_testpull/types.Point", ptr %2, align 4
  store %"github.com/goplus/llgo/cl/_testpull/types.Point" %94, ptr %93, align 4
  call void @"github.com/goplus/llgo/async.PullDebugState"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @105, i64 17 }, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 7 }, i1 true, i1 false)
  ret %"github.com/goplus/llgo/async.Poll[int]" zeroinitializer
}
