...
define %"github.com/goplus/llgo/runtime/internal/runtime.iface" @"EarlyReturn$Poll"(ptr %0) {
_llgo_0:
  %1 = getelementptr inbounds { i8, i1, ptr }, ptr %0, i32 0, i32 0
...
_llgo_1:                                          ; preds = %_llgo_0
  %3 = getelementptr inbounds { i8, i1, ptr }, ptr %0, i32 0, i32 0
...
define %"github.com/goplus/llgo/runtime/internal/runtime.iface" @"MultipleReturns$Poll"(ptr %0) {
_llgo_0:
...
_llgo_4:                                          ; preds = %_llgo_0
  %5 = getelementptr inbounds { i8, i64, ptr, ptr }, ptr %0, i32 0, i32 0
...
_llgo_6:                                          ; preds = %_llgo_0
  %6 = getelementptr inbounds { i8, i64, ptr, ptr }, ptr %0, i32 0, i32 0
...
define %"github.com/goplus/llgo/runtime/internal/runtime.iface" @"NoAwait$Poll"(ptr %0) {
_llgo_0:
  %1 = getelementptr inbounds { i8, i64 }, ptr %0, i32 0, i32 0
  %2 = load i8, ptr %1, align 1
  switch i8 %2, label %_llgo_2 [
    i8 0, label %_llgo_1
  ]
...
define %"github.com/goplus/llgo/runtime/internal/runtime.iface" @"SingleAwait$Poll"(ptr %0) {
_llgo_0:
  %1 = getelementptr inbounds { i8, i64, ptr }, ptr %0, i32 0, i32 0
  %2 = load i8, ptr %1, align 1
  switch i8 %2, label %_llgo_3 [
    i8 0, label %_llgo_1
    i8 1, label %_llgo_2
  ]

_llgo_1:                                          ; preds = %_llgo_0
  %3 = getelementptr inbounds { i8, i64, ptr }, ptr %0, i32 0, i32 0
  store i8 1, ptr %3, align 1
  ret %"github.com/goplus/llgo/runtime/internal/runtime.iface" zeroinitializer
