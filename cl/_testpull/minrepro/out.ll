...
@"_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 0, i32 1769159236, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @47, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/minrepro.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields", i64 4, i64 4 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"_llgo_github.com/goplus/llgo/async.Poll[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 32, i32 801809575, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Poll[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @59, i64 15 }, ptr @"*_llgo_github.com/goplus/llgo/async.Poll[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/minrepro.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields", i64 3, i64 3 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @"_llgo_func$qr5k1qEWsN-DT0K_2GdiJjFmaF5XRqCiKsG-CTPmlC8", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error", ptr @"github.com/goplus/llgo/async.Poll[int].Error" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 8 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError", ptr @"github.com/goplus/llgo/async.Poll[int].HasError" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady", ptr @"github.com/goplus/llgo/async.Poll[int].IsReady" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value", ptr @"github.com/goplus/llgo/async.Poll[int].Value" }] }, align 8
...
Divmod_state_00:                                  ; preds = %Divmod_entry
  ...
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 4
  %10 = load i64, ptr %9, align 4
  %11 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 6
  ...
  %13 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 7
...
Divmod_state_01:                                  ; preds = %Divmod_state_00_ready, %Divmod_entry
  ...
  %20 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 4
  %21 = load i64, ptr %20, align 4
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 6
  ...
  %24 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 8
...
Divmod_state_02:                                  ; preds = %Divmod_state_01_ready, %Divmod_entry
  ...
  %31 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 4
  %32 = load i64, ptr %31, align 4
  %33 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 6
  ...
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 9
...
Divmod_state_done:                                ; preds = %Divmod_entry
  ...
  %46 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 9
...
Divmod_state_00_ready:                            ; preds = %Divmod_state_00_poll
  ...
  %65 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 4
  store i64 %64, ptr %65, align 4
  store ptr null, ptr %13, align 8
  %66 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 0
...
Divmod_state_01_init:                             ; preds = %Divmod_state_01
  %67 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 1
  %68 = load i64, ptr %67, align 4
  %69 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 2
  %70 = load i64, ptr %69, align 4
  %71 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 4
  %72 = load i64, ptr %71, align 4
  %73 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 6
  %74 = load i64, ptr %73, align 4
  %75 = srem i64 %68, %70
  %76 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 5
  store i64 %75, ptr %76, align 4
  %77 = call ptr @"github.com/goplus/llgo/cl/_testpull/minrepro.StepInt"(i64 %75)
...
Divmod_state_01_ready:                            ; preds = %Divmod_state_01_poll
  ...
  %82 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 6
  store i64 %81, ptr %82, align 4
  store ptr null, ptr %24, align 8
  %83 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/minrepro.Divmod$State", ptr %0, i32 0, i32 0
