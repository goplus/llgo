...
%"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" = type { i8, ptr, ptr, ptr, %"github.com/goplus/llgo/runtime/internal/runtime.eface", i1, i1 }
...
%"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" = type { i8, ptr, ptr, ptr, %"github.com/goplus/llgo/runtime/internal/runtime.eface", i1, i1 }
%"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" = type { i8, i1, ptr, ptr, ptr, %"github.com/goplus/llgo/runtime/internal/runtime.eface", i1, i1 }
...
@"_llgo_github.com/goplus/llgo/async.Poll[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [4 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 32, i32 801809575, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/async.Poll[int]" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 15 }, ptr @"*_llgo_github.com/goplus/llgo/async.Poll[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/panic.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields", i64 3, i64 3 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 28 }, i16 4, i16 4, i32 24 }, [4 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @15, i64 5 }, ptr @"_llgo_func$qr5k1qEWsN-DT0K_2GdiJjFmaF5XRqCiKsG-CTPmlC8", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Error", ptr @"github.com/goplus/llgo/async.Poll[int].Error" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @18, i64 8 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).HasError", ptr @"github.com/goplus/llgo/async.Poll[int].HasError" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @21, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"github.com/goplus/llgo/async.(*Poll[int]).IsReady", ptr @"github.com/goplus/llgo/async.Poll[int].IsReady" }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @22, i64 5 }, ptr @"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", ptr @"github.com/goplus/llgo/async.(*Poll[int]).Value", ptr @"github.com/goplus/llgo/async.Poll[int].Value" }] }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/panic.struct$M9E5HRdqyc11Zqvq07yhy6frK_fAyRGIc35bZKl9nrs$fields" = weak_odr constant [3 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @23, i64 5 }, ptr @_llgo_bool, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, ptr @_llgo_int, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @24, i64 3 }, ptr @_llgo_any, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -539005506, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @26, i64 22 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*PanicInDefer$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*PanicInDefer$State).Poll" }] }, align 8
@26 = private unnamed_addr constant [22 x i8] c"foo.PanicInDefer$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 56, i64 32, i32 -1276059722, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @26, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/panic.struct$if3AZcKKVJ9ApG4mgxWiTzrGAc-rJXsy3oNGuj6terQ$fields", i64 7, i64 7 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@29 = private unnamed_addr constant [4 x i8] c"var0", align 1
@"*_llgo_github.com/goplus/llgo/async.Future[int]" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 934108082, i8 10, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 17 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/async.Future[int]" }, align 8
@30 = private unnamed_addr constant [17 x i8] c"async.Future[int]", align 1
@"_llgo_github.com/goplus/llgo/async.Future[int]" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -1503177044, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @30, i64 17 }, ptr @"*_llgo_github.com/goplus/llgo/async.Future[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0$imethods", i64 1, i64 1 } }, align 8
...
@"_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 32, i64 0, i32 1769159236, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } zeroinitializer, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @32, i64 22 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 28 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/panic.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields", i64 4, i64 4 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @1, i64 28 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"github.com/goplus/llgo/cl/_testpull/panic.struct$7rDZKmB42_Py8edMKa5F7f4jLaT74tduVmwgA_IDf00$fields" = weak_odr constant [4 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 2 }, ptr @"_llgo_closure$GJlcV766GMBE3IJ_9tkJ4Ppu8coeRlXki_OTyWvNI74", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @41, i64 7 }, ptr @_llgo_bool, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @23, i64 5 }, ptr @_llgo_bool, i64 17, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 5 }, ptr @_llgo_int, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@42 = private unnamed_addr constant [9 x i8] c"deferHead", align 1
@43 = private unnamed_addr constant [10 x i8] c"panicValue", align 1
@44 = private unnamed_addr constant [11 x i8] c"isPanicking", align 1
@45 = private unnamed_addr constant [9 x i8] c"recovered", align 1
@"github.com/goplus/llgo/cl/_testpull/panic.struct$if3AZcKKVJ9ApG4mgxWiTzrGAc-rJXsy3oNGuj6terQ$fields" = weak_odr constant [7 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @29, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.Future[int]", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @31, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 9 }, ptr @_llgo_Pointer, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @43, i64 10 }, ptr @_llgo_any, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 11 }, ptr @_llgo_bool, i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @45, i64 9 }, ptr @_llgo_bool, i64 49, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1950770465, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @46, i64 24 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*RecoverInDefer$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*RecoverInDefer$State).Poll" }] }, align 8
@46 = private unnamed_addr constant [24 x i8] c"foo.RecoverInDefer$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 56, i64 32, i32 -1745283989, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @46, i64 24 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/panic.struct$if3AZcKKVJ9ApG4mgxWiTzrGAc-rJXsy3oNGuj6terQ$fields", i64 7, i64 7 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.PtrType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1424501638, i8 11, i8 8, i8 8, i8 54, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @47, i64 19 }, ptr null }, ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 4 }, ptr @"_llgo_func$LMNkssIwRQ5S3KjblvOITtLXg_JEzMyFVFUPoZcikss", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*WithPanic$State).Poll", ptr @"github.com/goplus/llgo/cl/_testpull/panic.(*WithPanic$State).Poll" }] }, align 8
@47 = private unnamed_addr constant [19 x i8] c"foo.WithPanic$State", align 1
@"_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 56, i64 32, i32 -1826678497, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @47, i64 19 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testpull/panic.struct$xkLQPM0y7FYtKYLhN0m5oHYl3Rp0d24sd4YO7PPRlxo$fields", i64 8, i64 8 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 41 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
@48 = private unnamed_addr constant [6 x i8] c"param0", align 1
@"github.com/goplus/llgo/cl/_testpull/panic.struct$xkLQPM0y7FYtKYLhN0m5oHYl3Rp0d24sd4YO7PPRlxo$fields" = weak_odr constant [8 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @27, i64 5 }, ptr @_llgo_int8, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @48, i64 6 }, ptr @_llgo_bool, i64 1, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @29, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.Future[int]", i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @31, i64 4 }, ptr @"*_llgo_github.com/goplus/llgo/async.AsyncFuture[int]", i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @42, i64 9 }, ptr @_llgo_Pointer, i64 24, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @43, i64 10 }, ptr @_llgo_any, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @44, i64 11 }, ptr @_llgo_bool, i64 48, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @45, i64 9 }, ptr @_llgo_bool, i64 49, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@"github.com/goplus/llgo/cl/_testpull/panic.init$guard" = global i1 false, align 1
@49 = private unnamed_addr constant [16 x i8] c"operation failed", align 1
...
@51 = private unnamed_addr constant [11 x i8] c"defer panic", align 1
...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @49, i64 16 }, ptr %5, align 8
...
_llgo_0:
  %2 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 0
...
_llgo_1:                                          ; preds = %_llgo_0
  %4 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 2
  %7 = load ptr, ptr %6, align 8
  %8 = icmp eq ptr %7, null
  br i1 %8, label %_llgo_7, label %_llgo_8

_llgo_2:                                          ; preds = %_llgo_9, %_llgo_0
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 1
  %10 = load ptr, ptr %9, align 8
  %11 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %47)
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.iface" %14, ptr %10, align 8
  %15 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 3
  call void @"github.com/goplus/llgo/async.(*DeferState).RunDefers"(ptr %15)
  %16 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %10, align 8
  %17 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 0
  ...
  %20 = getelementptr inbounds %"github.com/goplus/llgo/async.Poll[int]", ptr %18, i32 0, i32 1
  store i64 0, ptr %20, align 4
  %21 = load %"github.com/goplus/llgo/async.Poll[int]", ptr %18, align 8
  ret %"github.com/goplus/llgo/async.Poll[int]" %21

_llgo_3:                                          ; preds = %_llgo_0
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 1
  %23 = load ptr, ptr %22, align 8
  %24 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %23, align 8
  %25 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 0
...
_llgo_7:                                          ; preds = %_llgo_1
  %34 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 1
  ...
  call void @llvm.memset(ptr %38, i8 0, i64 16, i1 false)
  %39 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 3
  call void @"github.com/goplus/llgo/async.(*DeferState).PushDefer"(ptr %39, ptr @"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$1", ptr null)
  %40 = call ptr @"github.com/goplus/llgo/cl/_testpull/panic.MayFail"(i1 false)
...
_llgo_9:                                          ; preds = %_llgo_8
  ...
  %48 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State", ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @51, i64 11 }, ptr %0, align 8
...
declare void @"github.com/goplus/llgo/async.(*DeferState).PushDefer"(ptr, ptr, ptr)
...
_llgo_0:
  ...
  %1 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.PanicInDefer$State")
...
_llgo_0:
  %2 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %_llgo_5 [
    i8 0, label %_llgo_1
    i8 1, label %_llgo_2
...
_llgo_1:                                          ; preds = %_llgo_0
  %4 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 1
  %5 = load ptr, ptr %4, align 8
  %6 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 2
  %7 = load ptr, ptr %6, align 8
  %8 = icmp eq ptr %7, null
  br i1 %8, label %_llgo_7, label %_llgo_8

_llgo_2:                                          ; preds = %_llgo_9, %_llgo_0
  %9 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 1
  %10 = load ptr, ptr %9, align 8
  %11 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %47)
  %12 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  %13 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %12, 0
  %14 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %13, ptr %11, 1
  store %"github.com/goplus/llgo/runtime/internal/runtime.iface" %14, ptr %10, align 8
  %15 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 3
  call void @"github.com/goplus/llgo/async.(*DeferState).RunDefers"(ptr %15)
  %16 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %10, align 8
  %17 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %17, align 1
  %18 = alloca %"github.com/goplus/llgo/async.Poll[int]", align 8
  %19 = getelementptr inbounds %"github.com/goplus/llgo/async.Poll[int]", ptr %18, i32 0, i32 0
  store i1 true, ptr %19, align 1
...
_llgo_3:                                          ; preds = %_llgo_0
  %22 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 1
  %23 = load ptr, ptr %22, align 8
  %24 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %23, align 8
  %25 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 0
  store i8 3, ptr %25, align 1
  %26 = alloca %"github.com/goplus/llgo/async.Poll[int]", align 8
  %27 = getelementptr inbounds %"github.com/goplus/llgo/async.Poll[int]", ptr %26, i32 0, i32 0
  store i1 true, ptr %27, align 1
...
_llgo_7:                                          ; preds = %_llgo_1
  %34 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 1
  %35 = load ptr, ptr %34, align 8
  %36 = alloca %"github.com/goplus/llgo/runtime/internal/runtime.iface", align 8
  call void @llvm.memset(ptr %36, i8 0, i64 16, i1 false)
  ...
  %38 = alloca %"github.com/goplus/llgo/runtime/internal/runtime.iface", align 8
  call void @llvm.memset(ptr %38, i8 0, i64 16, i1 false)
  %39 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 3
  call void @"github.com/goplus/llgo/async.(*DeferState).PushDefer"(ptr %39, ptr @"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$1", ptr null)
  %40 = call ptr @"github.com/goplus/llgo/cl/_testpull/panic.MayFail"(i1 true)
  store ptr %40, ptr %6, align 8
  br label %_llgo_8
...
_llgo_9:                                          ; preds = %_llgo_8
  %46 = getelementptr inbounds %"github.com/goplus/llgo/async.Poll[int]", ptr %43, i32 0, i32 1
  %47 = load i64, ptr %46, align 4
  %48 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State", ptr %0, i32 0, i32 0
  store i8 1, ptr %48, align 1
  br label %_llgo_2
...
_llgo_0:
  ...
  %1 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.RecoverInDefer$State")
  %2 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" undef, ptr %1, 0
  %3 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %2, ptr %0, 1
  ret %"github.com/goplus/llgo/runtime/internal/runtime.iface" %3
}
...
_llgo_0:
  %2 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %_llgo_5 [
    i8 0, label %_llgo_1
    i8 1, label %_llgo_2
...
_llgo_1:                                          ; preds = %_llgo_0
  %4 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 1
  %5 = load i1, ptr %4, align 1
  %6 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 2
  %7 = load ptr, ptr %6, align 8
  %8 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 3
  %9 = load ptr, ptr %8, align 8
  %10 = icmp eq ptr %9, null
  br i1 %10, label %_llgo_7, label %_llgo_8

_llgo_2:                                          ; preds = %_llgo_9, %_llgo_0
  %11 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 1
  %12 = load i1, ptr %11, align 1
  %13 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 2
  %14 = load ptr, ptr %13, align 8
  %15 = call ptr @"github.com/goplus/llgo/async.Return[int]"(i64 %55)
  %16 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/async.ReadyFuture[int]")
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.iface" %18, ptr %14, align 8
  %19 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 4
  call void @"github.com/goplus/llgo/async.(*DeferState).RunDefers"(ptr %19)
  %20 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %14, align 8
  %21 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 0
...
_llgo_3:                                          ; preds = %_llgo_0
  %26 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 1
  %27 = load i1, ptr %26, align 1
  %28 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 2
  %29 = load ptr, ptr %28, align 8
  %30 = load %"github.com/goplus/llgo/runtime/internal/runtime.iface", ptr %29, align 8
...
_llgo_4:                                          ; preds = %_llgo_0
  ...
  %38 = getelementptr inbounds %"github.com/goplus/llgo/async.Poll[int]", ptr %36, i32 0, i32 1
  store i64 0, ptr %38, align 4
  %39 = load %"github.com/goplus/llgo/async.Poll[int]", ptr %36, align 8
...
_llgo_7:                                          ; preds = %_llgo_1
  %40 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 1
  %41 = load i1, ptr %40, align 1
  %42 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 2
  %43 = load ptr, ptr %42, align 8
  %44 = alloca %"github.com/goplus/llgo/runtime/internal/runtime.iface", align 8
  call void @llvm.memset(ptr %44, i8 0, i64 16, i1 false)
  %45 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 2
  store ptr %44, ptr %45, align 8
  %46 = alloca %"github.com/goplus/llgo/runtime/internal/runtime.iface", align 8
  call void @llvm.memset(ptr %46, i8 0, i64 16, i1 false)
  %47 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 4
  call void @"github.com/goplus/llgo/async.(*DeferState).PushDefer"(ptr %47, ptr @"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$1", ptr null)
  %48 = call ptr @"github.com/goplus/llgo/cl/_testpull/panic.MayFail"(i1 %41)
...
_llgo_8:                                          ; preds = %_llgo_7, %_llgo_1
  ...
  store %"github.com/goplus/llgo/async.Poll[int]" %50, ptr %51, align 8
...
_llgo_9:                                          ; preds = %_llgo_8
  ...
  %56 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State", ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  %2 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$xltHQulLTi5yBONGGPc9JOa_OlS7yTXwogmOn3sHdV0", ptr @"*_llgo_github.com/goplus/llgo/cl/_testpull/panic.WithPanic$State")
