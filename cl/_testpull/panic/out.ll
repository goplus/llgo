...
define %"github.com/goplus/llgo/async.Poll[int]" @"PanicInDefer$Poll"(ptr %0, ptr %1) {
_llgo_0:
...
define %"github.com/goplus/llgo/async.Poll[int]" @"RecoverInDefer$Poll"(ptr %0, ptr %1) {
_llgo_0:
  %2 = getelementptr inbounds { i8, ptr, %"github.com/goplus/llgo/async.AsyncFuture[int]" }, ptr %0, i32 0, i32 0
  %3 = load i8, ptr %2, align 1
  switch i8 %3, label %_llgo_4 [
...
define %"github.com/goplus/llgo/async.Poll[int]" @"WithPanic$Poll"(ptr %0, ptr %1) {
_llgo_0:
