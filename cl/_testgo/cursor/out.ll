...
@"_llgo_go/token.Pos" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.Type", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 1285526538, i8 13, i8 8, i8 8, i8 2, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal64", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 9 }, ptr @"*_llgo_go/token.Pos" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 8 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @7, i64 7 }, ptr @"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", ptr @"go/token.(*Pos).IsValid", ptr @"go/token.Pos.IsValid" }] }, align 8
...
@_llgo_bool = weak_odr constant %"github.com/goplus/llgo/runtime/abi.Type" { i64 1, i64 0, i32 554183389, i8 12, i8 1, i8 1, i8 1, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal8", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @9, i64 4 }, ptr @"*_llgo_bool" }, align 8
...
@"_llgo_go/ast.ObjKind" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.Type", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 118841177, i8 13, i8 8, i8 8, i8 2, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal64", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @14, i64 11 }, ptr @"*_llgo_go/ast.ObjKind" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @15, i64 6 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @16, i64 6 }, ptr @"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", ptr @"go/ast.(*ObjKind).String", ptr @"go/ast.ObjKind.String" }] }, align 8
...
@_llgo_int = weak_odr constant %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 -25294021, i8 12, i8 8, i8 8, i8 2, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal64", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @46, i64 3 }, ptr @"*_llgo_int" }, align 8
...
@"_llgo_go/ast.ChanDir" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.Type", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 0, i32 -1370288072, i8 13, i8 8, i8 8, i8 2, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal64", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @87, i64 11 }, ptr @"*_llgo_go/ast.ChanDir" }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @15, i64 6 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@_llgo_uint8 = weak_odr constant %"github.com/goplus/llgo/runtime/abi.Type" { i64 1, i64 0, i32 269156761, i8 12, i8 1, i8 1, i8 8, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.memequal8", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @133, i64 5 }, ptr @"*_llgo_uint8" }, align 8
...
!6 = !{!"*_llgo_go/ast.Object", i32 0, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Object).Pos", !"go/ast.(*Object).Pos"}
!7 = !{!"*_llgo_go/ast.Ident", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ident).End", !"go/ast.(*Ident).End"}
!8 = !{!"*_llgo_go/ast.Ident", i32 1, !"IsExported", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/ast.(*Ident).IsExported", !"go/ast.(*Ident).IsExported"}
!9 = !{!"*_llgo_go/ast.Ident", i32 2, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ident).Pos", !"go/ast.(*Ident).Pos"}
!10 = !{!"*_llgo_go/ast.Ident", i32 3, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*Ident).String", !"go/ast.(*Ident).String"}
!11 = !{!"*_llgo_go/ast.Ident", i32 4, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*Ident).exprNode", !"go/ast.(*Ident).exprNode"}
!12 = !{!"*_llgo_go/ast.ArrayType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ArrayType).End", !"go/ast.(*ArrayType).End"}
!13 = !{!"*_llgo_go/ast.ArrayType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ArrayType).Pos", !"go/ast.(*ArrayType).Pos"}
!14 = !{!"*_llgo_go/ast.ArrayType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ArrayType).exprNode", !"go/ast.(*ArrayType).exprNode"}
!15 = !{!"*_llgo_go/token.Token", i32 0, !"IsKeyword", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsKeyword", !"go/token.(*Token).IsKeyword"}
!16 = !{!"*_llgo_go/token.Token", i32 1, !"IsLiteral", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsLiteral", !"go/token.(*Token).IsLiteral"}
!17 = !{!"*_llgo_go/token.Token", i32 2, !"IsOperator", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsOperator", !"go/token.(*Token).IsOperator"}
!18 = !{!"*_llgo_go/token.Token", i32 3, !"Precedence", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", !"go/token.(*Token).Precedence", !"go/token.(*Token).Precedence"}
!19 = !{!"*_llgo_go/token.Token", i32 4, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/token.(*Token).String", !"go/token.(*Token).String"}
!20 = !{!"_llgo_go/token.Token", i32 0, !"IsKeyword", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsKeyword", !"go/token.Token.IsKeyword"}
!21 = !{!"_llgo_go/token.Token", i32 1, !"IsLiteral", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsLiteral", !"go/token.Token.IsLiteral"}
!22 = !{!"_llgo_go/token.Token", i32 2, !"IsOperator", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Token).IsOperator", !"go/token.Token.IsOperator"}
!23 = !{!"_llgo_go/token.Token", i32 3, !"Precedence", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", !"go/token.(*Token).Precedence", !"go/token.Token.Precedence"}
!24 = !{!"_llgo_go/token.Token", i32 4, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/token.(*Token).String", !"go/token.Token.String"}
!25 = !{!"*_llgo_go/ast.AssignStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*AssignStmt).End", !"go/ast.(*AssignStmt).End"}
!26 = !{!"*_llgo_go/ast.AssignStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*AssignStmt).Pos", !"go/ast.(*AssignStmt).Pos"}
!27 = !{!"*_llgo_go/ast.AssignStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*AssignStmt).stmtNode", !"go/ast.(*AssignStmt).stmtNode"}
!28 = !{!"*_llgo_go/ast.BadDecl", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadDecl).End", !"go/ast.(*BadDecl).End"}
!29 = !{!"*_llgo_go/ast.BadDecl", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadDecl).Pos", !"go/ast.(*BadDecl).Pos"}
!30 = !{!"*_llgo_go/ast.BadDecl", i32 2, !"go/ast.declNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BadDecl).declNode", !"go/ast.(*BadDecl).declNode"}
!31 = !{!"*_llgo_go/ast.BadExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadExpr).End", !"go/ast.(*BadExpr).End"}
!32 = !{!"*_llgo_go/ast.BadExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadExpr).Pos", !"go/ast.(*BadExpr).Pos"}
!33 = !{!"*_llgo_go/ast.BadExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BadExpr).exprNode", !"go/ast.(*BadExpr).exprNode"}
!34 = !{!"*_llgo_go/ast.BadStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadStmt).End", !"go/ast.(*BadStmt).End"}
!35 = !{!"*_llgo_go/ast.BadStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BadStmt).Pos", !"go/ast.(*BadStmt).Pos"}
!36 = !{!"*_llgo_go/ast.BadStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BadStmt).stmtNode", !"go/ast.(*BadStmt).stmtNode"}
!37 = !{!"*_llgo_go/ast.BasicLit", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BasicLit).End", !"go/ast.(*BasicLit).End"}
!38 = !{!"*_llgo_go/ast.BasicLit", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BasicLit).Pos", !"go/ast.(*BasicLit).Pos"}
!39 = !{!"*_llgo_go/ast.BasicLit", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BasicLit).exprNode", !"go/ast.(*BasicLit).exprNode"}
!40 = !{!"*_llgo_go/ast.BinaryExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BinaryExpr).End", !"go/ast.(*BinaryExpr).End"}
!41 = !{!"*_llgo_go/ast.BinaryExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BinaryExpr).Pos", !"go/ast.(*BinaryExpr).Pos"}
!42 = !{!"*_llgo_go/ast.BinaryExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BinaryExpr).exprNode", !"go/ast.(*BinaryExpr).exprNode"}
!43 = !{!"*_llgo_go/ast.BlockStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BlockStmt).End", !"go/ast.(*BlockStmt).End"}
!44 = !{!"*_llgo_go/ast.BlockStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BlockStmt).Pos", !"go/ast.(*BlockStmt).Pos"}
!45 = !{!"*_llgo_go/ast.BlockStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BlockStmt).stmtNode", !"go/ast.(*BlockStmt).stmtNode"}
!46 = !{!"*_llgo_go/ast.BranchStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BranchStmt).End", !"go/ast.(*BranchStmt).End"}
!47 = !{!"*_llgo_go/ast.BranchStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*BranchStmt).Pos", !"go/ast.(*BranchStmt).Pos"}
!48 = !{!"*_llgo_go/ast.BranchStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*BranchStmt).stmtNode", !"go/ast.(*BranchStmt).stmtNode"}
!49 = !{!"*_llgo_go/ast.CallExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CallExpr).End", !"go/ast.(*CallExpr).End"}
!50 = !{!"*_llgo_go/ast.CallExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CallExpr).Pos", !"go/ast.(*CallExpr).Pos"}
!51 = !{!"*_llgo_go/ast.CallExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*CallExpr).exprNode", !"go/ast.(*CallExpr).exprNode"}
!52 = !{!"*_llgo_go/ast.CaseClause", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CaseClause).End", !"go/ast.(*CaseClause).End"}
!53 = !{!"*_llgo_go/ast.CaseClause", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CaseClause).Pos", !"go/ast.(*CaseClause).Pos"}
!54 = !{!"*_llgo_go/ast.CaseClause", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*CaseClause).stmtNode", !"go/ast.(*CaseClause).stmtNode"}
!55 = !{!"*_llgo_go/ast.ChanType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ChanType).End", !"go/ast.(*ChanType).End"}
!56 = !{!"*_llgo_go/ast.ChanType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ChanType).Pos", !"go/ast.(*ChanType).Pos"}
!57 = !{!"*_llgo_go/ast.ChanType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ChanType).exprNode", !"go/ast.(*ChanType).exprNode"}
!58 = !{!"*_llgo_go/ast.CommClause", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CommClause).End", !"go/ast.(*CommClause).End"}
!59 = !{!"*_llgo_go/ast.CommClause", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CommClause).Pos", !"go/ast.(*CommClause).Pos"}
!60 = !{!"*_llgo_go/ast.CommClause", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*CommClause).stmtNode", !"go/ast.(*CommClause).stmtNode"}
!61 = !{!"*_llgo_go/ast.Comment", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Comment).End", !"go/ast.(*Comment).End"}
!62 = !{!"*_llgo_go/ast.Comment", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Comment).Pos", !"go/ast.(*Comment).Pos"}
!63 = !{!"*_llgo_go/ast.CommentGroup", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CommentGroup).End", !"go/ast.(*CommentGroup).End"}
!64 = !{!"*_llgo_go/ast.CommentGroup", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CommentGroup).Pos", !"go/ast.(*CommentGroup).Pos"}
!65 = !{!"*_llgo_go/ast.CommentGroup", i32 2, !"Text", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*CommentGroup).Text", !"go/ast.(*CommentGroup).Text"}
!66 = !{!"*_llgo_go/ast.CompositeLit", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CompositeLit).End", !"go/ast.(*CompositeLit).End"}
!67 = !{!"*_llgo_go/ast.CompositeLit", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*CompositeLit).Pos", !"go/ast.(*CompositeLit).Pos"}
!68 = !{!"*_llgo_go/ast.CompositeLit", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*CompositeLit).exprNode", !"go/ast.(*CompositeLit).exprNode"}
!69 = !{!"*_llgo_go/ast.DeclStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*DeclStmt).End", !"go/ast.(*DeclStmt).End"}
!70 = !{!"*_llgo_go/ast.DeclStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*DeclStmt).Pos", !"go/ast.(*DeclStmt).Pos"}
!71 = !{!"*_llgo_go/ast.DeclStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*DeclStmt).stmtNode", !"go/ast.(*DeclStmt).stmtNode"}
!72 = !{!"*_llgo_go/ast.DeferStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*DeferStmt).End", !"go/ast.(*DeferStmt).End"}
!73 = !{!"*_llgo_go/ast.DeferStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*DeferStmt).Pos", !"go/ast.(*DeferStmt).Pos"}
!74 = !{!"*_llgo_go/ast.DeferStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*DeferStmt).stmtNode", !"go/ast.(*DeferStmt).stmtNode"}
!75 = !{!"*_llgo_go/ast.Ellipsis", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ellipsis).End", !"go/ast.(*Ellipsis).End"}
!76 = !{!"*_llgo_go/ast.Ellipsis", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ellipsis).Pos", !"go/ast.(*Ellipsis).Pos"}
!77 = !{!"*_llgo_go/ast.Ellipsis", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*Ellipsis).exprNode", !"go/ast.(*Ellipsis).exprNode"}
!78 = !{!"*_llgo_go/ast.EmptyStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*EmptyStmt).End", !"go/ast.(*EmptyStmt).End"}
!79 = !{!"*_llgo_go/ast.EmptyStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*EmptyStmt).Pos", !"go/ast.(*EmptyStmt).Pos"}
!80 = !{!"*_llgo_go/ast.EmptyStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*EmptyStmt).stmtNode", !"go/ast.(*EmptyStmt).stmtNode"}
!81 = !{!"*_llgo_go/ast.ExprStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ExprStmt).End", !"go/ast.(*ExprStmt).End"}
!82 = !{!"*_llgo_go/ast.ExprStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ExprStmt).Pos", !"go/ast.(*ExprStmt).Pos"}
!83 = !{!"*_llgo_go/ast.ExprStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ExprStmt).stmtNode", !"go/ast.(*ExprStmt).stmtNode"}
!84 = !{!"*_llgo_go/ast.Field", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Field).End", !"go/ast.(*Field).End"}
!85 = !{!"*_llgo_go/ast.Field", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Field).Pos", !"go/ast.(*Field).Pos"}
!86 = !{!"*_llgo_go/ast.FieldList", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FieldList).End", !"go/ast.(*FieldList).End"}
!87 = !{!"*_llgo_go/ast.FieldList", i32 1, !"NumFields", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA", !"go/ast.(*FieldList).NumFields", !"go/ast.(*FieldList).NumFields"}
!88 = !{!"*_llgo_go/ast.FieldList", i32 2, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FieldList).Pos", !"go/ast.(*FieldList).Pos"}
!89 = !{!"*_llgo_go/ast.Scope", i32 0, !"Insert", !"_llgo_func$6Bzrve4Ehr-C8uebix54ffuv5HX-Qd3V5Ir1RrkuIIQ", !"go/ast.(*Scope).Insert", !"go/ast.(*Scope).Insert"}
!90 = !{!"*_llgo_go/ast.Scope", i32 1, !"Lookup", !"_llgo_func$DskKPFGJyA_zqt8KHhnaaEzc7yv07D3u6QVXgrOswcg", !"go/ast.(*Scope).Lookup", !"go/ast.(*Scope).Lookup"}
!91 = !{!"*_llgo_go/ast.Scope", i32 2, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*Scope).String", !"go/ast.(*Scope).String"}
!92 = !{!"*_llgo_go/ast.ImportSpec", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ImportSpec).End", !"go/ast.(*ImportSpec).End"}
!93 = !{!"*_llgo_go/ast.ImportSpec", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ImportSpec).Pos", !"go/ast.(*ImportSpec).Pos"}
!94 = !{!"*_llgo_go/ast.ImportSpec", i32 2, !"go/ast.specNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ImportSpec).specNode", !"go/ast.(*ImportSpec).specNode"}
!95 = !{!"*_llgo_go/ast.File", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*File).End", !"go/ast.(*File).End"}
!96 = !{!"*_llgo_go/ast.File", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*File).Pos", !"go/ast.(*File).Pos"}
!97 = !{!"*_llgo_go/ast.ForStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ForStmt).End", !"go/ast.(*ForStmt).End"}
!98 = !{!"*_llgo_go/ast.ForStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ForStmt).Pos", !"go/ast.(*ForStmt).Pos"}
!99 = !{!"*_llgo_go/ast.ForStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ForStmt).stmtNode", !"go/ast.(*ForStmt).stmtNode"}
!100 = !{!"*_llgo_go/ast.FuncType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncType).End", !"go/ast.(*FuncType).End"}
!101 = !{!"*_llgo_go/ast.FuncType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncType).Pos", !"go/ast.(*FuncType).Pos"}
!102 = !{!"*_llgo_go/ast.FuncType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*FuncType).exprNode", !"go/ast.(*FuncType).exprNode"}
!103 = !{!"*_llgo_go/ast.FuncDecl", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncDecl).End", !"go/ast.(*FuncDecl).End"}
!104 = !{!"*_llgo_go/ast.FuncDecl", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncDecl).Pos", !"go/ast.(*FuncDecl).Pos"}
!105 = !{!"*_llgo_go/ast.FuncDecl", i32 2, !"go/ast.declNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*FuncDecl).declNode", !"go/ast.(*FuncDecl).declNode"}
!106 = !{!"*_llgo_go/ast.FuncLit", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncLit).End", !"go/ast.(*FuncLit).End"}
!107 = !{!"*_llgo_go/ast.FuncLit", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*FuncLit).Pos", !"go/ast.(*FuncLit).Pos"}
!108 = !{!"*_llgo_go/ast.FuncLit", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*FuncLit).exprNode", !"go/ast.(*FuncLit).exprNode"}
!109 = !{!"*_llgo_go/ast.GenDecl", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*GenDecl).End", !"go/ast.(*GenDecl).End"}
!110 = !{!"*_llgo_go/ast.GenDecl", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*GenDecl).Pos", !"go/ast.(*GenDecl).Pos"}
!111 = !{!"*_llgo_go/ast.GenDecl", i32 2, !"go/ast.declNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*GenDecl).declNode", !"go/ast.(*GenDecl).declNode"}
!112 = !{!"*_llgo_go/ast.GoStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*GoStmt).End", !"go/ast.(*GoStmt).End"}
!113 = !{!"*_llgo_go/ast.GoStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*GoStmt).Pos", !"go/ast.(*GoStmt).Pos"}
!114 = !{!"*_llgo_go/ast.GoStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*GoStmt).stmtNode", !"go/ast.(*GoStmt).stmtNode"}
!115 = !{!"*_llgo_go/ast.IfStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IfStmt).End", !"go/ast.(*IfStmt).End"}
!116 = !{!"*_llgo_go/ast.IfStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IfStmt).Pos", !"go/ast.(*IfStmt).Pos"}
!117 = !{!"*_llgo_go/ast.IfStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*IfStmt).stmtNode", !"go/ast.(*IfStmt).stmtNode"}
!118 = !{!"*_llgo_go/ast.IncDecStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IncDecStmt).End", !"go/ast.(*IncDecStmt).End"}
!119 = !{!"*_llgo_go/ast.IncDecStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IncDecStmt).Pos", !"go/ast.(*IncDecStmt).Pos"}
!120 = !{!"*_llgo_go/ast.IncDecStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*IncDecStmt).stmtNode", !"go/ast.(*IncDecStmt).stmtNode"}
!121 = !{!"*_llgo_go/ast.IndexExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IndexExpr).End", !"go/ast.(*IndexExpr).End"}
!122 = !{!"*_llgo_go/ast.IndexExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IndexExpr).Pos", !"go/ast.(*IndexExpr).Pos"}
!123 = !{!"*_llgo_go/ast.IndexExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*IndexExpr).exprNode", !"go/ast.(*IndexExpr).exprNode"}
!124 = !{!"*_llgo_go/ast.IndexListExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IndexListExpr).End", !"go/ast.(*IndexListExpr).End"}
!125 = !{!"*_llgo_go/ast.IndexListExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*IndexListExpr).Pos", !"go/ast.(*IndexListExpr).Pos"}
!126 = !{!"*_llgo_go/ast.IndexListExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*IndexListExpr).exprNode", !"go/ast.(*IndexListExpr).exprNode"}
!127 = !{!"*_llgo_go/ast.InterfaceType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*InterfaceType).End", !"go/ast.(*InterfaceType).End"}
!128 = !{!"*_llgo_go/ast.InterfaceType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*InterfaceType).Pos", !"go/ast.(*InterfaceType).Pos"}
!129 = !{!"*_llgo_go/ast.InterfaceType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*InterfaceType).exprNode", !"go/ast.(*InterfaceType).exprNode"}
!130 = !{!"*_llgo_go/ast.KeyValueExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*KeyValueExpr).End", !"go/ast.(*KeyValueExpr).End"}
!131 = !{!"*_llgo_go/ast.KeyValueExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*KeyValueExpr).Pos", !"go/ast.(*KeyValueExpr).Pos"}
!132 = !{!"*_llgo_go/ast.KeyValueExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*KeyValueExpr).exprNode", !"go/ast.(*KeyValueExpr).exprNode"}
!133 = !{!"*_llgo_go/ast.LabeledStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*LabeledStmt).End", !"go/ast.(*LabeledStmt).End"}
!134 = !{!"*_llgo_go/ast.LabeledStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*LabeledStmt).Pos", !"go/ast.(*LabeledStmt).Pos"}
!135 = !{!"*_llgo_go/ast.LabeledStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*LabeledStmt).stmtNode", !"go/ast.(*LabeledStmt).stmtNode"}
!136 = !{!"*_llgo_go/ast.MapType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*MapType).End", !"go/ast.(*MapType).End"}
!137 = !{!"*_llgo_go/ast.MapType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*MapType).Pos", !"go/ast.(*MapType).Pos"}
!138 = !{!"*_llgo_go/ast.MapType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*MapType).exprNode", !"go/ast.(*MapType).exprNode"}
!139 = !{!"*_llgo_go/ast.Package", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Package).End", !"go/ast.(*Package).End"}
!140 = !{!"*_llgo_go/ast.Package", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Package).Pos", !"go/ast.(*Package).Pos"}
!141 = !{!"*_llgo_go/ast.ParenExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ParenExpr).End", !"go/ast.(*ParenExpr).End"}
!142 = !{!"*_llgo_go/ast.ParenExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ParenExpr).Pos", !"go/ast.(*ParenExpr).Pos"}
!143 = !{!"*_llgo_go/ast.ParenExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ParenExpr).exprNode", !"go/ast.(*ParenExpr).exprNode"}
!144 = !{!"*_llgo_go/ast.RangeStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*RangeStmt).End", !"go/ast.(*RangeStmt).End"}
!145 = !{!"*_llgo_go/ast.RangeStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*RangeStmt).Pos", !"go/ast.(*RangeStmt).Pos"}
!146 = !{!"*_llgo_go/ast.RangeStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*RangeStmt).stmtNode", !"go/ast.(*RangeStmt).stmtNode"}
!147 = !{!"*_llgo_go/ast.ReturnStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ReturnStmt).End", !"go/ast.(*ReturnStmt).End"}
!148 = !{!"*_llgo_go/ast.ReturnStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ReturnStmt).Pos", !"go/ast.(*ReturnStmt).Pos"}
!149 = !{!"*_llgo_go/ast.ReturnStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ReturnStmt).stmtNode", !"go/ast.(*ReturnStmt).stmtNode"}
!150 = !{!"*_llgo_go/ast.SelectStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SelectStmt).End", !"go/ast.(*SelectStmt).End"}
!151 = !{!"*_llgo_go/ast.SelectStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SelectStmt).Pos", !"go/ast.(*SelectStmt).Pos"}
!152 = !{!"*_llgo_go/ast.SelectStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*SelectStmt).stmtNode", !"go/ast.(*SelectStmt).stmtNode"}
!153 = !{!"*_llgo_go/ast.SelectorExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SelectorExpr).End", !"go/ast.(*SelectorExpr).End"}
!154 = !{!"*_llgo_go/ast.SelectorExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SelectorExpr).Pos", !"go/ast.(*SelectorExpr).Pos"}
!155 = !{!"*_llgo_go/ast.SelectorExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*SelectorExpr).exprNode", !"go/ast.(*SelectorExpr).exprNode"}
!156 = !{!"*_llgo_go/ast.SendStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SendStmt).End", !"go/ast.(*SendStmt).End"}
!157 = !{!"*_llgo_go/ast.SendStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SendStmt).Pos", !"go/ast.(*SendStmt).Pos"}
!158 = !{!"*_llgo_go/ast.SendStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*SendStmt).stmtNode", !"go/ast.(*SendStmt).stmtNode"}
!159 = !{!"*_llgo_go/ast.SliceExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SliceExpr).End", !"go/ast.(*SliceExpr).End"}
!160 = !{!"*_llgo_go/ast.SliceExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SliceExpr).Pos", !"go/ast.(*SliceExpr).Pos"}
!161 = !{!"*_llgo_go/ast.SliceExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*SliceExpr).exprNode", !"go/ast.(*SliceExpr).exprNode"}
!162 = !{!"*_llgo_go/ast.StarExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*StarExpr).End", !"go/ast.(*StarExpr).End"}
!163 = !{!"*_llgo_go/ast.StarExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*StarExpr).Pos", !"go/ast.(*StarExpr).Pos"}
!164 = !{!"*_llgo_go/ast.StarExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*StarExpr).exprNode", !"go/ast.(*StarExpr).exprNode"}
!165 = !{!"*_llgo_go/ast.StructType", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*StructType).End", !"go/ast.(*StructType).End"}
!166 = !{!"*_llgo_go/ast.StructType", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*StructType).Pos", !"go/ast.(*StructType).Pos"}
!167 = !{!"*_llgo_go/ast.StructType", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*StructType).exprNode", !"go/ast.(*StructType).exprNode"}
!168 = !{!"*_llgo_go/ast.SwitchStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SwitchStmt).End", !"go/ast.(*SwitchStmt).End"}
!169 = !{!"*_llgo_go/ast.SwitchStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*SwitchStmt).Pos", !"go/ast.(*SwitchStmt).Pos"}
!170 = !{!"*_llgo_go/ast.SwitchStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*SwitchStmt).stmtNode", !"go/ast.(*SwitchStmt).stmtNode"}
!171 = !{!"*_llgo_go/ast.TypeAssertExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeAssertExpr).End", !"go/ast.(*TypeAssertExpr).End"}
!172 = !{!"*_llgo_go/ast.TypeAssertExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeAssertExpr).Pos", !"go/ast.(*TypeAssertExpr).Pos"}
!173 = !{!"*_llgo_go/ast.TypeAssertExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*TypeAssertExpr).exprNode", !"go/ast.(*TypeAssertExpr).exprNode"}
!174 = !{!"*_llgo_go/ast.TypeSpec", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeSpec).End", !"go/ast.(*TypeSpec).End"}
!175 = !{!"*_llgo_go/ast.TypeSpec", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeSpec).Pos", !"go/ast.(*TypeSpec).Pos"}
!176 = !{!"*_llgo_go/ast.TypeSpec", i32 2, !"go/ast.specNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*TypeSpec).specNode", !"go/ast.(*TypeSpec).specNode"}
!177 = !{!"*_llgo_go/ast.TypeSwitchStmt", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeSwitchStmt).End", !"go/ast.(*TypeSwitchStmt).End"}
!178 = !{!"*_llgo_go/ast.TypeSwitchStmt", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*TypeSwitchStmt).Pos", !"go/ast.(*TypeSwitchStmt).Pos"}
!179 = !{!"*_llgo_go/ast.TypeSwitchStmt", i32 2, !"go/ast.stmtNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*TypeSwitchStmt).stmtNode", !"go/ast.(*TypeSwitchStmt).stmtNode"}
!180 = !{!"*_llgo_go/ast.UnaryExpr", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*UnaryExpr).End", !"go/ast.(*UnaryExpr).End"}
!181 = !{!"*_llgo_go/ast.UnaryExpr", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*UnaryExpr).Pos", !"go/ast.(*UnaryExpr).Pos"}
!182 = !{!"*_llgo_go/ast.UnaryExpr", i32 2, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*UnaryExpr).exprNode", !"go/ast.(*UnaryExpr).exprNode"}
!183 = !{!"*_llgo_go/ast.ValueSpec", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ValueSpec).End", !"go/ast.(*ValueSpec).End"}
!184 = !{!"*_llgo_go/ast.ValueSpec", i32 1, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*ValueSpec).Pos", !"go/ast.(*ValueSpec).Pos"}
!185 = !{!"*_llgo_go/ast.ValueSpec", i32 2, !"go/ast.specNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*ValueSpec).specNode", !"go/ast.(*ValueSpec).specNode"}
