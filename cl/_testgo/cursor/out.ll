...
@"_llgo_go/ast.Expr" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 2005595146, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @33, i64 8 }, ptr @"*_llgo_go/ast.Expr" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @20, i64 40 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testgo/cursor.iface$Sgj3BULO-Q00_yQXYnGpuhlgemISeswqTKF4CsM8fj4$imethods", i64 3, i64 3 } }, align 8
...
@"_llgo_go/ast.Stmt" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 120086185, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @69, i64 8 }, ptr @"*_llgo_go/ast.Stmt" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @20, i64 40 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testgo/cursor.iface$aWT3Y-LS6IA7duoAic3XSpSKidbQ2k5eNPkDzno7gVM$imethods", i64 3, i64 3 } }, align 8
...
@"_llgo_go/ast.Decl" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -1408863929, i8 4, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @99, i64 8 }, ptr @"*_llgo_go/ast.Decl" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @20, i64 40 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testgo/cursor.iface$lX4HMtTJnqhQ8pyXSaTH9ix6C26QiWLjzbxwpuX_Hhc$imethods", i64 3, i64 3 } }, align 8
...
@"github.com/goplus/llgo/cl/_testgo/cursor.iface$JkIs7q6riw3M4lQirjgYyFzfYBj4fN5Sf5vd96hOpAU$imethods" = weak_odr constant [3 x %"github.com/goplus/llgo/runtime/abi.Imethod"] [%"github.com/goplus/llgo/runtime/abi.Imethod" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @25, i64 3 }, ptr @"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU" }, %"github.com/goplus/llgo/runtime/abi.Imethod" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @23, i64 3 }, ptr @"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU" }, %"github.com/goplus/llgo/runtime/abi.Imethod" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @153, i64 15 }, ptr @"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac" }], align 8
