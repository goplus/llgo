...
define void @"github.com/goplus/llgo/cl/_testgo/nestedcall.callFunc"({ ptr, ptr } %0) {
_llgo_0:
  ...
  call void %2()
  %5 = call ptr asm sideeffect "", "={x26},0,~{memory}"(ptr %3)
...
define void @"github.com/goplus/llgo/cl/_testgo/nestedcall.callFuncInner"({ ptr, ptr } %0) {
_llgo_0:
...
_llgo_0:
  call void @"github.com/goplus/llgo/cl/_testgo/nestedcall.callFunc"({ ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/nestedcall.main$1", ptr null })
...
_llgo_0:
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  call void @"github.com/goplus/llgo/cl/_testgo/nestedcall.callFuncInner"({ ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/nestedcall.main$1$1", ptr null })
