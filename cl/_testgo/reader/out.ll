...
_llgo_0:
  ...
  %2 = load ptr, ptr @_llgo_main.stringReader, align 8
  %3 = load ptr, ptr @"*_llgo_main.stringReader", align 8
  ...
  %8 = call { %"github.com/goplus/llgo/runtime/internal/runtime.Slice", %"github.com/goplus/llgo/runtime/internal/runtime.iface" } @main.ReadAll(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %7)
...
_llgo_22:                                         ; preds = %_llgo_21, %_llgo_20
  %72 = load ptr, ptr @_llgo_main.Writer, align 8
...
_llgo_24:                                         ; preds = %_llgo_23, %_llgo_22
  ...
  %77 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 6 })
...
_llgo_25:                                         ; preds = %_llgo_24
  ...
  store ptr %93, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
  br label %_llgo_26

_llgo_26:                                         ; preds = %_llgo_25, %_llgo_24
  %94 = load ptr, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
...
_llgo_28:                                         ; preds = %_llgo_27, %_llgo_26
  %101 = load ptr, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
  %102 = load ptr, ptr @"_llgo_iface$eN81k1zqixGTyagHw_4nqH4mGfwwehTOCTXUlbT9kzk", align 8
...
_llgo_29:                                         ; preds = %_llgo_28
  ...
  %110 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %109)
  store ptr %110, ptr @"_llgo_iface$eN81k1zqixGTyagHw_4nqH4mGfwwehTOCTXUlbT9kzk", align 8
  br label %_llgo_30

_llgo_30:                                         ; preds = %_llgo_29, %_llgo_28
  %111 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @7, i64 17 }, i64 25, i64 16, i64 3, i64 3)
  store ptr %111, ptr @_llgo_main.nopCloserWriterTo, align 8
  %112 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @8, i64 6 })
  %113 = load ptr, ptr @_llgo_main.Reader, align 8
  %114 = icmp eq ptr %113, null
  br i1 %114, label %_llgo_31, label %_llgo_32

_llgo_31:                                         ; preds = %_llgo_30
  store ptr %112, ptr @_llgo_main.Reader, align 8
  br label %_llgo_32
...
_llgo_34:                                         ; preds = %_llgo_33, %_llgo_32
  %123 = load ptr, ptr @_llgo_main.Reader, align 8
  %124 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @8, i64 6 })
  ...
  %131 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Struct"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, i64 16, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %130)
  store ptr %131, ptr @"_llgo_struct$_3ow4zXXILqvC0WDqDRNq5DPhjE1DInJgN924VHWc2Y", align 8
  %132 = load ptr, ptr @"_llgo_struct$_3ow4zXXILqvC0WDqDRNq5DPhjE1DInJgN924VHWc2Y", align 8
...
_llgo_36:                                         ; preds = %_llgo_35, %_llgo_34
  ...
  %148 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %147, ptr @"main.(*nopCloserWriterTo).Close", 2
  %149 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %148, ptr @"main.(*nopCloserWriterTo).Close", 3
  ...
  %151 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %150, ptr @"main.(*nopCloserWriterTo).Close", 2
  %152 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %151, ptr @main.nopCloserWriterTo.Close, 3
  ...
  %155 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %154, ptr @"main.(*nopCloserWriterTo).Read", 2
  %156 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %155, ptr @"main.(*nopCloserWriterTo).Read", 3
  ...
  %158 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %157, ptr @"main.(*nopCloserWriterTo).Read", 2
  %159 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %158, ptr @main.nopCloserWriterTo.Read, 3
  %160 = load ptr, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
  ...
  %162 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %161, ptr @"main.(*nopCloserWriterTo).WriteTo", 2
  %163 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %162, ptr @"main.(*nopCloserWriterTo).WriteTo", 3
  ...
  %165 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %164, ptr @"main.(*nopCloserWriterTo).WriteTo", 2
  %166 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %165, ptr @main.nopCloserWriterTo.WriteTo, 3
...
_llgo_37:                                         ; preds = %_llgo_36
  ...
  %193 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %192)
  store ptr %193, ptr @"_llgo_iface$2bmbYDBStAIdmbXPPn7qIaCcpVcj2I5k6AqgqwAfh84", align 8
  br label %_llgo_38

_llgo_38:                                         ; preds = %_llgo_37, %_llgo_36
  %194 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @11, i64 9 }, i64 25, i64 16, i64 2, i64 2)
  store ptr %194, ptr @_llgo_main.nopCloser, align 8
  %195 = load ptr, ptr @"_llgo_struct$_3ow4zXXILqvC0WDqDRNq5DPhjE1DInJgN924VHWc2Y", align 8
  ...
  %198 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %197, ptr @"main.(*nopCloser).Close", 2
  %199 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %198, ptr @"main.(*nopCloser).Close", 3
  ...
  %201 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %200, ptr @"main.(*nopCloser).Close", 2
  %202 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %201, ptr @main.nopCloser.Close, 3
  ...
  %205 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %204, ptr @"main.(*nopCloser).Read", 2
  %206 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %205, ptr @"main.(*nopCloser).Read", 3
  ...
  %208 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %207, ptr @"main.(*nopCloser).Read", 2
  %209 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %208, ptr @main.nopCloser.Read, 3
  ...
  %222 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @12, i64 12 })
  %223 = load ptr, ptr @_llgo_main.StringWriter, align 8
  %224 = icmp eq ptr %223, null
  br i1 %224, label %_llgo_39, label %_llgo_40

_llgo_39:                                         ; preds = %_llgo_38
  store ptr %222, ptr @_llgo_main.StringWriter, align 8
  br label %_llgo_40
...
_llgo_45:                                         ; preds = %_llgo_44
  ...
  %258 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %257)
  store ptr %258, ptr @"_llgo_iface$Ly4zXiUMEac-hYAMw6b6miJ1JEhGfLyBWyBOhpsRZcU", align 8
  br label %_llgo_46

_llgo_46:                                         ; preds = %_llgo_45, %_llgo_44
  %259 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @17, i64 12 }, i64 25, i64 32, i64 0, i64 10)
  store ptr %259, ptr @_llgo_main.stringReader, align 8
  ...
  %273 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Struct"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 }, i64 32, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %272)
  store ptr %273, ptr @"main.struct$Mdt84yjYYwxF9D2i4cRmpEPiWaO6tsjtrbGUjyESypk", align 8
  %274 = load ptr, ptr @"main.struct$Mdt84yjYYwxF9D2i4cRmpEPiWaO6tsjtrbGUjyESypk", align 8
...
_llgo_48:                                         ; preds = %_llgo_47, %_llgo_46
  ...
  %290 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %289, ptr @"main.(*stringReader).Len", 2
  %291 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %290, ptr @"main.(*stringReader).Len", 3
  ...
  %295 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %294, ptr @"main.(*stringReader).Read", 2
  %296 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %295, ptr @"main.(*stringReader).Read", 3
