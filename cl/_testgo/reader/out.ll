...
_llgo_34:                                         ; preds = %_llgo_33, %_llgo_32
  ...
  %124 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @10, i64 6 }, ptr %123, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 true)
  %125 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 56)
  %126 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %125, i64 0
  store %"github.com/goplus/llgo/internal/abi.StructField" %124, ptr %126, align 8
  %127 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %125, 0
  %128 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %127, i64 1, 1
  %129 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %128, i64 1, 2
  %130 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, i64 16, %"github.com/goplus/llgo/internal/runtime.Slice" %129)
...
_llgo_35:                                         ; preds = %_llgo_34
  %135 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 0)
  %136 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %135, 0
  %137 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %136, i64 0, 1
  %138 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %137, i64 0, 2
  %139 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 8)
  %140 = getelementptr ptr, ptr %139, i64 0
  store ptr %132, ptr %140, align 8
  %141 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %139, 0
  %142 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %141, i64 1, 1
  %143 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %142, i64 1, 2
  %144 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %138, %"github.com/goplus/llgo/internal/runtime.Slice" %143, i1 false)
...
_llgo_36:                                         ; preds = %_llgo_35, %_llgo_34
  ...
  %146 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr undef, ptr undef, ptr undef }, ptr %145, 1
  %147 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %146, ptr @"main.(*nopCloserWriterTo).Close", 2
  %148 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %147, ptr @"main.(*nopCloserWriterTo).Close", 3
  %149 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr undef, ptr undef, ptr undef }, ptr %145, 1
  %150 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %149, ptr @"main.(*nopCloserWriterTo).Close", 2
  %151 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %150, ptr @main.nopCloserWriterTo.Close, 3
  %152 = load ptr, ptr @"_llgo_func$06yPPin-fnDnxFKkLLcJ1GEUhIobjPimde7T_Id_hmY", align 8
  %153 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %152, 1
  %154 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %153, ptr @"main.(*nopCloserWriterTo).Read", 2
  %155 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %154, ptr @"main.(*nopCloserWriterTo).Read", 3
  %156 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %152, 1
  %157 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %156, ptr @"main.(*nopCloserWriterTo).Read", 2
  %158 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %157, ptr @main.nopCloserWriterTo.Read, 3
  %159 = load ptr, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
  %160 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 7 }, ptr undef, ptr undef, ptr undef }, ptr %159, 1
  %161 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %160, ptr @"main.(*nopCloserWriterTo).WriteTo", 2
  %162 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %161, ptr @"main.(*nopCloserWriterTo).WriteTo", 3
  %163 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 7 }, ptr undef, ptr undef, ptr undef }, ptr %159, 1
  %164 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %163, ptr @"main.(*nopCloserWriterTo).WriteTo", 2
  %165 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %164, ptr @main.nopCloserWriterTo.WriteTo, 3
  %166 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 120)
  %167 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %166, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %151, ptr %167, align 8
  %168 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %166, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %158, ptr %168, align 8
  %169 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %166, i64 2
  store %"github.com/goplus/llgo/internal/abi.Method" %165, ptr %169, align 8
  %170 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %166, 0
  %171 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %170, i64 3, 1
  %172 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %171, i64 3, 2
  %173 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 120)
  %174 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %173, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %148, ptr %174, align 8
  %175 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %173, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %155, ptr %175, align 8
  %176 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %173, i64 2
  store %"github.com/goplus/llgo/internal/abi.Method" %162, ptr %176, align 8
  %177 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %173, 0
  %178 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %177, i64 3, 1
  %179 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %178, i64 3, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %110, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @12, i64 17 }, ptr %131, %"github.com/goplus/llgo/internal/runtime.Slice" %172, %"github.com/goplus/llgo/internal/runtime.Slice" %179)
...
_llgo_37:                                         ; preds = %_llgo_36
  %184 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr undef }, ptr %180, 1
  %185 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef }, ptr %181, 1
  ...
  store %"github.com/goplus/llgo/internal/abi.Imethod" %184, ptr %187, align 8
  ...
  %189 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %186, 0
  %190 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %189, i64 2, 1
  %191 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %190, i64 2, 2
  %192 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %191)
  store ptr %192, ptr @"_llgo_iface$L2Ik-AJcd0jsoBw5fQ07pQpfUM-kh78Wn2bOeak6M3I", align 8
  br label %_llgo_38

_llgo_38:                                         ; preds = %_llgo_37, %_llgo_36
  %193 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @13, i64 14 }, i64 25, i64 16, i64 2, i64 2)
  ...
  %196 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr undef, ptr undef, ptr undef }, ptr %195, 1
  %197 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %196, ptr @"main.(*nopCloser).Close", 2
  %198 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %197, ptr @"main.(*nopCloser).Close", 3
  %199 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr undef, ptr undef, ptr undef }, ptr %195, 1
  %200 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %199, ptr @"main.(*nopCloser).Close", 2
  %201 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %200, ptr @main.nopCloser.Close, 3
  %202 = load ptr, ptr @"_llgo_func$06yPPin-fnDnxFKkLLcJ1GEUhIobjPimde7T_Id_hmY", align 8
  %203 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %202, 1
  %204 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %203, ptr @"main.(*nopCloser).Read", 2
  %205 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %204, ptr @"main.(*nopCloser).Read", 3
  %206 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %202, 1
  %207 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %206, ptr @"main.(*nopCloser).Read", 2
  %208 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %207, ptr @main.nopCloser.Read, 3
  %209 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %210 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %209, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %201, ptr %210, align 8
  %211 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %209, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %208, ptr %211, align 8
  %212 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %209, 0
  %213 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %212, i64 2, 1
  %214 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %213, i64 2, 2
  %215 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %216 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %215, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %198, ptr %216, align 8
  %217 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %215, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %205, ptr %217, align 8
  %218 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %215, 0
  %219 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %218, i64 2, 1
  %220 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %219, i64 2, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %193, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @14, i64 9 }, ptr %194, %"github.com/goplus/llgo/internal/runtime.Slice" %214, %"github.com/goplus/llgo/internal/runtime.Slice" %220)
  %221 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @15, i64 17 })
...
_llgo_41:                                         ; preds = %_llgo_40
  %229 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 8)
  %230 = getelementptr ptr, ptr %229, i64 0
  store ptr %224, ptr %230, align 8
  %231 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %229, 0
  %232 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %231, i64 1, 1
  %233 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %232, i64 1, 2
  ...
  %237 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %234, 0
  %238 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %237, i64 2, 1
  %239 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %238, i64 2, 2
  %240 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %233, %"github.com/goplus/llgo/internal/runtime.Slice" %239, i1 false)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %240)
...
_llgo_43:                                         ; preds = %_llgo_42
  %242 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @16, i64 11 }, ptr undef }, ptr %241, 1
  ...
  %245 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %243, 0
  %246 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %245, i64 1, 1
  %247 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %246, i64 1, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamedInterface"(ptr %221, %"github.com/goplus/llgo/internal/runtime.Slice" %247)
  br label %_llgo_44
...
_llgo_45:                                         ; preds = %_llgo_44
  %251 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @16, i64 11 }, ptr undef }, ptr %248, 1
  %252 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 24)
  %253 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %252, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %251, ptr %253, align 8
  ...
  %257 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %256)
  store ptr %257, ptr @"_llgo_iface$Ly4zXiUMEac-hYAMw6b6miJ1JEhGfLyBWyBOhpsRZcU", align 8
  br label %_llgo_46

_llgo_46:                                         ; preds = %_llgo_45, %_llgo_44
  %258 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @20, i64 17 }, i64 25, i64 32, i64 0, i64 10)
  store ptr %258, ptr @_llgo_main.stringReader, align 8
  %259 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 24)
  %260 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @21, i64 1 }, ptr %259, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %261 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 38)
  %262 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @22, i64 1 }, ptr %261, i64 16, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %263 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 34)
  %264 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @23, i64 8 }, ptr %263, i64 24, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %265 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 168)
  %266 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %265, i64 0
  store %"github.com/goplus/llgo/internal/abi.StructField" %260, ptr %266, align 8
  %267 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %265, i64 1
  store %"github.com/goplus/llgo/internal/abi.StructField" %262, ptr %267, align 8
  %268 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %265, i64 2
  store %"github.com/goplus/llgo/internal/abi.StructField" %264, ptr %268, align 8
  %269 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %265, 0
  %270 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %269, i64 3, 1
  %271 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %270, i64 3, 2
  %272 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, i64 32, %"github.com/goplus/llgo/internal/runtime.Slice" %271)
...
_llgo_47:                                         ; preds = %_llgo_46
  ...
  %278 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %277, 0
  %279 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %278, i64 0, 1
  %280 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %279, i64 0, 2
  %281 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 8)
  %282 = getelementptr ptr, ptr %281, i64 0
  store ptr %274, ptr %282, align 8
  %283 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %281, 0
  %284 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %283, i64 1, 1
  %285 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %284, i64 1, 2
  %286 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %280, %"github.com/goplus/llgo/internal/runtime.Slice" %285, i1 false)
...
_llgo_48:                                         ; preds = %_llgo_47, %_llgo_46
  ...
  %288 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @24, i64 3 }, ptr undef, ptr undef, ptr undef }, ptr %287, 1
  %289 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %288, ptr @"main.(*stringReader).Len", 2
  %290 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %289, ptr @"main.(*stringReader).Len", 3
  %291 = load ptr, ptr @"[]_llgo_byte", align 8
  %292 = load ptr, ptr @"_llgo_func$06yPPin-fnDnxFKkLLcJ1GEUhIobjPimde7T_Id_hmY", align 8
  %293 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %292, 1
  %294 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %293, ptr @"main.(*stringReader).Read", 2
  %295 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %294, ptr @"main.(*stringReader).Read", 3
...
_llgo_49:                                         ; preds = %_llgo_48
  %303 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 16)
  ...
  %306 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %303, 0
  %307 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %306, i64 2, 1
  %308 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %307, i64 2, 2
  %309 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 16)
  ...
  %312 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %309, 0
  %313 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %312, i64 2, 1
  %314 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %313, i64 2, 2
  %315 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %308, %"github.com/goplus/llgo/internal/runtime.Slice" %314, i1 false)
...
_llgo_50:                                         ; preds = %_llgo_49, %_llgo_48
  ...
  %317 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @25, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %316, 1
  %318 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %317, ptr @"main.(*stringReader).ReadAt", 2
  %319 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %318, ptr @"main.(*stringReader).ReadAt", 3
...
_llgo_51:                                         ; preds = %_llgo_50
  %324 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 0)
  %325 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %324, 0
  %326 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %325, i64 0, 1
  %327 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %326, i64 0, 2
  %328 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 16)
  ...
  %331 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %328, 0
  %332 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %331, i64 2, 1
  %333 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %332, i64 2, 2
  %334 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %327, %"github.com/goplus/llgo/internal/runtime.Slice" %333, i1 false)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %334)
...
_llgo_52:                                         ; preds = %_llgo_51, %_llgo_50
  ...
  %336 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @26, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %335, 1
  %337 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %336, ptr @"main.(*stringReader).ReadByte", 2
  %338 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %337, ptr @"main.(*stringReader).ReadByte", 3
  %339 = load ptr, ptr @_llgo_rune, align 8
  %340 = icmp eq ptr %339, null
  br i1 %340, label %_llgo_53, label %_llgo_54

_llgo_53:                                         ; preds = %_llgo_52
  %341 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 37)
...
_llgo_55:                                         ; preds = %_llgo_54
  %348 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 0)
  %349 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %348, 0
  %350 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %349, i64 0, 1
  %351 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %350, i64 0, 2
  ...
  %356 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %352, 0
  %357 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %356, i64 3, 1
  %358 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %357, i64 3, 2
  %359 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %351, %"github.com/goplus/llgo/internal/runtime.Slice" %358, i1 false)
...
_llgo_56:                                         ; preds = %_llgo_55, %_llgo_54
  ...
  %361 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @27, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %360, 1
  %362 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %361, ptr @"main.(*stringReader).ReadRune", 2
  %363 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %362, ptr @"main.(*stringReader).ReadRune", 3
...
_llgo_57:                                         ; preds = %_llgo_56
  %370 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 16)
  ...
  %373 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %370, 0
  %374 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %373, i64 2, 1
  %375 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %374, i64 2, 2
  %376 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 16)
  ...
  %379 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %376, 0
  %380 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %379, i64 2, 1
  %381 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %380, i64 2, 2
  %382 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %375, %"github.com/goplus/llgo/internal/runtime.Slice" %381, i1 false)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %382)
...
_llgo_58:                                         ; preds = %_llgo_57, %_llgo_56
  ...
  %384 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @28, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %383, 1
  %385 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %384, ptr @"main.(*stringReader).Seek", 2
  %386 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %385, ptr @"main.(*stringReader).Seek", 3
...
_llgo_59:                                         ; preds = %_llgo_58
  %390 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 0)
  %391 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %390, 0
  %392 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %391, i64 0, 1
  %393 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %392, i64 0, 2
  %394 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 8)
  %395 = getelementptr ptr, ptr %394, i64 0
  store ptr %387, ptr %395, align 8
  %396 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %394, 0
  %397 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %396, i64 1, 1
  %398 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %397, i64 1, 2
  %399 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %393, %"github.com/goplus/llgo/internal/runtime.Slice" %398, i1 false)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %399)
...
_llgo_60:                                         ; preds = %_llgo_59, %_llgo_58
  ...
  %401 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @29, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %400, 1
  %402 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %401, ptr @"main.(*stringReader).Size", 2
  %403 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %402, ptr @"main.(*stringReader).Size", 3
  %404 = load ptr, ptr @"_llgo_func$8rsrSd_r3UHd_2DiYTyaOKR7BYkei4zw5ysG35KF38w", align 8
  %405 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @30, i64 10 }, ptr undef, ptr undef, ptr undef }, ptr %404, 1
  %406 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %405, ptr @"main.(*stringReader).UnreadByte", 2
  %407 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %406, ptr @"main.(*stringReader).UnreadByte", 3
  %408 = load ptr, ptr @"_llgo_func$8rsrSd_r3UHd_2DiYTyaOKR7BYkei4zw5ysG35KF38w", align 8
  %409 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @31, i64 10 }, ptr undef, ptr undef, ptr undef }, ptr %408, 1
  %410 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %409, ptr @"main.(*stringReader).UnreadRune", 2
  %411 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %410, ptr @"main.(*stringReader).UnreadRune", 3
  %412 = load ptr, ptr @"_llgo_func$MrYxYl10p_I07B55pBsGw9la9zbzU2vGDPLWrT714Uk", align 8
  %413 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 7 }, ptr undef, ptr undef, ptr undef }, ptr %412, 1
  %414 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %413, ptr @"main.(*stringReader).WriteTo", 2
  %415 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %414, ptr @"main.(*stringReader).WriteTo", 3
  %416 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 400)
  %417 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %290, ptr %417, align 8
  %418 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %295, ptr %418, align 8
  %419 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 2
  store %"github.com/goplus/llgo/internal/abi.Method" %319, ptr %419, align 8
  %420 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 3
  store %"github.com/goplus/llgo/internal/abi.Method" %338, ptr %420, align 8
  %421 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 4
  store %"github.com/goplus/llgo/internal/abi.Method" %363, ptr %421, align 8
  %422 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 5
  store %"github.com/goplus/llgo/internal/abi.Method" %386, ptr %422, align 8
  %423 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 6
  store %"github.com/goplus/llgo/internal/abi.Method" %403, ptr %423, align 8
  %424 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 7
  store %"github.com/goplus/llgo/internal/abi.Method" %407, ptr %424, align 8
  %425 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 8
  store %"github.com/goplus/llgo/internal/abi.Method" %411, ptr %425, align 8
  %426 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %416, i64 9
  store %"github.com/goplus/llgo/internal/abi.Method" %415, ptr %426, align 8
  %427 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %416, 0
  %428 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %427, i64 10, 1
  %429 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %428, i64 10, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %258, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @32, i64 12 }, ptr %273, { ptr, i64, i64 } zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %429)
  %430 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @20, i64 17 }, i64 25, i64 32, i64 0, i64 10)
  %431 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %430)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %431)
...
_llgo_61:                                         ; preds = %_llgo_60
  %435 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 4 }, ptr undef }, ptr %432, 1
  %436 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 24)
  %437 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %436, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %435, ptr %437, align 8
  %438 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %436, 0
  %439 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %438, i64 1, 1
  %440 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %439, i64 1, 2
  %441 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %440)
  store ptr %441, ptr @"_llgo_iface$OFO8Us9n8ajWCabGedeuoJ-Za2zAMk4Jh0FunAcUCFE", align 8
  br label %_llgo_62

_llgo_62:                                         ; preds = %_llgo_61, %_llgo_60
  %442 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @33, i64 16 }, i64 25, i64 16, i64 0, i64 1)
  store ptr %442, ptr @_llgo_main.errorString, align 8
  %443 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 24)
  %444 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @21, i64 1 }, ptr %443, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %445 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 56)
  %446 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %445, i64 0
  store %"github.com/goplus/llgo/internal/abi.StructField" %444, ptr %446, align 8
  ...
  %450 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, i64 16, %"github.com/goplus/llgo/internal/runtime.Slice" %449)
  ...
  %453 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 5 }, ptr undef, ptr undef, ptr undef }, ptr %452, 1
  %454 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %453, ptr @"main.(*errorString).Error", 2
  %455 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %454, ptr @"main.(*errorString).Error", 3
  %456 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 40)
  %457 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %456, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %455, ptr %457, align 8
  %458 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %456, 0
  %459 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %458, i64 1, 1
  %460 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %459, i64 1, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %442, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @34, i64 11 }, ptr %451, { ptr, i64, i64 } zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %460)
  %461 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @33, i64 16 }, i64 25, i64 16, i64 0, i64 1)
  %462 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %461)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %462)
...
_llgo_63:                                         ; preds = %_llgo_62
  %466 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 5 }, ptr undef }, ptr %463, 1
  %467 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 24)
  %468 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %467, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %466, ptr %468, align 8
  %469 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %467, 0
  %470 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %469, i64 1, 1
  %471 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %470, i64 1, 2
  %472 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %471)
