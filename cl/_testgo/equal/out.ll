...
_llgo_4:                                          ; preds = %_llgo_3, %_llgo_2
  ...
  %10 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, i64 0, %"github.com/goplus/llgo/internal/runtime.Slice" %9)
  store ptr %10, ptr @"_llgo_struct$n1H8J_3prDN3firMwPxBLVTkE5hJ9Di-AqNvaC9jczw", align 8
  %11 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 6 }, i64 25, i64 48, i64 0, i64 0)
...
_llgo_7:                                          ; preds = %_llgo_6
  ...
  %20 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %19)
  store ptr %20, ptr @_llgo_any, align 8
  br label %_llgo_8

_llgo_8:                                          ; preds = %_llgo_7, %_llgo_6
  %21 = load ptr, ptr @_llgo_any, align 8
  %22 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 34)
  %23 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 1 }, ptr %22, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %24 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 34)
  %25 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 1 }, ptr %24, i64 8, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %26 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 24)
  %27 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 1 }, ptr %26, i64 16, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  ...
  %32 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %31)
  %33 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @8, i64 1 }, ptr %32, i64 32, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %34 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 224)
  %35 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %34, i64 0
  store %"github.com/goplus/llgo/internal/abi.StructField" %23, ptr %35, align 8
  %36 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %34, i64 1
  store %"github.com/goplus/llgo/internal/abi.StructField" %25, ptr %36, align 8
  %37 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %34, i64 2
  store %"github.com/goplus/llgo/internal/abi.StructField" %27, ptr %37, align 8
  %38 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %34, i64 3
  store %"github.com/goplus/llgo/internal/abi.StructField" %33, ptr %38, align 8
  %39 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %34, 0
  %40 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %39, i64 4, 1
  %41 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %40, i64 4, 2
  %42 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, i64 48, %"github.com/goplus/llgo/internal/runtime.Slice" %41)
...
_llgo_9:                                          ; preds = %_llgo_8
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %11, %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 1 }, ptr %43, { ptr, i64, i64 } zeroinitializer, { ptr, i64, i64 } zeroinitializer)
  br label %_llgo_10

_llgo_10:                                         ; preds = %_llgo_9, %_llgo_8
  %44 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @10, i64 6 }, i64 25, i64 0, i64 0, i64 0)
...
_llgo_13:                                         ; preds = %_llgo_12
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %44, %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 1 }, ptr %47, { ptr, i64, i64 } zeroinitializer, { ptr, i64, i64 } zeroinitializer)
  br label %_llgo_14
...
_llgo_15:                                         ; preds = %_llgo_14
  ...
  %52 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 40)
  %53 = call ptr @"github.com/goplus/llgo/internal/runtime.ArrayOf"(i64 8, ptr %52)
  %54 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @12, i64 7 }, ptr %53, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %55 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 34)
  %56 = call ptr @"github.com/goplus/llgo/internal/runtime.ArrayOf"(i64 8, ptr %55)
  %57 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @13, i64 4 }, ptr %56, i64 8, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %58 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 24)
  %59 = call ptr @"github.com/goplus/llgo/internal/runtime.ArrayOf"(i64 8, ptr %58)
  %60 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @14, i64 5 }, ptr %59, i64 72, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %61 = call ptr @"github.com/goplus/llgo/internal/runtime.Basic"(i64 58)
  %62 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @15, i64 8 }, ptr %61, i64 200, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 false)
  %63 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 224)
  %64 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %63, i64 0
  store %"github.com/goplus/llgo/internal/abi.StructField" %54, ptr %64, align 8
  %65 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %63, i64 1
  store %"github.com/goplus/llgo/internal/abi.StructField" %57, ptr %65, align 8
  %66 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %63, i64 2
  store %"github.com/goplus/llgo/internal/abi.StructField" %60, ptr %66, align 8
  %67 = getelementptr %"github.com/goplus/llgo/internal/abi.StructField", ptr %63, i64 3
  store %"github.com/goplus/llgo/internal/abi.StructField" %62, ptr %67, align 8
  %68 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %63, 0
  %69 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %68, i64 4, 1
  %70 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %69, i64 4, 2
  %71 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, i64 208, %"github.com/goplus/llgo/internal/runtime.Slice" %70)
  %72 = call ptr @"github.com/goplus/llgo/internal/runtime.MapOf"(ptr %50, ptr %51, ptr %71, i64 4)
