...
define { ptr, ptr } @"github.com/goplus/llgo/cl/_testgo/cfuncpollute.makeClosure"(i64 %0) {
_llgo_0:
  ...
  %4 = insertvalue { ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/cfuncpollute.makeClosure$1", ptr undef }, ptr %2, 1
  ret { ptr, ptr } %4
}
