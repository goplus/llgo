...
_llgo_0:
  %0 = alloca %"main.Data[int]", align 8
  call void @llvm.memset(ptr %0, i8 0, i64 8, i1 false)
  %1 = getelementptr inbounds %"main.Data[int]", ptr %0, i32 0, i32 0
  store i64 1, ptr %1, align 4
  %2 = load %"main.Data[int]", ptr %0, align 4
  %3 = extractvalue %"main.Data[int]" %2, 0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintInt"(i64 %3)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  %4 = alloca %"main.Data[string]", align 8
  call void @llvm.memset(ptr %4, i8 0, i64 16, i1 false)
  %5 = getelementptr inbounds %"main.Data[string]", ptr %4, i32 0, i32 0
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 5 }, ptr %5, align 8
  %6 = load %"main.Data[string]", ptr %4, align 8
  %7 = extractvalue %"main.Data[string]" %6, 0
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  %8 = alloca %"main.Data[int]", align 8
  call void @llvm.memset(ptr %8, i8 0, i64 8, i1 false)
  %9 = getelementptr inbounds %"main.Data[int]", ptr %8, i32 0, i32 0
  store i64 100, ptr %9, align 4
  %10 = load %"main.Data[int]", ptr %8, align 4
  %11 = extractvalue %"main.Data[int]" %10, 0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintInt"(i64 %11)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  %12 = alloca %"main.Data[string]", align 8
  call void @llvm.memset(ptr %12, i8 0, i64 16, i1 false)
  %13 = getelementptr inbounds %"main.Data[string]", ptr %12, i32 0, i32 0
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 5 }, ptr %13, align 8
  %14 = load %"main.Data[string]", ptr %12, align 8
  ...
  %22 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"main.(*Slice[[]int,int]).Append"(ptr %16, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %21)
  ...
  %29 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"main.(*Slice[[]string,string]).Append"(ptr %23, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %28)
  ...
  %39 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"main.(*Slice[[]int,int]).Append"(ptr %30, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %38)
  ...
  %48 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"main.(*Slice[[]int,int]).Append2"(ptr %30, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %47)
  %49 = getelementptr inbounds %"main.Slice[[]int,int]", ptr %16, i32 0, i32 0
  %50 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %49, align 8
  %51 = getelementptr inbounds %"main.Slice[[]int,int]", ptr %16, i32 0, i32 0
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  %58 = getelementptr inbounds %"main.Slice[[]string,string]", ptr %23, i32 0, i32 0
  %59 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %58, align 8
  %60 = getelementptr inbounds %"main.Slice[[]string,string]", ptr %23, i32 0, i32 0
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  %67 = getelementptr inbounds %"main.Slice[[]int,int]", ptr %30, i32 0, i32 0
  %68 = load %"github.com/goplus/llgo/runtime/internal/runtime.Slice", ptr %67, align 8
  %69 = getelementptr inbounds %"main.Slice[[]int,int]", ptr %30, i32 0, i32 0
