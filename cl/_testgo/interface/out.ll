...
_llgo_4:                                          ; preds = %_llgo_3, %_llgo_2
  ...
  %10 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, i64 0, %"github.com/goplus/llgo/internal/runtime.Slice" %9)
...
_llgo_6:                                          ; preds = %_llgo_8, %_llgo_4
  %14 = load ptr, ptr @"_llgo_github.com/goplus/llgo/cl/internal/foo.Game", align 8
  %15 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @1, i64 43 }, i64 25, i64 0, i64 0, i64 2)
...
_llgo_8:                                          ; preds = %_llgo_7, %_llgo_5
  ...
  %28 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %27, 1
  %29 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %28, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).Load", 2
  %30 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %29, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).Load", 3
  %31 = load ptr, ptr @"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", align 8
  %32 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 47 }, ptr undef, ptr undef, ptr undef }, ptr %31, 1
  %33 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %32, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).initGame", 2
  %34 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %33, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).initGame", 3
  %35 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %36 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %35, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %30, ptr %36, align 8
  %37 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %35, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %34, ptr %37, align 8
  ...
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %3, %"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 38 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 4 }, ptr %11, { ptr, i64, i64 } zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %40)
  br label %_llgo_6

_llgo_9:                                          ; preds = %_llgo_6
  %41 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %15)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %41)
  store ptr %41, ptr @"*_llgo_github.com/goplus/llgo/cl/internal/foo.Game", align 8
  br label %_llgo_10

_llgo_10:                                         ; preds = %_llgo_9, %_llgo_6
  %42 = load ptr, ptr @"*_llgo_github.com/goplus/llgo/cl/internal/foo.Game", align 8
  %43 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @1, i64 43 }, i64 25, i64 0, i64 0, i64 2)
  %44 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %43)
  %45 = call %"github.com/goplus/llgo/internal/abi.StructField" @"github.com/goplus/llgo/internal/runtime.StructField"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 4 }, ptr %44, i64 0, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, i1 true)
  ...
  store %"github.com/goplus/llgo/internal/abi.StructField" %45, ptr %47, align 8
  ...
  %51 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, i64 8, %"github.com/goplus/llgo/internal/runtime.Slice" %50)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %51)
  store ptr %51, ptr @"_llgo_struct$cJmCzeVn0orHWafCrTGAnbbAF46F2A4Fms4bJBm8ITI", align 8
  %52 = load ptr, ptr @"_llgo_struct$cJmCzeVn0orHWafCrTGAnbbAF46F2A4Fms4bJBm8ITI", align 8
  br i1 %2, label %_llgo_11, label %_llgo_12

_llgo_11:                                         ; preds = %_llgo_10
  %53 = load ptr, ptr @"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", align 8
  %54 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %53, 1
  %55 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %54, ptr @"main.(*Game1).Load", 2
  %56 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %55, ptr @"main.(*Game1).Load", 3
  %57 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, ptr undef, ptr undef, ptr undef }, ptr %53, 1
  %58 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %57, ptr @"main.(*Game1).Load", 2
  %59 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %58, ptr @main.Game1.Load, 3
  %60 = load ptr, ptr @"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", align 8
  %61 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 47 }, ptr undef, ptr undef, ptr undef }, ptr %60, 1
  %62 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %61, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).initGame", 2
  %63 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %62, ptr @"github.com/goplus/llgo/cl/internal/foo.(*Game).initGame", 3
  %64 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 40)
  %65 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %64, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %59, ptr %65, align 8
  ...
  %69 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %70 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %69, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %56, ptr %70, align 8
  %71 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %69, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %63, ptr %71, align 8
  %72 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %69, 0
  %73 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %72, i64 2, 1
  %74 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %73, i64 2, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %0, %"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @8, i64 5 }, ptr %52, %"github.com/goplus/llgo/internal/runtime.Slice" %68, %"github.com/goplus/llgo/internal/runtime.Slice" %74)
  br label %_llgo_12

_llgo_12:                                         ; preds = %_llgo_11, %_llgo_10
  %75 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 10 }, i64 25, i64 8, i64 2, i64 2)
  %76 = load ptr, ptr @"*_llgo_main.Game1", align 8
  %77 = icmp eq ptr %76, null
  br i1 %77, label %_llgo_13, label %_llgo_14

_llgo_13:                                         ; preds = %_llgo_12
  %78 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %75)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %78)
  store ptr %78, ptr @"*_llgo_main.Game1", align 8
  br label %_llgo_14

_llgo_14:                                         ; preds = %_llgo_13, %_llgo_12
  %79 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 10 }, i64 25, i64 0, i64 0, i64 1)
...
_llgo_17:                                         ; preds = %_llgo_16
  ...
  %84 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @10, i64 13 }, ptr undef, ptr undef, ptr undef }, ptr %83, 1
  %85 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %84, ptr @"main.(*Game2).initGame", 2
  %86 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %85, ptr @"main.(*Game2).initGame", 3
  %87 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 40)
  %88 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %87, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %86, ptr %88, align 8
  %89 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %87, 0
  %90 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %89, i64 1, 1
  %91 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %90, i64 1, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %79, %"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 5 }, ptr %82, { ptr, i64, i64 } zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %91)
  br label %_llgo_18

_llgo_18:                                         ; preds = %_llgo_17, %_llgo_16
  %92 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @9, i64 10 }, i64 25, i64 0, i64 0, i64 1)
  %93 = load ptr, ptr @"*_llgo_main.Game2", align 8
  %94 = icmp eq ptr %93, null
  br i1 %94, label %_llgo_19, label %_llgo_20

_llgo_19:                                         ; preds = %_llgo_18
  %95 = call ptr @"github.com/goplus/llgo/internal/runtime.PointerTo"(ptr %92)
  call void @"github.com/goplus/llgo/internal/runtime.SetDirectIface"(ptr %95)
  store ptr %95, ptr @"*_llgo_main.Game2", align 8
  br label %_llgo_20

_llgo_20:                                         ; preds = %_llgo_19, %_llgo_18
  %96 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 38 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @12, i64 44 })
  %97 = load ptr, ptr @"_llgo_github.com/goplus/llgo/cl/internal/foo.Gamer", align 8
  %98 = icmp eq ptr %97, null
  br i1 %98, label %_llgo_21, label %_llgo_22

_llgo_21:                                         ; preds = %_llgo_20
  store ptr %96, ptr @"_llgo_github.com/goplus/llgo/cl/internal/foo.Gamer", align 8
  br label %_llgo_22
...
_llgo_23:                                         ; preds = %_llgo_22
  %101 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, ptr undef }, ptr %99, 1
  %102 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 47 }, ptr undef }, ptr %100, 1
  %103 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 48)
  %104 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %103, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %101, ptr %104, align 8
  %105 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %103, i64 1
  store %"github.com/goplus/llgo/internal/abi.Imethod" %102, ptr %105, align 8
  %106 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %103, 0
  %107 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %106, i64 2, 1
  %108 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %107, i64 2, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamedInterface"(ptr %96, %"github.com/goplus/llgo/internal/runtime.Slice" %108)
  br label %_llgo_24
...
_llgo_24:                                         ; preds = %_llgo_23, %_llgo_22
  ...
  %111 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @3, i64 4 }, ptr undef }, ptr %109, 1
  %112 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 47 }, ptr undef }, ptr %110, 1
  %113 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 48)
  %114 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %113, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %111, ptr %114, align 8
  %115 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %113, i64 1
  store %"github.com/goplus/llgo/internal/abi.Imethod" %112, ptr %115, align 8
  %116 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %113, 0
  %117 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %116, i64 2, 1
  %118 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %117, i64 2, 2
  %119 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %118)
