...
define void @"github.com/goplus/llgo/cl/_testgo/oncedo.(*Once).Do"(ptr %0, { ptr, ptr } %1) {
_llgo_0:
...
_llgo_0:
  call void @"github.com/goplus/llgo/cl/_testgo/oncedo.(*Once).Do"(ptr @"github.com/goplus/llgo/cl/_testgo/oncedo.once", { ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/oncedo.main$1", ptr null })
  call void @"github.com/goplus/llgo/cl/_testgo/oncedo.(*Once).Do"(ptr @"github.com/goplus/llgo/cl/_testgo/oncedo.once", { ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/oncedo.main$2", ptr null })
