...
_llgo_0:
  ...
  %1 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 0)
  %2 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %1, 0
  %3 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %2, i64 0, 1
  %4 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %3, i64 0, 2
  %5 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, i64 0, %"github.com/goplus/llgo/internal/runtime.Slice" %4)
...
_llgo_4:                                          ; preds = %_llgo_3, %_llgo_2
  ...
  %25 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %24, 1
  %26 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %25, ptr @"main.(*impl).one", 2
  %27 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %26, ptr @"main.(*impl).one", 3
  %28 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %24, 1
  %29 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %28, ptr @"main.(*impl).one", 2
  %30 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %29, ptr @main.impl.one, 3
...
_llgo_7:                                          ; preds = %_llgo_6
  ...
  %39 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %38, 0
  %40 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %39, i64 0, 1
  %41 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %40, i64 0, 2
  %42 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 8)
  ...
  %47 = call ptr @"github.com/goplus/llgo/internal/runtime.Func"(%"github.com/goplus/llgo/internal/runtime.Slice" %41, %"github.com/goplus/llgo/internal/runtime.Slice" %46, i1 false)
...
_llgo_8:                                          ; preds = %_llgo_7, %_llgo_6
  ...
  %49 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %48, 1
  %50 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %49, ptr @"main.(*impl).two", 2
  %51 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %50, ptr @"main.(*impl).two", 3
  %52 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 8 }, ptr undef, ptr undef, ptr undef }, ptr %48, 1
  %53 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %52, ptr @"main.(*impl).two", 2
  %54 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %53, ptr @main.impl.two, 3
  %55 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %56 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %55, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %30, ptr %56, align 8
  %57 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %55, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %54, ptr %57, align 8
  %58 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %55, 0
  ...
  %61 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %62 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %61, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %27, ptr %62, align 8
  %63 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %61, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %51, ptr %63, align 8
  %64 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %61, 0
  %65 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %64, i64 2, 1
  %66 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %65, i64 2, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %0, %"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @6, i64 4 }, ptr %6, %"github.com/goplus/llgo/internal/runtime.Slice" %60, %"github.com/goplus/llgo/internal/runtime.Slice" %66)
  ...
  %69 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 8 }, ptr undef }, ptr %67, 1
  %70 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 8 }, ptr undef }, ptr %68, 1
  %71 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 48)
  %72 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %71, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %69, ptr %72, align 8
  %73 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %71, i64 1
  store %"github.com/goplus/llgo/internal/abi.Imethod" %70, ptr %73, align 8
  %74 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %71, 0
  %75 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %74, i64 2, 1
  %76 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %75, i64 2, 2
  %77 = call ptr @"github.com/goplus/llgo/internal/runtime.Interface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/internal/runtime.Slice" %76)
  store ptr %77, ptr @"main.iface$zZ89tENb5h_KNjvpxf1TXPfaWFYn0IZrZwyVf42lRtA", align 8
  %78 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @2, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 6 })
...
_llgo_11:                                         ; preds = %_llgo_10
  %83 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 8 }, ptr undef }, ptr %81, 1
  %84 = insertvalue %"github.com/goplus/llgo/internal/abi.Imethod" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @5, i64 8 }, ptr undef }, ptr %82, 1
  %85 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 48)
  %86 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %85, i64 0
  store %"github.com/goplus/llgo/internal/abi.Imethod" %83, ptr %86, align 8
  %87 = getelementptr %"github.com/goplus/llgo/internal/abi.Imethod", ptr %85, i64 1
  store %"github.com/goplus/llgo/internal/abi.Imethod" %84, ptr %87, align 8
  %88 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %85, 0
  %89 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %88, i64 2, 1
  %90 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %89, i64 2, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamedInterface"(ptr %78, %"github.com/goplus/llgo/internal/runtime.Slice" %90)
  br label %_llgo_12
