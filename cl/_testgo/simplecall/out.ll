...
define void @"github.com/goplus/llgo/cl/_testgo/simplecall.callFunc"({ ptr, ptr } %0) {
_llgo_0:
...
_llgo_0:
  call void @"github.com/goplus/llgo/cl/_testgo/simplecall.callFunc"({ ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/simplecall.main$1", ptr null })
