...
_llgo_18:                                         ; preds = %_llgo_17, %_llgo_16
  ...
  %67 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %66, 0
  %68 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %67, i64 0, 1
  %69 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %68, i64 0, 2
  %70 = call ptr @"github.com/goplus/llgo/internal/runtime.Struct"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, i64 0, %"github.com/goplus/llgo/internal/runtime.Slice" %69)
...
_llgo_19:                                         ; preds = %_llgo_18
  ...
  %73 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %72, 1
  %74 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %73, ptr @"main.(*C1).f", 2
  %75 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %74, ptr @"main.(*C1).f", 3
  %76 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %72, 1
  %77 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %76, ptr @"main.(*C1).f", 2
  %78 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %77, ptr @main.C1.f, 3
  %79 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 40)
  %80 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %79, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %78, ptr %80, align 8
  %81 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %79, 0
  %82 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %81, i64 1, 1
  %83 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %82, i64 1, 2
  %84 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 40)
  %85 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %84, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %75, ptr %85, align 8
  %86 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" undef, ptr %84, 0
  %87 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %86, i64 1, 1
  %88 = insertvalue %"github.com/goplus/llgo/internal/runtime.Slice" %87, i64 1, 2
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %63, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @11, i64 2 }, ptr %71, %"github.com/goplus/llgo/internal/runtime.Slice" %83, %"github.com/goplus/llgo/internal/runtime.Slice" %88)
  br label %_llgo_20

_llgo_20:                                         ; preds = %_llgo_19, %_llgo_18
  %89 = call ptr @"github.com/goplus/llgo/internal/runtime.NewNamed"(%"github.com/goplus/llgo/internal/runtime.String" { ptr @15, i64 7 }, i64 25, i64 0, i64 2, i64 2)
...
_llgo_23:                                         ; preds = %_llgo_22
  ...
  %94 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %93, 1
  %95 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %94, ptr @"main.(*C2).f", 2
  %96 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %95, ptr @"main.(*C2).f", 3
  %97 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @4, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %93, 1
  %98 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %97, ptr @"main.(*C2).f", 2
  %99 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %98, ptr @main.C2.f, 3
  %100 = load ptr, ptr @"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", align 8
  %101 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %100, 1
  %102 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %101, ptr @"main.(*C2).g", 2
  %103 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %102, ptr @"main.(*C2).g", 3
  %104 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" { %"github.com/goplus/llgo/internal/runtime.String" { ptr @7, i64 6 }, ptr undef, ptr undef, ptr undef }, ptr %100, 1
  %105 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %104, ptr @"main.(*C2).g", 2
  %106 = insertvalue %"github.com/goplus/llgo/internal/abi.Method" %105, ptr @main.C2.g, 3
  ...
  store %"github.com/goplus/llgo/internal/abi.Method" %99, ptr %108, align 8
  %109 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %107, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %106, ptr %109, align 8
  ...
  %113 = call ptr @"github.com/goplus/llgo/internal/runtime.AllocU"(i64 80)
  %114 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %113, i64 0
  store %"github.com/goplus/llgo/internal/abi.Method" %96, ptr %114, align 8
  %115 = getelementptr %"github.com/goplus/llgo/internal/abi.Method", ptr %113, i64 1
  store %"github.com/goplus/llgo/internal/abi.Method" %103, ptr %115, align 8
  ...
  call void @"github.com/goplus/llgo/internal/runtime.InitNamed"(ptr %89, %"github.com/goplus/llgo/internal/runtime.String" { ptr @0, i64 4 }, %"github.com/goplus/llgo/internal/runtime.String" { ptr @17, i64 2 }, ptr %92, %"github.com/goplus/llgo/internal/runtime.Slice" %112, %"github.com/goplus/llgo/internal/runtime.Slice" %118)
  br label %_llgo_24
