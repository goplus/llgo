...
!0 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_closure$QIHBTaw1IFobr8yvWpq-2AJFm3xBNhdW_aNBicqUBGk"}
!1 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_int"}
!2 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_string"}
!3 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_closure$QIHBTaw1IFobr8yvWpq-2AJFm3xBNhdW_aNBicqUBGk"}
!4 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_int"}
!5 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_string"}
!6 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"*_llgo_github.com/goplus/llgo/cl/_testgo/reflect.T"}
!7 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_int"}
!8 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_string"}
!9 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"*_llgo_github.com/goplus/llgo/cl/_testgo/reflect.T"}
!10 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_int"}
!11 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_string"}
!12 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"_llgo_closure$FjMjjQr3-2iTiWyZP1IIQFOz0hUCa0OS6pEm5uVV6Pk"}
!13 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"_llgo_int"}
!14 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"[]_llgo_any"}
!15 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.demo", !"_llgo_string"}
!16 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"map[_llgo_int]_llgo_string"}
!17 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_string"}
!18 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_int"}
!19 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_int"}
!20 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_string"}
!21 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!22 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!23 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!24 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!25 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_reflect.Type", !"Key", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!26 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_reflect.Type", !"Elem", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!27 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_reflect.Type", !"Key", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!28 = !{ptr @"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_reflect.Type", !"Elem", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
