...
_llgo_0:
  %0 = alloca %"github.com/goplus/llgo/cl/_testgo/closure.T", align 8
  %1 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64 16)
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 3 }, ptr %1, align 8
  %2 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 8)
  %3 = getelementptr inbounds { ptr }, ptr %2, i32 0, i32 0
  store ptr %1, ptr %3, align 8
  %4 = insertvalue { ptr, ptr } { ptr @"github.com/goplus/llgo/cl/_testgo/closure.main$2", ptr undef }, ptr %2, 1
  store { ptr, ptr } %4, ptr %0, align 8
  %5 = load %"github.com/goplus/llgo/cl/_testgo/closure.T", ptr %0, align 8
