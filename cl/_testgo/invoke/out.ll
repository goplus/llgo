...
_llgo_0:
  ...
  %8 = getelementptr inbounds %main.T5, ptr %7, i32 0, i32 0
  store i64 300, ptr %8, align 4
  %9 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64 16)
  store %main.T6 { ptr @"__llgo_stub.main.main$1", ptr null }, ptr %9, align 8
  %10 = load %main.T, ptr %0, align 8
  %11 = load ptr, ptr @_llgo_main.T, align 8
  %12 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %main.T %10, ptr %12, align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %17)
  %18 = load ptr, ptr @"*_llgo_main.T", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %22)
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %29)
  %30 = load ptr, ptr @"*_llgo_main.T1", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %34)
  %35 = load double, ptr %3, align 8
  %36 = load ptr, ptr @_llgo_main.T2, align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %42)
  %43 = load ptr, ptr @"*_llgo_main.T2", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %47)
  %48 = load ptr, ptr @_llgo_main.T3, align 8
  %49 = load ptr, ptr @"*_llgo_main.T3", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %53)
  %54 = load [1 x i64], ptr %5, align 4
  %55 = load ptr, ptr @_llgo_main.T4, align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %61)
  %62 = load ptr, ptr @"*_llgo_main.T4", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %66)
  %67 = load %main.T5, ptr %7, align 4
  %68 = load ptr, ptr @_llgo_main.T5, align 8
  %69 = extractvalue %main.T5 %67, 0
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %74)
  %75 = load ptr, ptr @"*_llgo_main.T5", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %79)
  %80 = load %main.T6, ptr %9, align 8
  %81 = load ptr, ptr @_llgo_main.T6, align 8
  %82 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %main.T6 %80, ptr %82, align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %86)
  %87 = load ptr, ptr @"*_llgo_main.T6", align 8
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %91)
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %109)
  %110 = alloca %main.T, align 8
  call void @llvm.memset(ptr %110, i8 0, i64 16, i1 false)
  %111 = getelementptr inbounds %main.T, ptr %110, i32 0, i32 0
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @22, i64 5 }, ptr %111, align 8
  %112 = load %main.T, ptr %110, align 8
  %113 = load ptr, ptr @_llgo_main.T, align 8
  %114 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 16)
  store %main.T %112, ptr %114, align 8
  ...
  %118 = load ptr, ptr @_llgo_main.I, align 8
...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %124)
...
_llgo_5:                                          ; preds = %_llgo_3
  ...
  call void @main.invoke(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %143)
  ret void
...
_llgo_56:                                         ; preds = %_llgo_55, %_llgo_54
  ...
  %225 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %224, i64 0, 1
  %226 = insertvalue %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %225, i64 0, 2
  %227 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Basic"(i64 34)
