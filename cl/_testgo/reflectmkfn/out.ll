...
@"__llgo_closure_const$github.com/goplus/llgo/cl/_testgo/reflectmkfn.main$1" = private constant { ptr, i64 } { ptr @"github.com/goplus/llgo/cl/_testgo/reflectmkfn.main$1", i64 0 }
@"_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 0, i32 1717305258, i8 32, i8 8, i8 8, i8 57, ptr null, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 50 }, ptr @"*_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY$fields", i64 2, i64 2 } }, align 8
@2 = private unnamed_addr constant [50 x i8] c"struct { $f func(string, int) string; $h uintptr }", align 1
@"*_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -208537121, i8 10, i8 8, i8 8, i8 54, ptr @"__llgo_closure_const$github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @2, i64 50 }, ptr null }, ptr @"_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY" }, align 8
@3 = private unnamed_addr constant [2 x i8] c"$f", align 1
@"_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.FuncType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 1371530963, i8 0, i8 8, i8 8, i8 51, ptr null, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 24 }, ptr @"*_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI" }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI$in", i64 2, i64 2 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI$out", i64 1, i64 1 } }, align 8
@4 = private unnamed_addr constant [24 x i8] c"func(string, int) string", align 1
@"*_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.PtrType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1546681513, i8 10, i8 8, i8 8, i8 54, ptr @"__llgo_closure_const$github.com/goplus/llgo/runtime/internal/runtime.memequalptr", ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 24 }, ptr null }, ptr @"_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI" }, align 8
...
@"_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY$fields" = weak_odr constant [2 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 2 }, ptr @"_llgo_func$CFociaKlCvq9sERkLkn9LoCwUbRN_-idPZ-9Ui7-BZI", i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }, %"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 2 }, ptr @_llgo_uintptr, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
@7 = private unnamed_addr constant [84 x i8] c"type assertion interface{} -> struct{$f func(string, int) string; $h uintptr} failed", align 1
...
_llgo_0:
  ...
  %19 = call %reflect.Value @reflect.MakeFunc(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %18, ptr @"__llgo_closure_const$github.com/goplus/llgo/cl/_testgo/reflectmkfn.main$1")
  ...
  %22 = call i1 @"github.com/goplus/llgo/runtime/internal/runtime.MatchesClosure"(ptr @"_llgo_closure$OWyKY9aXpt8KgKAeKwKVxaX7Ig7dtBQ7mBhNSyHJwRY", ptr %21)
...
_llgo_4:                                          ; preds = %_llgo_0
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @7, i64 84 }, ptr %31, align 8
