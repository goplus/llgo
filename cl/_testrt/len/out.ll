...
_llgo_0:
  ...
  %24 = call ptr @__llgo_load__llgo_int()
  %25 = call ptr @__llgo_load__llgo_string()
  %26 = call ptr @"__llgo_load_map[_llgo_int]_llgo_string"()
  %27 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.MakeMap"(ptr %26, i64 1)
  %28 = call ptr @"__llgo_load_map[_llgo_int]_llgo_string"()
...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  %23 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Struct"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 37 }, i64 208, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %22)
