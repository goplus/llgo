...
_llgo_3:                                          ; preds = %_llgo_12
  ...
  br i1 %17, label %_llgo_14, label %_llgo_13
...
_llgo_5:                                          ; preds = %_llgo_4, %_llgo_0
  ...
  switch i8 %22, label %_llgo_6 [
    i8 0, label %_llgo_9
    i8 1, label %_llgo_7
  ]

_llgo_6:                                          ; preds = %_llgo_8, %_llgo_7, %_llgo_16, %_llgo_5
  %23 = call i1 @llvm.coro.end(ptr %21, i1 false, token none)
  ret ptr %21

_llgo_7:                                          ; preds = %_llgo_2, %_llgo_15, %_llgo_18, %_llgo_16, %_llgo_5
...
_llgo_8:                                          ; preds = %_llgo_20, %_llgo_7
...
_llgo_12:                                         ; preds = %_llgo_11, %_llgo_10
  %30 = phi { { ptr, ptr, i1 }, i1 } [ %29, %_llgo_10 ], [ zeroinitializer, %_llgo_11 ]
...
_llgo_15:                                         ; preds = %_llgo_19, %_llgo_13
  %35 = phi i64 [ %33, %_llgo_13 ], [ %43, %_llgo_19 ]
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintInt"(i64 %35)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.PrintByte"(i8 10)
  br label %_llgo_7

_llgo_16:                                         ; preds = %_llgo_14
  %36 = call ptr @llvm.coro.promise(ptr %34, i32 8, i1 false)
  ...
  switch i8 %38, label %_llgo_6 [
    i8 0, label %_llgo_17
    i8 1, label %_llgo_7
  ]

_llgo_17:                                         ; preds = %_llgo_16
  %39 = call i1 @"github.com/goplus/llgo/runtime/internal/runtime.CoroIsPanicByHandle"(ptr %34)
  br i1 %39, label %_llgo_18, label %_llgo_19

_llgo_18:                                         ; preds = %_llgo_17
  %40 = call %"github.com/goplus/llgo/runtime/internal/runtime.eface" @"github.com/goplus/llgo/runtime/internal/runtime.CoroGetPanicByHandle"(ptr %34)
