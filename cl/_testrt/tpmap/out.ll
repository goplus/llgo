...
_llgo_0:
  %0 = load ptr, ptr @_llgo_main.cacheKey, align 8
  %1 = load ptr, ptr @_llgo_string, align 8
  %2 = load ptr, ptr @"map[_llgo_main.cacheKey]_llgo_string", align 8
  %3 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.MakeMap"(ptr %2, i64 0)
  %4 = alloca %main.cacheKey, align 8
  call void @llvm.memset(ptr %4, i8 0, i64 48, i1 false)
  %5 = getelementptr inbounds %main.cacheKey, ptr %4, i32 0, i32 0
  %6 = getelementptr inbounds %main.cacheKey, ptr %4, i32 0, i32 1
  %7 = getelementptr inbounds %main.T2, ptr %6, i32 0, i32 0
  %8 = getelementptr inbounds %main.cacheKey, ptr %4, i32 0, i32 2
  %9 = getelementptr inbounds %"main.T3[any]", ptr %8, i32 0, i32 0
  %10 = getelementptr inbounds %main.cacheKey, ptr %4, i32 0, i32 3
  %11 = getelementptr inbounds %main.cacheKey, ptr %4, i32 0, i32 4
  ...
  %15 = load %main.cacheKey, ptr %4, align 8
  %16 = load ptr, ptr @"map[_llgo_main.cacheKey]_llgo_string", align 8
  %17 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 48)
  store %main.cacheKey %15, ptr %17, align 8
  ...
  %19 = alloca %main.cacheKey, align 8
  call void @llvm.memset(ptr %19, i8 0, i64 48, i1 false)
  %20 = getelementptr inbounds %main.cacheKey, ptr %19, i32 0, i32 0
  %21 = getelementptr inbounds %main.cacheKey, ptr %19, i32 0, i32 1
  %22 = getelementptr inbounds %main.T2, ptr %21, i32 0, i32 0
  %23 = getelementptr inbounds %main.cacheKey, ptr %19, i32 0, i32 2
  %24 = getelementptr inbounds %"main.T3[any]", ptr %23, i32 0, i32 0
  %25 = getelementptr inbounds %main.cacheKey, ptr %19, i32 0, i32 3
  %26 = getelementptr inbounds %main.cacheKey, ptr %19, i32 0, i32 4
  ...
  %30 = load %main.cacheKey, ptr %19, align 8
  %31 = load ptr, ptr @"map[_llgo_main.cacheKey]_llgo_string", align 8
  %32 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocU"(i64 48)
  store %main.cacheKey %30, ptr %32, align 8
