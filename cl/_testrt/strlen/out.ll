; ModuleID = 'github.com/goplus/llgo/cl/_testrt/strlen'
source_filename = "github.com/goplus/llgo/cl/_testrt/strlen"
...
_llgo_0:
  ...
  %20 = load i1, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.init$guard", align 1
  br i1 %20, label %_llgo_2, label %_llgo_1

_llgo_1:                                          ; preds = %_llgo_0
  store i1 true, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.init$guard", align 1
  call void @syscall.init()
  call void @"github.com/goplus/llgo/runtime/internal/runtime.AssertNilDeref"(i1 false)
  %21 = call i64 @"github.com/goplus/llgo/runtime/internal/runtime.CheckIndexInt"(i64 0, i64 10)
  %22 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %21
  ...
  %34 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %33
  ...
  %46 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %45
  ...
  %58 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %57
  ...
  %70 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %69
  ...
  %82 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %81
  ...
  %94 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %93
  ...
  %106 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %105
  ...
  %118 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %117
  ...
  %130 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %129
...
_llgo_0:
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.AssertNilDeref"(i1 false)
  %8 = call i64 @"github.com/goplus/llgo/runtime/internal/runtime.CheckIndexInt"(i64 0, i64 10)
  %9 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/cl/_testrt/strlen.format", i64 %8
  ...
  call void @runtime.ClobberPointerRegs()
  call void (ptr, ...) @printf(ptr %44, i32 %32)
