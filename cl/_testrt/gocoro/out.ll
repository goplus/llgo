...
_llgo_1:                                          ; preds = %_llgo_3
  call void @"github.com/goplus/llgo/cl/_testrt/gocoro.hello"()
  %2 = call i8 @llvm.coro.suspend(token none, i1 true)
...
_llgo_4:                                          ; preds = %_llgo_6, %_llgo_1, %_llgo_1
  %7 = call ptr @llvm.coro.free(token %0, ptr %6)
  call void @free(ptr %7)
  br label %_llgo_5

_llgo_5:                                          ; preds = %_llgo_4
  %8 = call i1 @llvm.coro.end(ptr %6, i1 false, token none)
  ret ptr %6
