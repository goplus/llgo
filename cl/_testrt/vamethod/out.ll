...
@_llgo_main.CFmt = linkonce global ptr null, align 8
...
@"*_llgo_main.T" = linkonce global ptr null, align 8
@"_llgo_struct$jB-5FSjWcB6kgngJYpnaXRaLp1sLOLDMjHXTG5kAK8U" = linkonce global ptr null, align 8
...
@"*_llgo_main.CFmt" = linkonce global ptr null, align 8
@_llgo_main.IFmt = linkonce global ptr null, align 8
...
define i32 @main.CFmt.Printf(%main.CFmt %0, ...) {
_llgo_0:
  %1 = alloca %main.CFmt, align 8
  call void @llvm.memset(ptr %1, i8 0, i64 8, i1 false)
  store %main.CFmt %0, ptr %1, align 8
  %2 = getelementptr inbounds %main.CFmt, ptr %1, i32 0, i32 0
  %3 = load ptr, ptr %2, align 8
  %4 = call i32 (ptr, ...) @printf(ptr %3)
  ret i32 %4
}

define i32 @"main.(*CFmt).Printf"(ptr %0, ...) {
_llgo_0:
  %1 = getelementptr inbounds %main.CFmt, ptr %0, i32 0, i32 0
  %2 = load ptr, ptr %1, align 8
  %3 = call i32 (ptr, ...) @printf(ptr %2)
  ret i32 %3
}

define void @"main.(*CFmt).SetFormat"(ptr %0, ptr %1) {
_llgo_0:
  %2 = getelementptr inbounds %main.CFmt, ptr %0, i32 0, i32 0
...
_llgo_0:
  ...
  call void @"main.(*CFmt).SetFormat"(ptr %0, ptr @0)
  %1 = getelementptr inbounds %main.CFmt, ptr %0, i32 0, i32 0
  %2 = load ptr, ptr %1, align 8
  %3 = call i32 (ptr, ...) @printf(ptr %2, ptr @1, i64 100)
  call void @"main.(*CFmt).SetFormat"(ptr %0, ptr @2)
  %4 = getelementptr inbounds %main.CFmt, ptr %0, i32 0, i32 0
  %5 = load ptr, ptr %4, align 8
  %6 = call i32 (ptr, ...) @printf(ptr %5, i64 200, ptr @3)
  %7 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64 8)
  %8 = load ptr, ptr @_llgo_main.CFmt, align 8
  %9 = load ptr, ptr @"*_llgo_main.CFmt", align 8
  ...
  %13 = load ptr, ptr @_llgo_main.IFmt, align 8
...
_llgo_0:
  %0 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 4 }, i64 25, i64 8, i64 1, i64 2)
  %1 = load ptr, ptr @_llgo_main.CFmt, align 8
  %2 = icmp eq ptr %1, null
  br i1 %2, label %_llgo_1, label %_llgo_2

_llgo_1:                                          ; preds = %_llgo_0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.SetDirectIface"(ptr %0)
  store ptr %0, ptr @_llgo_main.CFmt, align 8
  br label %_llgo_2

_llgo_2:                                          ; preds = %_llgo_1, %_llgo_0
  %3 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 1 }, i64 3, i64 1, i64 0, i64 1)
...
_llgo_8:                                          ; preds = %_llgo_16, %_llgo_6
  ...
  %13 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 1 }, i64 3, i64 1, i64 0, i64 1)
...
_llgo_9:                                          ; preds = %_llgo_7
  ...
  %20 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %19)
...
_llgo_11:                                         ; preds = %_llgo_10
  ...
  %28 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %27)
...
_llgo_15:                                         ; preds = %_llgo_14
  ...
  %41 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %40)
...
_llgo_17:                                         ; preds = %_llgo_8
  ...
  store ptr %64, ptr @"*_llgo_main.T", align 8
  br label %_llgo_18

_llgo_18:                                         ; preds = %_llgo_17, %_llgo_8
  %65 = load ptr, ptr @"*_llgo_main.T", align 8
  %66 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @6, i64 1 }, i64 3, i64 1, i64 0, i64 1)
  ...
  %74 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Struct"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, i64 8, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %73)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.SetDirectIface"(ptr %74)
  store ptr %74, ptr @"_llgo_struct$jB-5FSjWcB6kgngJYpnaXRaLp1sLOLDMjHXTG5kAK8U", align 8
  %75 = load ptr, ptr @"_llgo_struct$jB-5FSjWcB6kgngJYpnaXRaLp1sLOLDMjHXTG5kAK8U", align 8
...
_llgo_19:                                         ; preds = %_llgo_18
  ...
  %78 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %77, ptr @"main.(*CFmt).Printf", 2
  %79 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %78, ptr @"main.(*CFmt).Printf", 3
  ...
  %81 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %80, ptr @"main.(*CFmt).Printf", 2
  %82 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %81, ptr @main.CFmt.Printf, 3
...
_llgo_20:                                         ; preds = %_llgo_24, %_llgo_18
  %86 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamed"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 4 }, i64 25, i64 8, i64 1, i64 2)
  %87 = load ptr, ptr @"*_llgo_main.CFmt", align 8
...
_llgo_24:                                         ; preds = %_llgo_23, %_llgo_22
  ...
  %108 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %107, ptr @"main.(*CFmt).SetFormat", 2
  %109 = insertvalue %"github.com/goplus/llgo/runtime/abi.Method" %108, ptr @"main.(*CFmt).SetFormat", 3
...
_llgo_25:                                         ; preds = %_llgo_20
  ...
  store ptr %121, ptr @"*_llgo_main.CFmt", align 8
  br label %_llgo_26

_llgo_26:                                         ; preds = %_llgo_25, %_llgo_20
  %122 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewNamedInterface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @9, i64 4 })
  %123 = load ptr, ptr @_llgo_main.IFmt, align 8
  %124 = icmp eq ptr %123, null
  br i1 %124, label %_llgo_27, label %_llgo_28

_llgo_27:                                         ; preds = %_llgo_26
  store ptr %122, ptr @_llgo_main.IFmt, align 8
  br label %_llgo_28
...
_llgo_31:                                         ; preds = %_llgo_30
  ...
  %149 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.Interface"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 4 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" %148)
