...
@"_llgo_github.com/goplus/llgo/cl/_testrt/vamethod.CFmt" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [1 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 8, i64 8, i32 -1944946986, i8 13, i8 8, i8 8, i8 57, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.structequal$ctx", ptr @"_llgo_github.com/goplus/llgo/cl/_testrt/vamethod.CFmt" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 9 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testrt/vamethod.CFmt" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"_llgo_struct$quUppefyumGvUA5WNkqjeO0PomZGx9OI8NFZ2pfWLXw$fields", i64 1, i64 1 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @7, i64 42 }, i16 1, i16 1, i32 24 }, [1 x %"github.com/goplus/llgo/runtime/abi.Method"] [%"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @8, i64 6 }, ptr @"_llgo_func$sSO5Bw-E3E7TeJqIJF_OmmojTYyqWBhYrUwNYJNw7Bs", ptr @"github.com/goplus/llgo/cl/_testrt/vamethod.(*CFmt).Printf", ptr @"github.com/goplus/llgo/cl/_testrt/vamethod.CFmt.Printf" }] }, align 8
...
_llgo_2:                                          ; preds = %_llgo_5
  %13 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.IfacePtrData"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %39)
  %14 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %39, 0
  ...
  %22 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.IfacePtrData"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %39)
  %23 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %39, 0
  ...
  %31 = call i32 (ptr, ...) %29(ptr %28, ptr @19, i64 100, i64 200)
...
_llgo_3:                                          ; preds = %_llgo_0
  ...
  %33 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$a85zs5wWQQoPIERm_en8plssh4spdIeeXZPC-E0TDh0", ptr %9)
  ...
  %36 = insertvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } undef, %"github.com/goplus/llgo/runtime/internal/runtime.iface" %35, 0
  %37 = insertvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %36, i1 true, 1
  br label %_llgo_5
...
_llgo_5:                                          ; preds = %_llgo_4, %_llgo_3
  %38 = phi { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } [ %37, %_llgo_3 ], [ zeroinitializer, %_llgo_4 ]
  %39 = extractvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %38, 0
  %40 = extractvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %38, 1
  br i1 %40, label %_llgo_2, label %_llgo_1
}
