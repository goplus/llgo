...
@llvm.compiler.used = appending global [3 x ptr] [ptr @"github.com/goplus/llgo/cl/_testrt/vamethod.CFmt.Printf", ptr @"github.com/goplus/llgo/cl/_testrt/vamethod.(*CFmt).Printf", ptr @"github.com/goplus/llgo/cl/_testrt/vamethod.(*CFmt).SetFormat"], section "llvm.metadata"
...
_llgo_0:
  ...
  %3 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testrt/vamethod.CFmt", ptr %1, i32 0, i32 0
...
_llgo_0:
  ...
  call void @"github.com/goplus/llgo/runtime/internal/runtime.AssertNilDeref"(i1 %2)
  %3 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testrt/vamethod.CFmt", ptr %0, i32 0, i32 0
...
_llgo_2:                                          ; preds = %_llgo_5
  %17 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.IfacePtrData"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %41)
  %18 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %41, 0
  ...
  call void %24(ptr %23, ptr @18)
  %25 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.IfacePtrData"(%"github.com/goplus/llgo/runtime/internal/runtime.iface" %41)
  %26 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.iface" %41, 0
  ...
  %33 = call i32 (ptr, ...) %32(ptr %31, ptr @19, i64 100, i64 200)
  ret void

_llgo_3:                                          ; preds = %_llgo_0
  %34 = extractvalue %"github.com/goplus/llgo/runtime/internal/runtime.eface" %12, 1
  %35 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$a85zs5wWQQoPIERm_en8plssh4spdIeeXZPC-E0TDh0", ptr %13)
  ...
  %38 = insertvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } undef, %"github.com/goplus/llgo/runtime/internal/runtime.iface" %37, 0
  %39 = insertvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %38, i1 true, 1
  br label %_llgo_5
...
_llgo_5:                                          ; preds = %_llgo_4, %_llgo_3
  %40 = phi { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } [ %39, %_llgo_3 ], [ zeroinitializer, %_llgo_4 ]
  %41 = extractvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %40, 0
  %42 = extractvalue { %"github.com/goplus/llgo/runtime/internal/runtime.iface", i1 } %40, 1
