...
_llgo_0:
  %2 = fcmp ole float %0, 0xC1E0000000000000
  %3 = fcmp oge float %0, 0x41E0000000000000
  %4 = fcmp uno float %0, %0
  %5 = or i1 %2, %3
  %6 = or i1 %4, %5
  %7 = select i1 %6, float 0.000000e+00, float %0
  %8 = fptosi float %7 to i32
  %9 = select i1 %2, i32 -2147483648, i32 %8
  %10 = select i1 %3, i32 2147483647, i32 %9
...
_llgo_0:
  ...
  %3 = fcmp oge float %0, 0x41F0000000000000
  %4 = fcmp uno float %0, %0
  %5 = or i1 %2, %3
  %6 = or i1 %4, %5
  %7 = select i1 %6, float 0.000000e+00, float %0
...
_llgo_0:
  ...
  %3 = fcmp oge double %0, 0x43F0000000000000
  %4 = fcmp uno double %0, %0
  %5 = or i1 %2, %3
  %6 = or i1 %4, %5
  %7 = select i1 %6, double 0.000000e+00, double %0
  %8 = fptoui double %7 to i64
  %9 = select i1 %2, i64 0, i64 %8
  %10 = select i1 %3, i64 -1, i64 %9
  %11 = select i1 %4, i64 0, i64 %10
  %12 = icmp ne i64 %11, %1
  br i1 %12, label %_llgo_1, label %_llgo_2
...
_llgo_0:
  ...
  call void @"github.com/goplus/llgo/cl/_testrt/cast.cvt32Fto32U"(float 0x41F0000000000000, i32 -1)
  call void @"github.com/goplus/llgo/cl/_testrt/cast.cvt32Fto32U"(float 0x41F3B9ACA0000000, i32 -1)
  call void @"github.com/goplus/llgo/cl/_testrt/cast.cvt32Fto32U"(float 0xC1F0000000000000, i32 0)
  call void @"github.com/goplus/llgo/cl/_testrt/cast.cvt32Fto32U"(float 0xC1D34BE880000000, i32 0)
  call void @"github.com/goplus/llgo/cl/_testrt/cast.cvt32Fto32U"(float 0xBFF19999A0000000, i32 0)
