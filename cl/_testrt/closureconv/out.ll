...
_llgo_0:
  ...
  call void asm sideeffect "", "{x26}"(ptr %9)
  ...
  call void asm sideeffect "", "{x26}"(ptr %13)
  ...
  call void asm sideeffect "", "{x26}"(ptr %17)
  ...
  call void asm sideeffect "", "{x26}"(ptr %23)
  ...
  call void asm sideeffect "", "{x26}"(ptr %27)
