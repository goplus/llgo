...
_llgo_8:                                          ; preds = %_llgo_1
  ...
  %24 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %23, i32 0, i32 0
...
_llgo_11:                                         ; preds = %_llgo_9
  ...
  %29 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %28, i32 0, i32 1
  %30 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %29, align 8
  call void @llvm.coro.destroy(ptr %14)
  %31 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %1, i32 0, i32 1
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" %30, ptr %31, align 8
  br label %_llgo_5
...
_llgo_5:                                          ; preds = %_llgo_4, %_llgo_0
  ...
  switch i8 %28, label %_llgo_6 [
    i8 0, label %_llgo_9
    i8 1, label %_llgo_7
  ]

_llgo_6:                                          ; preds = %_llgo_8, %_llgo_7, %_llgo_20, %_llgo_13, %_llgo_5
  %29 = call i1 @llvm.coro.end(ptr %27, i1 false, token none)
  ret ptr %27

_llgo_7:                                          ; preds = %_llgo_3, %_llgo_2, %_llgo_22, %_llgo_20, %_llgo_15, %_llgo_13, %_llgo_5
...
_llgo_12:                                         ; preds = %_llgo_16, %_llgo_10
  %34 = phi %"github.com/goplus/llgo/runtime/internal/runtime.String" [ %32, %_llgo_10 ], [ %48, %_llgo_16 ]
  ...
  br i1 %40, label %_llgo_18, label %_llgo_17

_llgo_13:                                         ; preds = %_llgo_11
  %41 = call ptr @llvm.coro.promise(ptr %33, i32 8, i1 false)
  %42 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %41, i32 0, i32 0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.CoroAddWaiter"(ptr %42, ptr %27)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.CoroReschedule"(ptr %33)
...
_llgo_14:                                         ; preds = %_llgo_13
  %44 = call i1 @"github.com/goplus/llgo/runtime/internal/runtime.CoroIsPanicByHandle"(ptr %33)
  br i1 %44, label %_llgo_15, label %_llgo_16

_llgo_15:                                         ; preds = %_llgo_14
  %45 = call %"github.com/goplus/llgo/runtime/internal/runtime.eface" @"github.com/goplus/llgo/runtime/internal/runtime.CoroGetPanicByHandle"(ptr %33)
...
_llgo_16:                                         ; preds = %_llgo_14
  %46 = call ptr @llvm.coro.promise(ptr %33, i32 8, i1 false)
  %47 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %46, i32 0, i32 1
  %48 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %47, align 8
  call void @llvm.coro.destroy(ptr %33)
  br label %_llgo_12

_llgo_17:                                         ; preds = %_llgo_12
  %49 = call %"github.com/goplus/llgo/runtime/internal/runtime.String" %38(ptr %39, %"github.com/goplus/llgo/runtime/internal/runtime.iface" %37)
  br label %_llgo_19

_llgo_18:                                         ; preds = %_llgo_12
  %50 = call ptr %38(ptr %39, %"github.com/goplus/llgo/runtime/internal/runtime.iface" %37)
  br label %_llgo_20

_llgo_19:                                         ; preds = %_llgo_23, %_llgo_17
  %51 = phi %"github.com/goplus/llgo/runtime/internal/runtime.String" [ %49, %_llgo_17 ], [ %61, %_llgo_23 ]
  %52 = call i1 @"github.com/goplus/llgo/runtime/internal/runtime.StringEqual"(%"github.com/goplus/llgo/runtime/internal/runtime.String" %34, %"github.com/goplus/llgo/runtime/internal/runtime.String" %51)
  %53 = xor i1 %52, true
  br i1 %53, label %_llgo_2, label %_llgo_3

_llgo_20:                                         ; preds = %_llgo_18
  %54 = call ptr @llvm.coro.promise(ptr %50, i32 8, i1 false)
  %55 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %54, i32 0, i32 0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.CoroAddWaiter"(ptr %55, ptr %27)
...
_llgo_23:                                         ; preds = %_llgo_21
  ...
  %60 = getelementptr inbounds { ptr, %"github.com/goplus/llgo/runtime/internal/runtime.String" }, ptr %59, i32 0, i32 1
  %61 = load %"github.com/goplus/llgo/runtime/internal/runtime.String", ptr %60, align 8
