...
%"main.M[bool]" = type { i1, i32, %"main.N[bool]" }
%"main.N[bool]" = type { i1, i1 }
%"github.com/goplus/llgo/runtime/internal/runtime.String" = type { ptr, i64 }
%"github.com/goplus/llgo/runtime/internal/runtime.eface" = type { ptr, ptr }
%"main.M[int64]" = type { i64, i32, %"main.N[int64]" }
%"main.N[int64]" = type { i64, i64 }
...
_llgo_0:
  ...
  call void @"main.(*M[bool]).check"(ptr %0, i64 1, i64 8, i64 1)
  %1 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64 32)
  call void @"main.(*M[int64]).check"(ptr %1, i64 8, i64 16, i64 8)
  ret void
}

declare ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64)

define linkonce void @"main.(*M[bool]).check"(ptr %0, i64 %1, i64 %2, i64 %3) {
_llgo_0:
  %4 = getelementptr inbounds %"main.M[bool]", ptr %0, i32 0, i32 2
  %5 = load %"main.N[bool]", ptr %4, align 1
  %6 = icmp ne i64 1, %1
...
_llgo_2:                                          ; preds = %_llgo_0
  %11 = getelementptr inbounds %"main.M[bool]", ptr %0, i32 0, i32 2
  %12 = load %"main.N[bool]", ptr %11, align 1
  %13 = icmp ne i64 8, %2
...
_llgo_4:                                          ; preds = %_llgo_2
  %18 = getelementptr inbounds %"main.M[bool]", ptr %0, i32 0, i32 2
  %19 = getelementptr inbounds %"main.N[bool]", ptr %18, i32 0, i32 1
...
define linkonce void @"main.(*M[int64]).check"(ptr %0, i64 %1, i64 %2, i64 %3) {
_llgo_0:
  %4 = getelementptr inbounds %"main.M[int64]", ptr %0, i32 0, i32 2
  %5 = load %"main.N[int64]", ptr %4, align 4
  %6 = icmp ne i64 8, %1
  br i1 %6, label %_llgo_1, label %_llgo_2
...
_llgo_2:                                          ; preds = %_llgo_0
  %11 = getelementptr inbounds %"main.M[int64]", ptr %0, i32 0, i32 2
  %12 = load %"main.N[int64]", ptr %11, align 4
  %13 = icmp ne i64 16, %2
  br i1 %13, label %_llgo_3, label %_llgo_4
...
_llgo_4:                                          ; preds = %_llgo_2
  %18 = getelementptr inbounds %"main.M[int64]", ptr %0, i32 0, i32 2
  %19 = getelementptr inbounds %"main.N[int64]", ptr %18, i32 0, i32 1
