...
_llgo_11:                                         ; preds = %_llgo_9
  ...
  %20 = call ptr @"github.com/goplus/llgo/cl/_testrt/tpunsafe.(*M[int64]).check$coro"(ptr %19, i64 8, i64 16, i64 8)
  br label %_llgo_12

_llgo_12:                                         ; preds = %_llgo_11
  %21 = call ptr @llvm.coro.promise(ptr %20, i32 8, i1 false)
  %22 = getelementptr inbounds { ptr }, ptr %21, i32 0, i32 0
  call void @"github.com/goplus/llgo/runtime/internal/runtime.CoroAddWaiter"(ptr %22, ptr %9)
...
_llgo_9:                                          ; preds = %_llgo_8, %_llgo_0
  ...
  switch i8 %28, label %_llgo_10 [
    i8 0, label %_llgo_13
    i8 1, label %_llgo_11
  ]

_llgo_10:                                         ; preds = %_llgo_12, %_llgo_11, %_llgo_9
  %29 = call i1 @llvm.coro.end(ptr %27, i1 false, token none)
  ret ptr %27

_llgo_11:                                         ; preds = %_llgo_7, %_llgo_6, %_llgo_4, %_llgo_2, %_llgo_9
...
_llgo_12:                                         ; preds = %_llgo_14, %_llgo_11
