...
_llgo_4:                                          ; preds = %_llgo_6, %_llgo_5
  %6 = call i1 @llvm.coro.end(ptr %5, i1 false, token none)
  ret ptr %5
...
_llgo_6:                                          ; preds = %_llgo_7, %_llgo_5
  %8 = call ptr @llvm.coro.free(token %0, ptr %5)
...
_llgo_6:                                          ; preds = %_llgo_7, %_llgo_5
  %9 = call ptr @llvm.coro.free(token %1, ptr %6)
...
_llgo_6:                                          ; preds = %_llgo_7, %_llgo_5
  %10 = call ptr @llvm.coro.free(token %2, ptr %7)
...
_llgo_1:                                          ; preds = %_llgo_3
  %2 = call ptr @"github.com/goplus/llgo/cl/_testrt/corodefer.worker$coro"()
  br label %_llgo_7
...
_llgo_4:                                          ; preds = %_llgo_6, %_llgo_5, %_llgo_10
  %7 = call i1 @llvm.coro.end(ptr %6, i1 false, token none)
  ret ptr %6

_llgo_5:                                          ; preds = %_llgo_11, %_llgo_10
  %8 = call i8 @llvm.coro.suspend(token none, i1 true)
  switch i8 %8, label %_llgo_4 [
    i8 0, label %_llgo_13
    i8 1, label %_llgo_6
...
_llgo_5:                                          ; preds = %_llgo_7, %_llgo_6, %_llgo_9, %_llgo_8, %_llgo_1
  %7 = call i1 @llvm.coro.end(ptr %6, i1 false, token none)
  ret ptr %6

_llgo_6:                                          ; preds = %_llgo_2, %_llgo_10, %_llgo_9, %_llgo_8, %_llgo_1
...
_llgo_7:                                          ; preds = %_llgo_11, %_llgo_6
  %9 = call ptr @llvm.coro.free(token %0, ptr %6)
  call void @free(ptr %9)
  call void @"github.com/goplus/llgo/runtime/internal/runtime.CoroExit"()
  br label %_llgo_5
