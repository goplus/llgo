...
// CHECK-NEXT:   %11 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"_llgo_{{.*}}/cl/_testrt/makemap.N1", ptr undef }, ptr %10, 1
...
// CHECK-NEXT:   store i64 2, ptr %15, align 8
// CHECK-NEXT:   %16 = load [1 x i64], ptr %14, align 8
// CHECK-NEXT:   %17 = extractvalue [1 x i64] %16, 0
// CHECK-NEXT:   %18 = inttoptr i64 %17 to ptr
// CHECK-NEXT:   %19 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"_llgo_{{.*}}/cl/_testrt/makemap.N1", ptr undef }, ptr %18, 1
...
// CHECK-NEXT:   store i64 200, ptr %21, align 8
...
// CHECK-NEXT:   store i64 3, ptr %23, align 8
// CHECK-NEXT:   %24 = load [1 x i64], ptr %22, align 8
// CHECK-NEXT:   %25 = extractvalue [1 x i64] %24, 0
// CHECK-NEXT:   %26 = inttoptr i64 %25 to ptr
// CHECK-NEXT:   %27 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"_llgo_{{.*}}/cl/_testrt/makemap.N1", ptr undef }, ptr %26, 1
// CHECK-NEXT:   %28 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 16)
...
// CHECK-NEXT:   store i64 300, ptr %29, align 8
...
// CHECK-NEXT:   %32 = load [1 x i64], ptr %30, align 8
// CHECK-NEXT:   %33 = extractvalue [1 x i64] %32, 0
// CHECK-NEXT:   %34 = inttoptr i64 %33 to ptr
// CHECK-NEXT:   %35 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"_llgo_{{.*}}/cl/_testrt/makemap.N1", ptr undef }, ptr %34, 1
...
// CHECK-NEXT:   %44 = icmp eq ptr %43, @"_llgo_{{.*}}/cl/_testrt/makemap.N1"
...
// CHECK-NEXT:   %55 = insertvalue [1 x i64] undef, i64 %54, 0
// CHECK-NEXT:   %56 = alloca [1 x i64], align 8
// CHECK-NEXT:   call void @llvm.memset(ptr %56, i8 0, i64 8, i1 false)
// CHECK-NEXT:   store [1 x i64] %55, ptr %56, align 8
// CHECK-NEXT:   %57 = getelementptr inbounds i64, ptr %56, i64 0
