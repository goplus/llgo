...
func SeqIterCheck(op *Object) c.Int
...
func CallIterCheck(op *Object) c.Int
...
func SeqIterType() TypeObject {
	return *(*TypeObject)(c.Pointer(&C.PySeqIter_Type))
}
...
func CallIterType() TypeObject {
	return *(*TypeObject)(c.Pointer(&C.PyCallIter_Type))
}
