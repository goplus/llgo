...
`)
	err := UndefinedGlobalStrings(pkg, []string{"foo/bar.a", "foo/bar.b"})
	if err != nil {
		t.Fatal(err)
	}
	UndefinedGlobalStrings(pkg, []string{"foo.bar.d"})
	err = UndefinedGlobalStrings(pkg, []string{"foo/bar.c"})
	if err == nil {
		t.Fatal("must err")
	}
	assertPkg(t, pkg, `; ModuleID = 'foo/bar'
...
`)
	...
	AddGlobalStrings(global, map[string]string{
		"foo/bar.a": "1.0",
		"foo/bar.b": "info",
	})
...
@0 = private unnamed_addr global [3 x i8] c"1.0", align 1
@"foo/bar.a" = global %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 3 }, align 8
@1 = private unnamed_addr global [4 x i8] c"info", align 1
