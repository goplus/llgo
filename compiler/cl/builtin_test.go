...
func TestErrBuiltin(t *testing.T) {
	...
	test("cstr(NoArgs)", func(ctx *context) { ctx.cstr(nil, nil) })
	test("cstr(Nonconst)", func(ctx *context) { ctx.cstr(nil, []ssa.Value{&ssa.Parameter{}}) })
	test("pystr(NoArgs)", func(ctx *context) { ctx.pystr(nil, nil) })
	test("pystr(Nonconst)", func(ctx *context) { ctx.pystr(nil, []ssa.Value{&ssa.Parameter{}}) })
