...
func FuncWithAllTypeStructParam(s StructWithAllTypeFields) {
	...
	//   s.arr2: [3]github.com/goplus/compiler/cl/_testdata/debug.E{{i = 27}, {i = 28}, {i = 29}}
	//   s.s: "hello"
	//   s.e: github.com/goplus/compiler/cl/_testdata/debug.E{i = 30}
	//   s.pad1: 100
	//   s.pad2: 200
	s.i8 = '\b'
	// Expected:
...
func FuncWithAllTypeParams(
	...
	//   slice: []int{21, 22, 23}
	//   arr: [3]int{24, 25, 26}
	//   arr2: [3]github.com/goplus/compiler/cl/_testdata/debug.E{{i = 27}, {i = 28}, {i = 29}}
	//   slice[0]: 21
	//   slice[1]: 22
	//   slice[2]: 23
	//   arr[0]: 24
	...
	//   arr2[1].i: 28
	//   arr2[2].i: 29
	//   e: github.com/goplus/compiler/cl/_testdata/debug.E{i = 30}
	...
	//   slice: []int{31, 32, 33}
	//   arr2: [3]github.com/goplus/compiler/cl/_testdata/debug.E{{i = 37}, {i = 38}, {i = 39}}
	//   s: "world"
	//   e: github.com/goplus/compiler/cl/_testdata/debug.E{i = 40}
