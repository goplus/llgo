; ModuleID = 'github.com/goplus/llgo/compiler/cl/_testdata/utf8'
source_filename = "github.com/goplus/llgo/compiler/cl/_testdata/utf8"

%"github.com/goplus/llgo/runtime/internal/runtime.String" = type { ptr, i64 }

@"github.com/goplus/llgo/compiler/cl/_testdata/utf8.array" = global [8 x i8] zeroinitializer, align 1
@"github.com/goplus/llgo/compiler/cl/_testdata/utf8.init$guard" = global i1 false, align 1
@0 = private unnamed_addr constant [7 x i8] c"\E4\B8\ADabcd", align 1

define i8 @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.index"(i8 %0) {
_llgo_0:
  %1 = sext i8 %0 to i64
  %2 = icmp slt i64 %1, 0
  %3 = icmp sge i64 %1, 8
  ...
  %5 = getelementptr inbounds i8, ptr @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.array", i64 %1
  %6 = load i8, ptr %5, align 1
  ret i8 %6
}

define void @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.init"() {
_llgo_0:
  %0 = load i1, ptr @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.init$guard", align 1
  br i1 %0, label %_llgo_2, label %_llgo_1

_llgo_1:                                          ; preds = %_llgo_0
  store i1 true, ptr @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.init$guard", align 1
  ...
  store i8 5, ptr getelementptr inbounds (i8, ptr @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.array", i64 4), align 1
  store i8 6, ptr getelementptr inbounds (i8, ptr @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.array", i64 5), align 1
...
define void @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.main"() {
_llgo_0:
  br label %_llgo_1
...
_llgo_3:                                          ; preds = %_llgo_1
  %8 = call i8 @"github.com/goplus/llgo/compiler/cl/_testdata/utf8.index"(i8 2)
  %9 = icmp eq i8 %8, 3
