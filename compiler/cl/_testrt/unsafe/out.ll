; ModuleID = 'github.com/goplus/llgo/compiler/cl/_testrt/unsafe'
source_filename = "github.com/goplus/llgo/compiler/cl/_testrt/unsafe"

%"github.com/goplus/llgo/runtime/internal/runtime.String" = type { ptr, i64 }
%"github.com/goplus/llgo/runtime/internal/runtime.eface" = type { ptr, ptr }
%"github.com/goplus/llgo/runtime/internal/runtime.Slice" = type { ptr, i64, i64 }

@"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init$guard" = global i1 false, align 1
...
define void @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init"() {
_llgo_0:
  %0 = load i1, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init$guard", align 1
  br i1 %0, label %_llgo_2, label %_llgo_1

_llgo_1:                                          ; preds = %_llgo_0
  store i1 true, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init$guard", align 1
  call void @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init$after"()
  br label %_llgo_2
...
define void @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.main"() {
_llgo_0:
...
_llgo_32:                                         ; preds = %_llgo_31
  ...
  store %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 5 }, ptr %87, align 8
...
define void @"github.com/goplus/llgo/compiler/cl/_testrt/unsafe.init$after"() {
_llgo_0:
  %0 = load ptr, ptr @_llgo_string, align 8
