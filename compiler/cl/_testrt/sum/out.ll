; ModuleID = 'github.com/goplus/llgo/compiler/cl/_testrt/sum'
source_filename = "github.com/goplus/llgo/compiler/cl/_testrt/sum"

%"github.com/goplus/llgo/runtime/internal/runtime.Slice" = type { ptr, i64, i64 }

@"github.com/goplus/llgo/compiler/cl/_testrt/sum.init$guard" = global i1 false, align 1
@0 = private unnamed_addr constant [10 x i8] c"Hello %d\0A\00", align 1

define void @"github.com/goplus/llgo/compiler/cl/_testrt/sum.init"() {
_llgo_0:
  %0 = load i1, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/sum.init$guard", align 1
  br i1 %0, label %_llgo_2, label %_llgo_1

_llgo_1:                                          ; preds = %_llgo_0
  store i1 true, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/sum.init$guard", align 1
  br label %_llgo_2
...
define void @"github.com/goplus/llgo/compiler/cl/_testrt/sum.main"() {
_llgo_0:
  ...
  %8 = call i64 @"github.com/goplus/llgo/compiler/cl/_testrt/sum.sum"(%"github.com/goplus/llgo/runtime/internal/runtime.Slice" %7)
  %9 = call i32 (ptr, ...) @printf(ptr @0, i64 %8)
  ret void
}

define i64 @"github.com/goplus/llgo/compiler/cl/_testrt/sum.sum"(%"github.com/goplus/llgo/runtime/internal/runtime.Slice" %0) {
_llgo_0:
