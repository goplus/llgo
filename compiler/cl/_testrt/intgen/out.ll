; ModuleID = 'github.com/goplus/llgo/compiler/cl/_testrt/intgen'
source_filename = "github.com/goplus/llgo/compiler/cl/_testrt/intgen"

%"github.com/goplus/llgo/runtime/internal/runtime.Slice" = type { ptr, i64, i64 }
%"github.com/goplus/llgo/compiler/cl/_testrt/intgen.generator" = type { i32 }

@"github.com/goplus/llgo/compiler/cl/_testrt/intgen.init$guard" = global i1 false, align 1
@0 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

define %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.genInts"(i64 %0, { ptr, ptr } %1) {
_llgo_0:
...
define i32 @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.(*generator).next"(ptr %0) {
_llgo_0:
  %1 = getelementptr inbounds %"github.com/goplus/llgo/compiler/cl/_testrt/intgen.generator", ptr %0, i32 0, i32 0
  %2 = load i32, ptr %1, align 4
  %3 = add i32 %2, 1
  %4 = getelementptr inbounds %"github.com/goplus/llgo/compiler/cl/_testrt/intgen.generator", ptr %0, i32 0, i32 0
  store i32 %3, ptr %4, align 4
  %5 = getelementptr inbounds %"github.com/goplus/llgo/compiler/cl/_testrt/intgen.generator", ptr %0, i32 0, i32 0
  %6 = load i32, ptr %5, align 4
  ret i32 %6
}

define void @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.init"() {
_llgo_0:
  %0 = load i1, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.init$guard", align 1
  br i1 %0, label %_llgo_2, label %_llgo_1

_llgo_1:                                          ; preds = %_llgo_0
  store i1 true, ptr @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.init$guard", align 1
  br label %_llgo_2
...
define void @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.main"() {
_llgo_0:
  %0 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.genInts"(i64 5, { ptr, ptr } { ptr @__llgo_stub.rand, ptr null })
...
_llgo_3:                                          ; preds = %_llgo_1
  ...
  %16 = insertvalue { ptr, ptr } { ptr @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.main$1", ptr undef }, ptr %14, 1
  %17 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.genInts"(i64 5, { ptr, ptr } %16)
...
_llgo_6:                                          ; preds = %_llgo_4
  ...
  %31 = getelementptr inbounds %"github.com/goplus/llgo/compiler/cl/_testrt/intgen.generator", ptr %30, i32 0, i32 0
  ...
  %34 = insertvalue { ptr, ptr } { ptr @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.next$bound", ptr undef }, ptr %32, 1
  %35 = call %"github.com/goplus/llgo/runtime/internal/runtime.Slice" @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.genInts"(i64 5, { ptr, ptr } %34)
...
define i32 @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.main$1"(ptr %0) {
_llgo_0:
...
define i32 @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.next$bound"(ptr %0) {
_llgo_0:
  %1 = load { ptr }, ptr %0, align 8
  %2 = extractvalue { ptr } %1, 0
  %3 = call i32 @"github.com/goplus/llgo/compiler/cl/_testrt/intgen.(*generator).next"(ptr %2)
  ret i32 %3
}
