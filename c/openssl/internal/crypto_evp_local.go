...
type OSSL_FUNC_keymgmt_get_params_fn func(key unsafe.Pointer, params []OSSL_PARAM) c.Int
type OSSL_FUNC_keymgmt_gettable_params_fn func(provctx unsafe.Pointer) *OSSL_PARAM
type OSSL_FUNC_keymgmt_set_params_fn func(key unsafe.Pointer, params []OSSL_PARAM) c.Int
type OSSL_FUNC_keymgmt_settable_params_fn func(provctx unsafe.Pointer) *OSSL_PARAM
type OSSL_FUNC_keymgmt_gen_init_fn func(provctx unsafe.Pointer, selection c.Int, params []OSSL_PARAM) unsafe.Pointer
type OSSL_FUNC_keymgmt_gen_set_template_fn func(genctx unsafe.Pointer, templ unsafe.Pointer) c.Int
type OSSL_FUNC_keymgmt_gen_set_params_fn func(genctx unsafe.Pointer, params []OSSL_PARAM) c.Int
type OSSL_FUNC_keymgmt_gen_settable_params_fn func(genctx unsafe.Pointer, provctx unsafe.Pointer) *OSSL_PARAM
type OSSL_FUNC_keymgmt_gen_fn func(genctx unsafe.Pointer, osslcb *OSSL_CALLBACK, cbarg unsafe.Pointer) unsafe.Pointer
...
type OSSL_FUNC_keymgmt_import_fn func(fake_keydata unsafe.Pointer, ignored_selection c.Int, params []OSSL_PARAM) c.Int
type OSSL_FUNC_keymgmt_import_types_fn func(selection c.Int) *OSSL_PARAM
type OSSL_FUNC_keymgmt_import_types_ex_fn func(provctx unsafe.Pointer, selec c.Int) *OSSL_PARAM
type OSSL_FUNC_keymgmt_export_fn func(keydata unsafe.Pointer, selection c.Int, param_cb *OSSL_CALLBACK, cbarg unsafe.Pointer) c.Int
type OSSL_FUNC_keymgmt_export_types_fn func(selection c.Int) *OSSL_PARAM
type OSSL_FUNC_keymgmt_export_types_ex_fn func(provctx unsafe.Pointer, sel c.Int) *OSSL_PARAM
