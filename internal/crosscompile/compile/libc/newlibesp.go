...
func getNewlibESP32ConfigRISCV(baseDir, target string) compile.CompileConfig {
	...
	libmFiles := getNewlibESP32LibmFiles(baseDir)
	libmFileEntries := getNewlibESP32LibmFileEntries(baseDir)
...
func getNewlibESP32LibmFileEntries(baseDir string) []compile.CompileFile {
...
func getNewlibESP32LibmFiles(baseDir string) []string {
	entries := getNewlibESP32LibmFileEntries(baseDir)
