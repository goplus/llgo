...
@"*_llgo_github.com/goplus/llgo/cl/deadcode/_testdata/ifacemethod.T" = global { i8, [2 x %"github.com/goplus/llgo/runtime/abi.Method"] } { i8 0, [2 x %"github.com/goplus/llgo/runtime/abi.Method"] [ %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @nameM, i64 1 }, ptr @mtyp, ptr @pt_ifn_m, ptr @pt_tfn_m }, %"github.com/goplus/llgo/runtime/abi.Method" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @nameN, i64 1 }, ptr @mtyp, ptr @pt_ifn_n, ptr @pt_tfn_n } ] }, align 8
