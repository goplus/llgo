...
func hasAltPkgForTarget(conf *Config, pkgPath string) bool {
	...
	// internal/runtime/atomic is enabled by default on arm64 in ABI mode 0/1
	// unless explicitly disabled.
	if conf != nil && conf.AbiMode != cabi.ModeAllFunc && conf.Goarch == "arm64" && pkgPath == "internal/runtime/atomic" && !plan9asmDisabledByEnv() {
		return false
	}
