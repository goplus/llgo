...
const (
	LLGoPackage = "link: $LLGO_LIB_BDWGC"
)
...
//go:linkname RegisterFinalizerNo_order C.GC_register_finalizer_no_order
func RegisterFinalizerNo_order(obj c.Pointer, fn func(c.Pointer, c.Pointer), cd c.Pointer, old_fn *func(c.Pointer, c.Pointer), old_cd *c.Pointer) int
