...
define dso_local void @demo1(%struct.point1* noalias sret(%struct.point1) align 4 %0, double %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo2(%struct.point2* noalias sret(%struct.point2) align 4 %0, double %1, double %2) #0 {
  %4 = alloca i8*, align 4
