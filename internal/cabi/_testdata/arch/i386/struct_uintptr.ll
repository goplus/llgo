...
define dso_local void @demo1(%struct.point1* noalias sret(%struct.point1) align 4 %0, i8* %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo2(%struct.point2* noalias sret(%struct.point2) align 4 %0, i8* %1, i8* %2) #0 {
  %4 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo3(%struct.point3* noalias sret(%struct.point3) align 4 %0, i8* %1, i8* %2, i8* %3) #0 {
  %5 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @demo4(%struct.point4* noalias sret(%struct.point4) align 4 %0, i8* %1, i8* %2, i8* %3, i8* %4) #0 {
  %6 = alloca i8*, align 4
