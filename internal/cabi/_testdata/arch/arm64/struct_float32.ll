...
define dso_local %struct.point1 @demo1([1 x float] %0) #0 {
  ...
  %8 = load %struct.point1, %struct.point1* %2, align 4
  ret %struct.point1 %8
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.point2 @demo2([2 x float] %0) #0 {
  ...
  %7 = load %struct.point2, %struct.point2* %2, align 4
  ret %struct.point2 %7
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.point3 @demo3([3 x float] %0) #0 {
  %2 = alloca %struct.point3, align 4
  %3 = alloca %struct.point3, align 4
  %4 = bitcast %struct.point3* %3 to [3 x float]*
  ...
  %7 = load %struct.point3, %struct.point3* %2, align 4
  ret %struct.point3 %7
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.point4 @demo4([4 x float] %0) #0 {
  %2 = alloca %struct.point4, align 4
  %3 = alloca %struct.point4, align 4
  %4 = bitcast %struct.point4* %3 to [4 x float]*
  ...
  %7 = load %struct.point4, %struct.point4* %2, align 4
  ret %struct.point4 %7
}
