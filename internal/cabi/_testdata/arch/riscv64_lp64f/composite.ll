...
define dso_local i64 @demo_array10(i64 %0) #0 {
  ...
  %7 = getelementptr inbounds %struct.basearray1, %struct.basearray1* %6, i32 0, i32 0
  store i64 %0, i64* %4, align 8
  %8 = bitcast [1 x i32]* %7 to i8*
  %9 = bitcast i64* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %8, i8* align 8 %9, i64 4, i1 false)
  %10 = bitcast %struct.array10* %2 to i8*
  %11 = bitcast %struct.array10* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %10, i8* align 4 %11, i64 4, i1 false)
  %12 = getelementptr inbounds %struct.array10, %struct.array10* %2, i32 0, i32 0
  %13 = getelementptr inbounds %struct.basearray1, %struct.basearray1* %12, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone
define dso_local i64 @demo_point10(i64 %0) #0 {
